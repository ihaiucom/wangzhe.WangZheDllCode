...
namespace ResData
{
	public class ResLuckyDrawRewardForClient : tsf4g_csharp_interface, IUnpackable
	{
		...
		{
			if (cutVer == 0u || ResLuckyDrawRewardForClient.CURRVERSION < cutVer)
			{
				cutVer = ResLuckyDrawRewardForClient.CURRVERSION;
			}
			if (ResLuckyDrawRewardForClient.BASEVERSION > cutVer)
			{
