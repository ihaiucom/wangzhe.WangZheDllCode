...
namespace ResData
{
	public class NewbieGuideWeakConf : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public uint dwWeakLineID;

		public uint[] Param;

		public ushort wSpecialTip;

		public byte bOnlyOnce;
		...
		public NewbieGuideWeakConf()
		{
			this.szRemark_ByteArray = new byte[1];
			this.Param = new uint[3];
		...
		{
			if (cutVer == 0u || NewbieGuideWeakConf.CURRVERSION < cutVer)
			{
				cutVer = NewbieGuideWeakConf.CURRVERSION;
			}
			if (NewbieGuideWeakConf.BASEVERSION > cutVer)
			{
			...
			{
				if ((ulong)num > (ulong)NewbieGuideWeakConf.LENGTH_szRemark)
				{
			...
			errorType = srcBuf.readUInt32(ref this.dwWeakLineID);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				this.szRemark_ByteArray = new byte[NewbieGuideWeakConf.LENGTH_szRemark];
			}
