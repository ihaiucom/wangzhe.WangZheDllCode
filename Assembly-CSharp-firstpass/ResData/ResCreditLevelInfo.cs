...
namespace ResData
{
	public class ResCreditLevelInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResCreditLevelInfo.LENGTH_szCreditDayRewardDesc)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResCreditLevelInfo.LENGTH_szCreditWeekRewardDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResCreditLevelInfo.LENGTH_szCreditLevelTxt)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
