...
namespace ResData
{
	public class ResAcntBattleLevelInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwMapId;
		...
		{
			if (cutVer == 0u || ResAcntBattleLevelInfo.CURRVERSION < cutVer)
			{
				cutVer = ResAcntBattleLevelInfo.CURRVERSION;
			}
			if (ResAcntBattleLevelInfo.BASEVERSION > cutVer)
			{
