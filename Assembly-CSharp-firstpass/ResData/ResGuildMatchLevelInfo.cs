...
namespace ResData
{
	public class ResGuildMatchLevelInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwMapId;
		...
		{
			if (cutVer == 0u || ResGuildMatchLevelInfo.CURRVERSION < cutVer)
			{
				cutVer = ResGuildMatchLevelInfo.CURRVERSION;
			}
			if (ResGuildMatchLevelInfo.BASEVERSION > cutVer)
			{
