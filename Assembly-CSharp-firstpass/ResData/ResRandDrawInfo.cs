...
namespace ResData
{
	public class ResRandDrawInfo : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResRandDrawInfo.LENGTH_szStartTime)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResRandDrawInfo.LENGTH_szEndTime)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
