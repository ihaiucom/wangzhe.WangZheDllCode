...
namespace ResData
{
	public class ResRecommendEquipInBattle : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResRecommendEquipInBattle.LENGTH_szCombinationName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResRecommendEquipInBattle.LENGTH_szCombinationDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
