...
namespace ResData
{
	public class ResMonsterCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResMonsterCfgInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResMonsterCfgInfo.LENGTH_szCharacterInfo)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResMonsterCfgInfo.LENGTH_szBossIcon)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
