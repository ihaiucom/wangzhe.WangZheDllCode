...
namespace ResData
{
	public class ResMentorPrivilege : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResMentorPrivilege.LENGTH_szPrivilegeIcon)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResMentorPrivilege.LENGTH_szPrivilegeDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
