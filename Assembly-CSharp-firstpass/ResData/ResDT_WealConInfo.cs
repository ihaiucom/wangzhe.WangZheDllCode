...
namespace ResData
{
	public class ResDT_WealConInfo : tsf4g_csharp_interface, IUnpackable
	{
		public byte[] szDesc_ByteArray;

		public uint dwConType;

		public uint dwGoalValue;

		public uint[] ReachConParam;

		public uint dwFixedRewardID;

		public uint dwLimitDays;

		public uint dwLimitRewardID;

		public uint dwJumpEntry;
		...
		public ResDT_WealConInfo()
		{
			this.szDesc_ByteArray = new byte[1];
			this.ReachConParam = new uint[5];
