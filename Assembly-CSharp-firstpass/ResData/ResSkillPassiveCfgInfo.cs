...
namespace ResData
{
	public class ResSkillPassiveCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResSkillPassiveCfgInfo.LENGTH_szPassiveName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResSkillPassiveCfgInfo.LENGTH_szPassiveDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResSkillPassiveCfgInfo.LENGTH_szActionName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
