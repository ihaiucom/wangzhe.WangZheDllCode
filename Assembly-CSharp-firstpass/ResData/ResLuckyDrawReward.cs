...
namespace ResData
{
	public class ResLuckyDrawReward : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwRewardPoolID;

		public byte bRewardIndex;

		public uint dwRewardLimitID;
		...
		public uint dwItemTag;

		public byte bShowProbabilityDoubled;

		public uint dwItemPreciousValue;

		public uint dwItemProbability;

		public byte bExcludeIfChosen;

		public ushort wMissCntPerAddProbaility;

		public uint dwAddProbaility;

		public ushort wAddProbailityLimit;

		public ushort wProbailityReduceRatio;
