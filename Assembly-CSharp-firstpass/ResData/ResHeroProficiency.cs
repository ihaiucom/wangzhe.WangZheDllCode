...
namespace ResData
{
	public class ResHeroProficiency : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResHeroProficiency.LENGTH_szTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResHeroProficiency.LENGTH_szImagePath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
