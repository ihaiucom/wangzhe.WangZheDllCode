...
namespace ResData
{
	public class ResHeroShop : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResHeroShop.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResHeroShop.LENGTH_szObtWay)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResHeroShop.LENGTH_szOnTimeStr)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResHeroShop.LENGTH_szOffTimeStr)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
