...
namespace ResData
{
	public class ResLevelCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResLevelCfgInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResLevelCfgInfo.LENGTH_szDesignFileName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResLevelCfgInfo.LENGTH_szArtistFileName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResLevelCfgInfo.LENGTH_szLevelIcon)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num10 > (ulong)ResLevelCfgInfo.LENGTH_szThumbnailPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num12 > (ulong)ResLevelCfgInfo.LENGTH_szMapPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num14 > (ulong)ResLevelCfgInfo.LENGTH_szBigMapPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num17 > (ulong)ResLevelCfgInfo.LENGTH_szMusicStartEvent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num19 > (ulong)ResLevelCfgInfo.LENGTH_szMusicEndEvent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num21 > (ulong)ResLevelCfgInfo.LENGTH_szAmbientSoundEvent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num23 > (ulong)ResLevelCfgInfo.LENGTH_szBankResourceName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num26 > (ulong)ResLevelCfgInfo.LENGTH_szLevelDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
