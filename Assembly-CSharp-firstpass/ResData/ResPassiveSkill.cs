...
namespace ResData
{
	public class ResPassiveSkill : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public uint[] PassiveRmvSkillFuncID;
		...
		public ResPassiveSkill()
		{
			this.szDesc_ByteArray = new byte[1];
			this.PassiveRmvSkillFuncID = new uint[3];
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				this.szDesc_ByteArray = new byte[ResPassiveSkill.LENGTH_szDesc];
			}
