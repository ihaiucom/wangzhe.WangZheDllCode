...
namespace ResData
{
	public class ResLbsReward : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwLbsID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResLbsReward.LENGTH_szMailTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResLbsReward.LENGTH_szMailBody)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
