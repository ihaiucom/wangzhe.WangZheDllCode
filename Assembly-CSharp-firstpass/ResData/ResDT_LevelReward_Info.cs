...
namespace ResData
{
	public class ResDT_LevelReward_Info : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResDT_LevelReward_Info.LENGTH_szIcon)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResDT_LevelReward_Info.LENGTH_szDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
