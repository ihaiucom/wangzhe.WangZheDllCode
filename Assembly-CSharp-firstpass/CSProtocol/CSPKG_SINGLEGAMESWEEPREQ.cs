...
{
	public class CSPKG_SINGLEGAMESWEEPREQ : ProtocolObject
	{
		public int iLevelID;
		...
		public static readonly int CLASS_ID = 796;
		...
		{
			if (cutVer == 0u || CSPKG_SINGLEGAMESWEEPREQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_SINGLEGAMESWEEPREQ.CURRVERSION;
			}
			if (CSPKG_SINGLEGAMESWEEPREQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_SINGLEGAMESWEEPREQ.CLASS_ID;
		}
