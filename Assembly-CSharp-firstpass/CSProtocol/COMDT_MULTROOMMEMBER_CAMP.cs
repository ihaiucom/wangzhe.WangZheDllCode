...
namespace CSProtocol
{
	public class COMDT_MULTROOMMEMBER_CAMP : ProtocolObject
	{
		...
		public COMDT_ROOMMEMBER_DT[] astMemInfo;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 56;

		public COMDT_MULTROOMMEMBER_CAMP()
		{
			this.astMemInfo = new COMDT_ROOMMEMBER_DT[5];
			for (int i = 0; i < 5; i++)
			{
		...
		{
			if (cutVer == 0u || COMDT_MULTROOMMEMBER_CAMP.CURRVERSION < cutVer)
			{
				cutVer = COMDT_MULTROOMMEMBER_CAMP.CURRVERSION;
			}
			if (COMDT_MULTROOMMEMBER_CAMP.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_MULTROOMMEMBER_CAMP.CLASS_ID;
		}
