...
{
	public class SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1035;

		public SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST.CURRVERSION;
			}
			if (SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_NTF_INTIMACY_RELATION_REQUEST.CLASS_ID;
		}
