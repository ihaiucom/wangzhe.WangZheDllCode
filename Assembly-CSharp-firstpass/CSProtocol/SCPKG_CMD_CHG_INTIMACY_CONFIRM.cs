...
{
	public class SCPKG_CMD_CHG_INTIMACY_CONFIRM : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1037;

		public SCPKG_CMD_CHG_INTIMACY_CONFIRM()
		{
		...
		{
			return SCPKG_CMD_CHG_INTIMACY_CONFIRM.CLASS_ID;
		}
