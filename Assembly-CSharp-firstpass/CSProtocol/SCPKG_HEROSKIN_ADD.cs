...
{
	public class SCPKG_HEROSKIN_ADD : ProtocolObject
	{
		...
		public static readonly uint CURRVERSION = 75u;

		public static readonly uint VERSION_dwFrom = 75u;

		public static readonly int CLASS_ID = 906;
		...
		{
			if (cutVer == 0u || SCPKG_HEROSKIN_ADD.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_HEROSKIN_ADD.CURRVERSION;
			}
			if (SCPKG_HEROSKIN_ADD.BASEVERSION > cutVer)
			{
			...
			if (SCPKG_HEROSKIN_ADD.VERSION_dwFrom <= cutVer)
			{
		...
		{
			return SCPKG_HEROSKIN_ADD.CLASS_ID;
		}
