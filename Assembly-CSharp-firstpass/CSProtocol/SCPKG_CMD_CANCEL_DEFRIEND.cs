...
{
	public class SCPKG_CMD_CANCEL_DEFRIEND : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1046;

		public SCPKG_CMD_CANCEL_DEFRIEND()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_CANCEL_DEFRIEND.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_CANCEL_DEFRIEND.CURRVERSION;
			}
			if (SCPKG_CMD_CANCEL_DEFRIEND.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_CANCEL_DEFRIEND.CLASS_ID;
		}
