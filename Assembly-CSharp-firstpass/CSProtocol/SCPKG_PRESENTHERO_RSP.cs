...
{
	public class SCPKG_PRESENTHERO_RSP : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 908;

		public SCPKG_PRESENTHERO_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_PRESENTHERO_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_PRESENTHERO_RSP.CURRVERSION;
			}
			if (SCPKG_PRESENTHERO_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_PRESENTHERO_RSP.CLASS_ID;
		}
