...
{
	public class FRAMEPKG_CMD_USECOMMONATTACK : ProtocolObject
	{
		public sbyte chStart;

		public uint dwObjID;

		public uint dwRealObjID;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 8;
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = destBuf.writeInt8(this.chStart);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			...
			errorType = destBuf.writeUInt32(this.dwRealObjID);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return FRAMEPKG_CMD_USECOMMONATTACK.CLASS_ID;
		}
