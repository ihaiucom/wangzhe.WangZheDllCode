...
{
	public class COMDT_WEAL_HEAD : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 546;
		...
		{
			if (cutVer == 0u || COMDT_WEAL_HEAD.CURRVERSION < cutVer)
			{
				cutVer = COMDT_WEAL_HEAD.CURRVERSION;
			}
			if (COMDT_WEAL_HEAD.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_WEAL_HEAD.CLASS_ID;
		}
