...
{
	public class COMDT_ROOM_BASE : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || COMDT_ROOM_BASE.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ROOM_BASE.CURRVERSION;
			}
			if (COMDT_ROOM_BASE.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ROOM_BASE.CLASS_ID;
		}
