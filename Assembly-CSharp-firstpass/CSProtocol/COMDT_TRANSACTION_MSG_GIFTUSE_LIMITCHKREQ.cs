...
{
	public class COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 695;

		public COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ.CURRVERSION;
			}
			if (COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TRANSACTION_MSG_GIFTUSE_LIMITCHKREQ.CLASS_ID;
		}
