...
{
	public class CSPKG_CLT_ACTION_STATISTICS : ProtocolObject
	{
		public byte bActionType;

		public CSDT_CLT_ACTION_DATA stActionData;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 1487;
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = destBuf.writeUInt8(this.bActionType);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			long selector = (long)this.bActionType;
			errorType = this.stActionData.pack(selector, ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSPKG_CLT_ACTION_STATISTICS.CLASS_ID;
		}
