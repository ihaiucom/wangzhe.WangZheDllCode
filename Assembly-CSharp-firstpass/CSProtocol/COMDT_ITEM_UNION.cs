...
namespace CSProtocol
{
	public class COMDT_ITEM_UNION : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 557;
		...
		{
			if (cutVer == 0u || COMDT_ITEM_UNION.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ITEM_UNION.CURRVERSION;
			}
			if (COMDT_ITEM_UNION.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ITEM_UNION.CLASS_ID;
		}
