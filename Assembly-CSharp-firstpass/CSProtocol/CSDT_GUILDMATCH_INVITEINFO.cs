...
{
	public class CSDT_GUILDMATCH_INVITEINFO : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 1581;
		...
		{
			if (cutVer == 0u || CSDT_GUILDMATCH_INVITEINFO.CURRVERSION < cutVer)
			{
				cutVer = CSDT_GUILDMATCH_INVITEINFO.CURRVERSION;
			}
			if (CSDT_GUILDMATCH_INVITEINFO.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_GUILDMATCH_INVITEINFO.CLASS_ID;
		}
