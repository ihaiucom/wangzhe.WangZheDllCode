...
{
	public class CSPKG_CMD_SHOPBUY : ProtocolObject
	{
		public int iBuyType;
		...
		{
			if (cutVer == 0u || CSPKG_CMD_SHOPBUY.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_SHOPBUY.CURRVERSION;
			}
			if (CSPKG_CMD_SHOPBUY.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_SHOPBUY.CLASS_ID;
		}
