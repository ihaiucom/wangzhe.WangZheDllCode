...
{
	public class CSPKG_CMD_CHG_INTIMACY_DENY : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1039;

		public CSPKG_CMD_CHG_INTIMACY_DENY()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CMD_CHG_INTIMACY_DENY.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_CHG_INTIMACY_DENY.CURRVERSION;
			}
			if (CSPKG_CMD_CHG_INTIMACY_DENY.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_CHG_INTIMACY_DENY.CLASS_ID;
		}
