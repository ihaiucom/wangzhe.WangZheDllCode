...
{
	public class COMDT_MATCHROOM_ATTR : ProtocolObject
	{
		public byte bPkAI;
		...
		public static readonly int CLASS_ID = 243;
		...
		{
			if (cutVer == 0u || COMDT_MATCHROOM_ATTR.CURRVERSION < cutVer)
			{
				cutVer = COMDT_MATCHROOM_ATTR.CURRVERSION;
			}
			if (COMDT_MATCHROOM_ATTR.BASEVERSION > cutVer)
			{
				return TdrError.ErrorType.TDR_ERR_CUTVER_TOO_SMALL;
			}
			TdrError.ErrorType errorType = destBuf.writeUInt8(this.bPkAI);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt8(ref this.bPkAI);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_MATCHROOM_ATTR.CLASS_ID;
		}
