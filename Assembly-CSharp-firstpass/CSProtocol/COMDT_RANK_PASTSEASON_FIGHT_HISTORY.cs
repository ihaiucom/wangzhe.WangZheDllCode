...
{
	public class COMDT_RANK_PASTSEASON_FIGHT_HISTORY : ProtocolObject
	{
		public byte bPos;
		...
		public static readonly int CLASS_ID = 447;

		public COMDT_RANK_PASTSEASON_FIGHT_HISTORY()
		{
		...
		{
			if (cutVer == 0u || COMDT_RANK_PASTSEASON_FIGHT_HISTORY.CURRVERSION < cutVer)
			{
				cutVer = COMDT_RANK_PASTSEASON_FIGHT_HISTORY.CURRVERSION;
			}
			if (COMDT_RANK_PASTSEASON_FIGHT_HISTORY.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_RANK_PASTSEASON_FIGHT_HISTORY.CLASS_ID;
		}
