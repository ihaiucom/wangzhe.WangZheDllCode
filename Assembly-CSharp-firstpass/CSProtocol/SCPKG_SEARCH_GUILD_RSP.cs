...
{
	public class SCPKG_SEARCH_GUILD_RSP : ProtocolObject
	{
		public byte bResult;

		public CSDT_RANKING_LIST_ITEM_INFO stGuildInfo;
		...
		public static readonly int CLASS_ID = 1333;

		public SCPKG_SEARCH_GUILD_RSP()
		{
			this.stGuildInfo = (CSDT_RANKING_LIST_ITEM_INFO)ProtocolObjectPool.Get(CSDT_RANKING_LIST_ITEM_INFO.CLASS_ID);
		}
		...
		{
			if (cutVer == 0u || SCPKG_SEARCH_GUILD_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_SEARCH_GUILD_RSP.CURRVERSION;
			}
			if (SCPKG_SEARCH_GUILD_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_SEARCH_GUILD_RSP.CLASS_ID;
		}
