...
{
	public class CSPKG_UPDATECLIENTBITS_NTF : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1382;
		...
		{
			if (cutVer == 0u || CSPKG_UPDATECLIENTBITS_NTF.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_UPDATECLIENTBITS_NTF.CURRVERSION;
			}
			if (CSPKG_UPDATECLIENTBITS_NTF.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_UPDATECLIENTBITS_NTF.CLASS_ID;
		}
