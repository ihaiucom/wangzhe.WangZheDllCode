...
namespace CSProtocol
{
	public class CSDT_RECONN_ADJUSTINFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1283;
		...
		public override TdrError.ErrorType construct()
		{
			...
			errorType = this.stHeroSwapInfo.construct();
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			if (cutVer == 0u || CSDT_RECONN_ADJUSTINFO.CURRVERSION < cutVer)
			{
				cutVer = CSDT_RECONN_ADJUSTINFO.CURRVERSION;
			}
			if (CSDT_RECONN_ADJUSTINFO.BASEVERSION > cutVer)
			{
			...
			errorType = this.stHeroSwapInfo.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = this.stHeroSwapInfo.unpack(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSDT_RECONN_ADJUSTINFO.CLASS_ID;
		}
