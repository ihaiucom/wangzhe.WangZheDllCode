...
{
	public class COMDT_TRANS_CONTEXT_OF_CONFIRM_STUDENTREQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 428;

		public COMDT_TRANS_CONTEXT_OF_CONFIRM_STUDENTREQ()
		{
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			errorType = destBuf.writeUInt8(this.bInsertSucc);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_CONFIRM_STUDENTREQ.CLASS_ID;
		}
