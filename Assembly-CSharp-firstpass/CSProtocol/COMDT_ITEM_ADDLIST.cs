...
{
	public class COMDT_ITEM_ADDLIST : ProtocolObject
	{
		public ushort wItemCnt;

		public COMDT_ITEM_ADDINFO[] astItemList;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 228;

		public COMDT_ITEM_ADDLIST()
		{
			this.astItemList = new COMDT_ITEM_ADDINFO[400];
			for (int i = 0; i < 400; i++)
			{
				this.astItemList[i] = (COMDT_ITEM_ADDINFO)ProtocolObjectPool.Get(COMDT_ITEM_ADDINFO.CLASS_ID);
			}
		}
		...
		{
			if (cutVer == 0u || COMDT_ITEM_ADDLIST.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ITEM_ADDLIST.CURRVERSION;
			}
			if (COMDT_ITEM_ADDLIST.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ITEM_ADDLIST.CLASS_ID;
		}
