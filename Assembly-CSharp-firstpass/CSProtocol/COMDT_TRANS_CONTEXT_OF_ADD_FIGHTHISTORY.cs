...
{
	public class COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 646;

		public COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TRANS_CONTEXT_OF_ADD_FIGHTHISTORY.CLASS_ID;
		}
