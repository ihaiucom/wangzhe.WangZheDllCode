...
{
	public class SCPKG_CMD_CHG_INTIMACY_DENY : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1040;

		public SCPKG_CMD_CHG_INTIMACY_DENY()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_CHG_INTIMACY_DENY.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_CHG_INTIMACY_DENY.CURRVERSION;
			}
			if (SCPKG_CMD_CHG_INTIMACY_DENY.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_CHG_INTIMACY_DENY.CLASS_ID;
		}
