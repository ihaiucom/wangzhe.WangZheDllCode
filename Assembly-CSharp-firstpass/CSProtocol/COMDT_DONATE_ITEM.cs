...
{
	public class COMDT_DONATE_ITEM : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 564;

		public COMDT_DONATE_ITEM()
		{
		...
		{
			if (cutVer == 0u || COMDT_DONATE_ITEM.CURRVERSION < cutVer)
			{
				cutVer = COMDT_DONATE_ITEM.CURRVERSION;
			}
			if (COMDT_DONATE_ITEM.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_DONATE_ITEM.CLASS_ID;
		}
