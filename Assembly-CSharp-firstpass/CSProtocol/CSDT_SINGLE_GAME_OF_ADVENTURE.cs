...
{
	public class CSDT_SINGLE_GAME_OF_ADVENTURE : ProtocolObject
	{
		public int iLevelID;
		...
		public static readonly int CLASS_ID = 737;
		...
		{
			if (cutVer == 0u || CSDT_SINGLE_GAME_OF_ADVENTURE.CURRVERSION < cutVer)
			{
				cutVer = CSDT_SINGLE_GAME_OF_ADVENTURE.CURRVERSION;
			}
			if (CSDT_SINGLE_GAME_OF_ADVENTURE.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_SINGLE_GAME_OF_ADVENTURE.CLASS_ID;
		}
