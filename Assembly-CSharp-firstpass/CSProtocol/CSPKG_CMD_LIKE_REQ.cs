...
{
	public class CSPKG_CMD_LIKE_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1053;

		public CSPKG_CMD_LIKE_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CMD_LIKE_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_LIKE_REQ.CURRVERSION;
			}
			if (CSPKG_CMD_LIKE_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_LIKE_REQ.CLASS_ID;
		}
