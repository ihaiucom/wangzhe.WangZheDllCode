...
{
	public class SCPKG_GETARENAFIGHTHISTORY_RSP : ProtocolObject
	{
		public byte bNum;
		...
		public static readonly int CLASS_ID = 1385;

		public SCPKG_GETARENAFIGHTHISTORY_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_GETARENAFIGHTHISTORY_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GETARENAFIGHTHISTORY_RSP.CURRVERSION;
			}
			if (SCPKG_GETARENAFIGHTHISTORY_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_GETARENAFIGHTHISTORY_RSP.CLASS_ID;
		}
