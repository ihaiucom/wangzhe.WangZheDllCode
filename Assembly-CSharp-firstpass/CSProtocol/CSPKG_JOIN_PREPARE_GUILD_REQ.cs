...
{
	public class CSPKG_JOIN_PREPARE_GUILD_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1312;
		...
		{
			if (cutVer == 0u || CSPKG_JOIN_PREPARE_GUILD_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_JOIN_PREPARE_GUILD_REQ.CURRVERSION;
			}
			if (CSPKG_JOIN_PREPARE_GUILD_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_JOIN_PREPARE_GUILD_REQ.CLASS_ID;
		}
