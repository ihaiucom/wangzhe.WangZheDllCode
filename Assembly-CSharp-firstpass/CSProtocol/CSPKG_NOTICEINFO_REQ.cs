...
{
	public class CSPKG_NOTICEINFO_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1163;
		...
		{
			if (cutVer == 0u || CSPKG_NOTICEINFO_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_NOTICEINFO_REQ.CURRVERSION;
			}
			if (CSPKG_NOTICEINFO_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_NOTICEINFO_REQ.CLASS_ID;
		}

		public override void OnRelease()
		{
			this.dwNoticeID = 0u;
			this.ullNoticeTime = 0uL;
