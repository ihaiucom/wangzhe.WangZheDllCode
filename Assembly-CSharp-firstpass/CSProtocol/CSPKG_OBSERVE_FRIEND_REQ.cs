...
{
	public class CSPKG_OBSERVE_FRIEND_REQ : ProtocolObject
	{
		public byte bType;
		...
		public static readonly int CLASS_ID = 1525;

		public CSPKG_OBSERVE_FRIEND_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_OBSERVE_FRIEND_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_OBSERVE_FRIEND_REQ.CURRVERSION;
			}
			if (CSPKG_OBSERVE_FRIEND_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_OBSERVE_FRIEND_REQ.CLASS_ID;
		}
