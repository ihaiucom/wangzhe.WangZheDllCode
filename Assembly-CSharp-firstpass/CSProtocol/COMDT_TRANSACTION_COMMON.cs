...
{
	public class COMDT_TRANSACTION_COMMON : ProtocolObject
	{
		public uint dwTransId;

		public uint dwTransSeq;

		public byte bActionIndex;
		...
		public static readonly int CLASS_ID = 421;
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt32(ref this.dwTransId);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt32(ref this.dwTransSeq);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt8(ref this.bActionIndex);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_TRANSACTION_COMMON.CLASS_ID;
		}
