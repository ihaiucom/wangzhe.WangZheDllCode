...
{
	public class CSPKG_GET_EQUIPEVAL_RSP : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1613;

		public CSPKG_GET_EQUIPEVAL_RSP()
		{
		...
		{
			if (cutVer == 0u || CSPKG_GET_EQUIPEVAL_RSP.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_GET_EQUIPEVAL_RSP.CURRVERSION;
			}
			if (CSPKG_GET_EQUIPEVAL_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_GET_EQUIPEVAL_RSP.CLASS_ID;
		}
