...
{
	public class COMDT_NEWCLIENT_BITS : ProtocolObject
	{
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			if (cutVer == 0u || COMDT_NEWCLIENT_BITS.CURRVERSION < cutVer)
			{
				cutVer = COMDT_NEWCLIENT_BITS.CURRVERSION;
			}
			if (COMDT_NEWCLIENT_BITS.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_NEWCLIENT_BITS.CLASS_ID;
		}
