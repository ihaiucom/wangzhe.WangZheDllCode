...
{
	public class CSDT_CHEAT_SET_MASTERHERO : ProtocolObject
	{
		public ulong ullAcntID;

		public int iWorldLogicId;
		...
		public static readonly int CLASS_ID = 848;
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt64(ref this.ullAcntID);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readInt32(ref this.iWorldLogicId);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSDT_CHEAT_SET_MASTERHERO.CLASS_ID;
		}

		public override void OnRelease()
		{
			this.ullAcntID = 0uL;
			this.iWorldLogicId = 0;
			this.dwHeroID = 0u;
			this.dwWinCnt = 0u;
			this.dwGameCnt = 0u;
		}
