...
{
	public class SCPKG_CMD_SKILLUNLOCK_SEL : ProtocolObject
	{
		public int iResult;
		...
		public static readonly int CLASS_ID = 1455;
		...
		{
			if (cutVer == 0u || SCPKG_CMD_SKILLUNLOCK_SEL.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_SKILLUNLOCK_SEL.CURRVERSION;
			}
			if (SCPKG_CMD_SKILLUNLOCK_SEL.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_SKILLUNLOCK_SEL.CLASS_ID;
		}
