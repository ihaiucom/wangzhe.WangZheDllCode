...
{
	public class COMDT_JOIN_ARENA_RSP : ProtocolObject
	{
		public byte bErrCode;

		public COMDT_JOIN_ARENA_DETAIL stDetail;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 67u;

		public static readonly int CLASS_ID = 528;

		public COMDT_JOIN_ARENA_RSP()
		{
			this.stDetail = (COMDT_JOIN_ARENA_DETAIL)ProtocolObjectPool.Get(COMDT_JOIN_ARENA_DETAIL.CLASS_ID);
		}
		...
		{
			if (cutVer == 0u || COMDT_JOIN_ARENA_RSP.CURRVERSION < cutVer)
			{
				cutVer = COMDT_JOIN_ARENA_RSP.CURRVERSION;
			}
			if (COMDT_JOIN_ARENA_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_JOIN_ARENA_RSP.CLASS_ID;
		}
