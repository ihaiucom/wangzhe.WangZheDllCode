...
{
	public class CSDT_CHEAT_ADD_FIGHTHISTORY : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 849;

		public CSDT_CHEAT_ADD_FIGHTHISTORY()
		{
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_ADD_FIGHTHISTORY.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_ADD_FIGHTHISTORY.CURRVERSION;
			}
			if (CSDT_CHEAT_ADD_FIGHTHISTORY.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_CHEAT_ADD_FIGHTHISTORY.CLASS_ID;
		}
