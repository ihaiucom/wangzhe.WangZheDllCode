...
{
	public class SCPKG_CMD_ADD_FRIEND_DENY : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1026;

		public SCPKG_CMD_ADD_FRIEND_DENY()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_ADD_FRIEND_DENY.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_ADD_FRIEND_DENY.CURRVERSION;
			}
			if (SCPKG_CMD_ADD_FRIEND_DENY.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_ADD_FRIEND_DENY.CLASS_ID;
		}
