...
{
	public class CSPKG_CMD_CHG_INTIMACY_CONFIRM : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1036;

		public CSPKG_CMD_CHG_INTIMACY_CONFIRM()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CMD_CHG_INTIMACY_CONFIRM.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_CHG_INTIMACY_CONFIRM.CURRVERSION;
			}
			if (CSPKG_CMD_CHG_INTIMACY_CONFIRM.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_CHG_INTIMACY_CONFIRM.CLASS_ID;
		}
