...
namespace CSProtocol
{
	public class COMDT_SETTLE_HERO_DETAIL : ProtocolObject
	{
		...
		public COMDT_SETTLE_HERO_INFO[] astHeroList;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 165;

		public COMDT_SETTLE_HERO_DETAIL()
		{
			this.astHeroList = new COMDT_SETTLE_HERO_INFO[3];
			for (int i = 0; i < 3; i++)
			{
		...
		{
			if (cutVer == 0u || COMDT_SETTLE_HERO_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_SETTLE_HERO_DETAIL.CURRVERSION;
			}
			if (COMDT_SETTLE_HERO_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_SETTLE_HERO_DETAIL.CLASS_ID;
		}
