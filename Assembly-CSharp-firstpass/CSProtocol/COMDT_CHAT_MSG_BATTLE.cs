...
namespace CSProtocol
{
	public class COMDT_CHAT_MSG_BATTLE : ProtocolObject
	{
		...
		public COMDT_BATTLE_CHAT_UNION stChatInfo;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 289;
		...
		{
			if (cutVer == 0u || COMDT_CHAT_MSG_BATTLE.CURRVERSION < cutVer)
			{
				cutVer = COMDT_CHAT_MSG_BATTLE.CURRVERSION;
			}
			if (COMDT_CHAT_MSG_BATTLE.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_CHAT_MSG_BATTLE.CLASS_ID;
		}
