...
{
	public class SCPKG_LUCKYDRAW_EXTERN_RSP : ProtocolObject
	{
		public int iResult;
		...
		public static readonly int CLASS_ID = 1461;
		...
		{
			if (cutVer == 0u || SCPKG_LUCKYDRAW_EXTERN_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_LUCKYDRAW_EXTERN_RSP.CURRVERSION;
			}
			if (SCPKG_LUCKYDRAW_EXTERN_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_LUCKYDRAW_EXTERN_RSP.CLASS_ID;
		}
