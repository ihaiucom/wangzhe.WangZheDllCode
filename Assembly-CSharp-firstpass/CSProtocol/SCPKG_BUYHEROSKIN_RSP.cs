...
{
	public class SCPKG_BUYHEROSKIN_RSP : ProtocolObject
	{
		public int iResult;
		...
		public static readonly int CLASS_ID = 903;
		...
		{
			if (cutVer == 0u || SCPKG_BUYHEROSKIN_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_BUYHEROSKIN_RSP.CURRVERSION;
			}
			if (SCPKG_BUYHEROSKIN_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_BUYHEROSKIN_RSP.CLASS_ID;
		}
