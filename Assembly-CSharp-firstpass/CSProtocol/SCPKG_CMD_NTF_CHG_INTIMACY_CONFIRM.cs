...
{
	public class SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1038;

		public SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM.CURRVERSION;
			}
			if (SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_NTF_CHG_INTIMACY_CONFIRM.CLASS_ID;
		}
