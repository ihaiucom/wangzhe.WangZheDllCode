...
{
	public class SCPKG_BUYHERO_RSP : ProtocolObject
	{
		public int iResult;
		...
		{
			if (cutVer == 0u || SCPKG_BUYHERO_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_BUYHERO_RSP.CURRVERSION;
			}
			if (SCPKG_BUYHERO_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_BUYHERO_RSP.CLASS_ID;
		}
