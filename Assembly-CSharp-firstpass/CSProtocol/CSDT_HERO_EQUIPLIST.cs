...
{
	public class CSDT_HERO_EQUIPLIST : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 866;

		public CSDT_HERO_EQUIPLIST()
		{
		...
		{
			if (cutVer == 0u || CSDT_HERO_EQUIPLIST.CURRVERSION < cutVer)
			{
				cutVer = CSDT_HERO_EQUIPLIST.CURRVERSION;
			}
			if (CSDT_HERO_EQUIPLIST.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_HERO_EQUIPLIST.CLASS_ID;
		}
