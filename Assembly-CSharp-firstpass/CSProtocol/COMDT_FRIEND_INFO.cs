...
namespace CSProtocol
{
	public class COMDT_FRIEND_INFO : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)COMDT_FRIEND_INFO.LENGTH_szUserName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			if (COMDT_FRIEND_INFO.VERSION_szHeadUrl <= cutVer)
			{
				...
				{
					if ((ulong)num3 > (ulong)COMDT_FRIEND_INFO.LENGTH_szHeadUrl)
					{
						return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
					}
			...
			if (COMDT_FRIEND_INFO.VERSION_szOpenId <= cutVer)
			{
				...
				{
					if ((ulong)num5 > (ulong)COMDT_FRIEND_INFO.LENGTH_szOpenId)
					{
						return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
					}
