...
{
	public class CSPKG_DRAWWEAL_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1212;
		...
		{
			if (cutVer == 0u || CSPKG_DRAWWEAL_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_DRAWWEAL_REQ.CURRVERSION;
			}
			if (CSPKG_DRAWWEAL_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_DRAWWEAL_REQ.CLASS_ID;
		}
