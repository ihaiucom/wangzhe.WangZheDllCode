...
namespace CSProtocol
{
	public class CSDT_INTIMACY_RELATION_INFO : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)CSDT_INTIMACY_RELATION_INFO.LENGTH_szUserName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num3 > (ulong)CSDT_INTIMACY_RELATION_INFO.LENGTH_szHeadUrl)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)CSDT_INTIMACY_RELATION_INFO.LENGTH_szSignatureInfo)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
