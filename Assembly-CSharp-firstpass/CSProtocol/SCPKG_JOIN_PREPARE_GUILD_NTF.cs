...
{
	public class SCPKG_JOIN_PREPARE_GUILD_NTF : ProtocolObject
	{
		public COMDT_GUILD_MEMBER_BRIEF_INFO stNewMember;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 234u;

		public static readonly int CLASS_ID = 1314;
		...
		{
			if (cutVer == 0u || SCPKG_JOIN_PREPARE_GUILD_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_JOIN_PREPARE_GUILD_NTF.CURRVERSION;
			}
			if (SCPKG_JOIN_PREPARE_GUILD_NTF.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_JOIN_PREPARE_GUILD_NTF.CLASS_ID;
		}
