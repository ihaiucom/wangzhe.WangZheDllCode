...
{
	public class FRAMEPKG_CMD_ATTACKPOSITION : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || FRAMEPKG_CMD_ATTACKPOSITION.CURRVERSION < cutVer)
			{
				cutVer = FRAMEPKG_CMD_ATTACKPOSITION.CURRVERSION;
			}
			if (FRAMEPKG_CMD_ATTACKPOSITION.BASEVERSION > cutVer)
			{
		...
		{
			return FRAMEPKG_CMD_ATTACKPOSITION.CLASS_ID;
		}
