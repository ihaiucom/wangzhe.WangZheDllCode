...
{
	public class COMDT_APOLLO_PAY_PVEREVIVE : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 466;
		...
		{
			if (cutVer == 0u || COMDT_APOLLO_PAY_PVEREVIVE.CURRVERSION < cutVer)
			{
				cutVer = COMDT_APOLLO_PAY_PVEREVIVE.CURRVERSION;
			}
			if (COMDT_APOLLO_PAY_PVEREVIVE.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_APOLLO_PAY_PVEREVIVE.CLASS_ID;
		}
