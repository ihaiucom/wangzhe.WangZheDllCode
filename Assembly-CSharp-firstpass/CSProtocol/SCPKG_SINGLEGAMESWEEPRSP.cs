...
namespace CSProtocol
{
	public class SCPKG_SINGLEGAMESWEEPRSP : ProtocolObject
	{
		...
		public SCDT_SWEEP_REWARD stReward;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 175u;

		public static readonly int CLASS_ID = 798;

		public SCPKG_SINGLEGAMESWEEPRSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_SINGLEGAMESWEEPRSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_SINGLEGAMESWEEPRSP.CURRVERSION;
			}
			if (SCPKG_SINGLEGAMESWEEPRSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_SINGLEGAMESWEEPRSP.CLASS_ID;
		}
