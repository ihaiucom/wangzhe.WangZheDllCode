...
{
	public class SCDT_NEWTASKGET : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1103;
		...
		{
			if (cutVer == 0u || SCDT_NEWTASKGET.CURRVERSION < cutVer)
			{
				cutVer = SCDT_NEWTASKGET.CURRVERSION;
			}
			if (SCDT_NEWTASKGET.BASEVERSION > cutVer)
			{
		...
		{
			return SCDT_NEWTASKGET.CLASS_ID;
		}
