...
{
	public class CSPKG_NOTICELIST_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1160;
		...
		{
			if (cutVer == 0u || CSPKG_NOTICELIST_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_NOTICELIST_REQ.CURRVERSION;
			}
			if (CSPKG_NOTICELIST_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_NOTICELIST_REQ.CLASS_ID;
		}
