...
namespace IIPSMobile
{
	public class DataDownloader : IIPSMobileDownloaderInterface
	{
		...
		[DllImport("apollo", ExactSpelling = true)]
		private static extern byte DownloadLocalData(IntPtr dataDownloader, [MarshalAs(20)] string downloadurl, [MarshalAs(20)] string filepath, byte priority, ref uint TaskID, byte bDoBrokenResume);
