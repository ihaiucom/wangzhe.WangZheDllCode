...
internal class AkSoundEnginePINVOKE
{
	...
	[DllImport("AkSoundEngine")]
	public static extern void CSharp_AkExternalSourceInfo_szFile_set(IntPtr jarg1, [MarshalAs(20)] string jarg2);
	...
	[DllImport("AkSoundEngine")]
	public static extern IntPtr CSharp_new_AkExternalSourceInfo__SWIG_2([MarshalAs(20)] string jarg1, uint jarg2, uint jarg3);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_GetSpeakerAngles__SWIG_0([MarshalAs(42)] [In] [Out] float[] jarg1, ref uint jarg2, out float jarg3, int jarg4, uint jarg5);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_GetSpeakerAngles__SWIG_1([MarshalAs(42)] [In] [Out] float[] jarg1, ref uint jarg2, out float jarg3, int jarg4);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_GetSpeakerAngles__SWIG_2([MarshalAs(42)] [In] [Out] float[] jarg1, ref uint jarg2, out float jarg3);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_SetSpeakerAngles__SWIG_0([MarshalAs(42)] [In] float[] jarg1, uint jarg2, float jarg3, int jarg4, uint jarg5);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_SetSpeakerAngles__SWIG_1([MarshalAs(42)] [In] float[] jarg1, uint jarg2, float jarg3, int jarg4);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_SetSpeakerAngles__SWIG_2([MarshalAs(42)] [In] float[] jarg1, uint jarg2, float jarg3);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_PrepareEvent__SWIG_1(int jarg1, [MarshalAs(42)] [In] uint[] jarg2, uint jarg3);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_PrepareEvent__SWIG_2(int jarg1, IntPtr jarg2, uint jarg3, IntPtr jarg4, IntPtr jarg5);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_PrepareEvent__SWIG_3(int jarg1, [MarshalAs(42)] [In] uint[] jarg2, uint jarg3, IntPtr jarg4, IntPtr jarg5);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_PrepareGameSyncs__SWIG_1(int jarg1, int jarg2, uint jarg3, [MarshalAs(42)] [In] uint[] jarg4, uint jarg5);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_PrepareGameSyncs__SWIG_3(int jarg1, int jarg2, uint jarg3, [MarshalAs(42)] [In] uint[] jarg4, uint jarg5, IntPtr jarg6, IntPtr jarg7);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_SetActiveListeners(uint jarg1, uint jarg2);

	[DllImport("AkSoundEngine")]
	public static extern int CSharp_SetListenerSpatialization__SWIG_0(uint jarg1, bool jarg2, IntPtr jarg3, [MarshalAs(42)] [In] float[] jarg4);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_StartOutputCapture([MarshalAs(20)] string jarg1);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_StartProfilerCapture([MarshalAs(20)] string jarg1);
	...
	[DllImport("AkSoundEngine")]
	public static extern uint CSharp_ResolveDialogueEvent__SWIG_0(uint jarg1, [MarshalAs(42)] [In] uint[] jarg2, uint jarg3, uint jarg4);

	[DllImport("AkSoundEngine")]
	public static extern uint CSharp_ResolveDialogueEvent__SWIG_1(uint jarg1, [MarshalAs(42)] [In] uint[] jarg2, uint jarg3);
	...
	[DllImport("AkSoundEngine")]
	public static extern int CSharp_GetPlayingIDsFromGameObject(uint jarg1, ref uint jarg2, [MarshalAs(42)] [Out] uint[] jarg3);
