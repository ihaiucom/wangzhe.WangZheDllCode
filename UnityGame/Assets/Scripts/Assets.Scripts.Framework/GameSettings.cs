...
namespace Assets.Scripts.Framework
{
	public class GameSettings
	{
		...
		{
			PlayerPrefs.SetInt("sgameSettings_muteSound", GameSettings.EnableSound ? 1 : 0);
			PlayerPrefs.SetInt("sgameSettings_muteMusic", GameSettings.EnableMusic ? 1 : 0);
			...
			PlayerPrefs.SetInt("sgameSettings_outline", GameSettings.EnableOutline ? 1 : 0);
			PlayerPrefs.SetInt("sgameSettings_EnableVoice", GameSettings.EnableVoice ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableVibrate", GameSettings.EnableVibrate ? 1 : 0);
			PlayerPrefs.SetInt("GameSettings_HeroInfoShowEnable", GameSettings.EnableHeroInfo ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingSelectHeroSortType", (int)GameSettings.HeroSelectHeroViewSortType);
			PlayerPrefs.SetInt("GameSettingShowEquipInfo", GameSettings.ShowEquipInfo ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableReplayKit", GameSettings.EnableReplayKit ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableReplayKitAutoMode", GameSettings.EnableReplayKitAutoMode ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableKingTime", GameSettings.EnableKingTimeMode ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableRecorderMode", GameSettings.EnableRecorderMode ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableRecordVideoHighQualityMode", GameSettings.EnableRecordVideoHighQualityMode ? 1 : 0);
			...
			PlayerPrefs.SetInt("GameSettingEnableHDMode_New2", GameSettings._EnableHDMode ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableLunPanLockEnemyHeroMode", GameSettings.LunPanLockEnemyHeroMode ? 1 : 0);
			PlayerPrefs.SetInt("GameSettingEnableShowEnemyHeroHeadBtnMode", GameSettings.ShowEnemyHeroHeadBtnMode ? 1 : 0);
		...
		{
			int num = (GameSettings.DefaultScreenWidth > GameSettings.DefaultScreenHeight) ? GameSettings.DefaultScreenWidth : GameSettings.DefaultScreenHeight;
			int num2 = (GameSettings.DefaultScreenWidth > GameSettings.DefaultScreenHeight) ? GameSettings.DefaultScreenHeight : GameSettings.DefaultScreenWidth;
		...
		public static bool supportOutline()
		{
			...
			int num2 = (Screen.width > Screen.height) ? Screen.height : Screen.width;
