...
namespace Assets.Scripts.Framework
{
	public class GameTask
	{
		...
		static GameTask()
		{
			GameTask.CompareOperatorFunc[] array = new GameTask.CompareOperatorFunc[5];
			array[0] = ((int l, int r) => l < r);
			array[1] = ((int l, int r) => l <= r);
			array[2] = ((int l, int r) => l == r);
			array[3] = ((int l, int r) => l > r);
			array[4] = ((int l, int r) => l >= r);
			GameTask._compareFuncs = array;
		}
