...
namespace AGE
{
	...
	public class PlayAnimDuration : DurationEvent
	{
		...
		public override void Enter(Action _action, Track _track)
		{
			...
			if (!this.bLoop)
			{
				speed = (this.endTime - this.startTime) / base.lengthSec * (this.applyActionSpeed ? _action.playSpeed.single : 1f);
			}
			else
			{
				speed = (this.applyActionSpeed ? _action.playSpeed.single : 1f);
			}
