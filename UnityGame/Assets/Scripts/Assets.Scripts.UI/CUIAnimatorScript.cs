...
namespace Assets.Scripts.UI
{
	public class CUIAnimatorScript : CUIComponent
	{
		...
		[HideInInspector]
		public enUIEventID[] m_eventIDs = new enUIEventID[Enum.GetValues(typeof(enAnimatorEventType)).get_Length()];

		public stUIEventParams[] m_eventParams = new stUIEventParams[Enum.GetValues(typeof(enAnimatorEventType)).get_Length()];
