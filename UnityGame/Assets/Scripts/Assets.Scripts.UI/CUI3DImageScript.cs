...
namespace Assets.Scripts.UI
{
	...
	public class CUI3DImageScript : CUIComponent
	{
		...
		public GameObject AddGameObject(string path, bool useGameObjectPool, ref Vector2 screenPosition, bool bindPivot, bool needCached, string pathToAdd)
		{
			...
			CUIUtility.SetGameObjectLayer(gameObject, this.m_renderCamera.enabled ? CUI3DImageScript.s_cameraLayers[(int)this.m_imageLayer] : 31);
			return gameObject;
		}
		...
		public void InitializeRender()
		{
			if (this.m_renderCamera != null)
			{
				...
				{
					this.m_renderCamera.gameObject.transform.localScale = this.m_renderCameraDefaultScale * (1f / ((this.m_belongedFormScript.gameObject.transform.localScale.x == 0f) ? 1f : this.m_belongedFormScript.gameObject.transform.localScale.x));
				}
			}
