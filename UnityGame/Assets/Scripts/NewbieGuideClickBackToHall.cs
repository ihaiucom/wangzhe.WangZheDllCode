...
public class NewbieGuideClickBackToHall : NewbieGuideBaseScript
{
	...
	{
		for (int i = 0; i < NewbieGuideBaseScript.ms_originalGo.get_Count(); i++)
		{
			GameObject gameObject = NewbieGuideBaseScript.ms_originalGo.get_Item(i);
			GameObject obj = NewbieGuideBaseScript.ms_highlitGo.get_Item(i);
