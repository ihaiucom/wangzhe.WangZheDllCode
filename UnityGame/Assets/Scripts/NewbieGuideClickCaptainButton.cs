		...
		if (form != null)
		{
			...
			if (transform != null)
			{
				...
				if (gameObject.activeInHierarchy)
				{
					...
					if (NewbieGuideBaseScript.ms_originalGo.get_Count() > 0 && NewbieGuideBaseScript.ms_highlitGo.get_Count() > 0)
					{
						PlayerHead component = NewbieGuideBaseScript.ms_originalGo.get_Item(0).GetComponent<PlayerHead>();
						PlayerHead component2 = NewbieGuideBaseScript.ms_highlitGo.get_Item(0).GetComponent<PlayerHead>();
