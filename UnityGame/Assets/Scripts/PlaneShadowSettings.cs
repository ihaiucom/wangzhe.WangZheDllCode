...
public class PlaneShadowSettings : MonoBehaviour
{
	...
	public static float defaultFadeBegin;

	public static float defaultFadeExp;
	...
	{
		PlaneShadowSettings.defaultIntensity = 0.45f;
		PlaneShadowSettings.defaultFadeBegin = 0.1f;
		PlaneShadowSettings.defaultFadeExp = 4f;
