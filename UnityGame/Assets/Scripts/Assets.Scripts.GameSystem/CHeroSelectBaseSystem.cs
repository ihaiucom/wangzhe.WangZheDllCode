...
namespace Assets.Scripts.GameSystem
{
	...
	public class CHeroSelectBaseSystem : Singleton<CHeroSelectBaseSystem>
	{
		...
		{
			Singleton<CHeroSelectBaseSystem>.instance.m_selectHeroIDList.set_Item(0, heroID);
		...
		public static void SendSinglePrepareToBattleMsg(RoomInfo roomInfo, uint battleListID, enSelectGameType selectGameType, byte selectHeroCount, List<uint> selectHeroIDList)
		{
			...
			else
			{
				...
				{
					cSPkg.stPkgData.stBattleListReq.stBattleList.stBattleList.BattleHeroList[i] = selectHeroIDList.get_Item(i);
				}
			}
			Singleton<NetworkModule>.GetInstance().SendLobbyMsg(ref cSPkg, true);
		}
		...
		public static void PostAdventureSingleGame(CSDT_BATTLE_PLAYER_BRIEF stBattlePlayer)
		{
			...
			if (dataByKey != null && (dataByKey.iLevelType == 0 || (dataByKey.iLevelType == 4 && Singleton<CBattleGuideManager>.instance.bTrainingAdv)))
			{
				...
				for (int i = 0; i < Singleton<CHeroSelectBaseSystem>.instance.m_selectHeroIDList.get_Count(); i++)
				{
					stBattlePlayer.astFighter[0].astChoiceHero[i].stBaseInfo.stCommonInfo.dwHeroID = Singleton<CHeroSelectBaseSystem>.instance.m_selectHeroIDList.get_Item(i);
				}
				int num = 1;
		...
		public static void PostCombatSingleGame(CSDT_BATTLE_PLAYER_BRIEF stBattlePlayer)
		{
			...
			if (Singleton<CHeroSelectBaseSystem>.instance.m_isAllowDupHero == 0)
			{
				...
				array[(cOM_PLAYERCAMP == COM_PLAYERCAMP.COM_PLAYERCAMP_1) ? 0 : 1] = Singleton<CHeroSelectBaseSystem>.instance.GetPveTeamHeroIDList();
			}
			int num = 0;
		...
		public static void ImpCalc9SlotHeroStandingPosition(ref Calc9SlotHeroData[] heroes)
		{
			...
			case 2:
			{
				...
				int num2 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
				heroes[num2].selected = true;
				heroes[num2].BornIndex = 1;
				num2 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
				heroes[num2].selected = true;
			...
			case 3:
			{
				int num3 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
				heroes[num3].selected = true;
				heroes[num3].BornIndex = 1;
				num3 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
				heroes[num3].selected = true;
			...
			default:
				...
				case 1:
				{
					...
					int num4 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num4].selected = true;
					heroes[num4].BornIndex = 8;
					num4 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num4].selected = true;
				...
				case 2:
				{
					...
					int num5 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num5].selected = true;
					heroes[num5].BornIndex = 1;
					num5 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num5].selected = true;
				...
				case 3:
				{
					int num6 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num6].selected = true;
					heroes[num6].BornIndex = 1;
					num6 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num6].selected = true;
				...
				default:
				{
					int num7 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num7].selected = true;
					heroes[num7].BornIndex = 4;
					num7 = CHeroSelectBaseSystem.WhoIsBestHero(ref heroes);
					heroes[num7].selected = true;
		...
		public static void ReciveDefaultSelectHeroes(CSPkg msg)
		{
			...
			if (Singleton<CHeroSelectBaseSystem>.instance.uiType == enUIType.enNormal)
			{
				if (flag)
				{
					Singleton<CHeroSelectNormalSystem>.GetInstance().m_showHeroID = Singleton<CHeroSelectBaseSystem>.instance.m_selectHeroIDList.get_Item(0);
				}
