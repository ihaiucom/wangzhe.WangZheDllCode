...
namespace Assets.Scripts.GameSystem
{
	public class CSignalButton
	{
		...
		public void Initialize(CUIFormScript formScript)
		{
			...
			{
				this.m_buttonImage.SetSprite(CUIUtility.s_battleSignalPrefabDir + ((this.m_signalInfo.bSignalType == 0) ? "Signal_Btn_Normal.prefab" : "Signal_Btn_Voice.prefab"), formScript, true, false, false, false);
			}
			...
			{
				this.m_highLightImage.SetSprite(CUIUtility.s_battleSignalPrefabDir + ((this.m_signalInfo.bSignalType == 0) ? "Signal_Btn_Normal_Highlight.prefab" : "Signal_Btn_Voice_Highlight.prefab"), formScript, true, false, false, false);
			}
