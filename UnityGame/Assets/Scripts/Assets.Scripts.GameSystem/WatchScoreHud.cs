...
namespace Assets.Scripts.GameSystem
{
	public class WatchScoreHud
	{
		...
		{
			this._campMoneyText_1.set_text(string.Format("{0:N1}k", (float)campMoney_1 * 0.001f));
			this._campMoneyText_2.set_text(string.Format("{0:N1}k", (float)campMoney_2 * 0.001f));
		}
