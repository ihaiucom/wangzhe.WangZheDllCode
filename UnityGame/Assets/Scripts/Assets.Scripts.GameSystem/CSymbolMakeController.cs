	...
	public class CSymbolMakeController : Singleton<CSymbolMakeController>
	{
		...
		private void InitSymbolCfgList()
		{
			...
			while (enumerator.MoveNext())
			{
				...
				ResSymbolInfo resSymbolInfo = (ResSymbolInfo)current.get_Value();
		...
		public void RefreshSymbolMakeForm()
		{
			...
			componetInChild.set_text(this.GetBreakExcessSymbolCoinCnt(65535).ToString());
		}
		...
		public void RefreshSymbolTransformForm()
		{
			...
			component2.set_text(StringHelper.UTF8BytesToString(ref this.m_curTransformSymbol.szName));
			...
			if (useableContainer != null)
			{
				...
				CTextManager instance = Singleton<CTextManager>.GetInstance();
				component3.set_text((num > 0) ? string.Format(instance.GetText("Symbol_Own_Cnt"), num) : instance.GetText("Symbol_Not_Own"));
			}
			...
			component4.set_text(this.m_curTransformSymbol.dwMakeCoin.ToString());
			Text component5 = gameObject.transform.Find("breakCoinText").GetComponent<Text>();
			component5.set_text(this.m_curTransformSymbol.dwBreakCoin.ToString());
		...
		private void OnBreakListItemEnable(CUIEvent uiEvent)
		{
			...
			if (cBreakSymbolItem != null && cBreakSymbolItem.symbol != null)
			{
				...
				if (transform2 != null)
				{
					...
					component2.set_isOn(cBreakSymbolItem.bBreakToggle);
				}
			}
		}
		...
		private void OnBreakListItemSelToggle(CUIEvent uiEvent)
		{
			...
			if (cBreakSymbolItem != null && cBreakSymbolItem.symbol != null && uiEvent.m_srcWidget != null)
			{
				...
				cBreakSymbolItem.bBreakToggle = component.get_isOn();
			}
		}
		...
		private void RefreshSymbolBreakForm()
		{
			...
			component.set_text(selectBreakSymbolCoinCnt.ToString());
		}
