...
namespace Assets.Scripts.GameSystem
{
	public class CombineData
	{
		...
		public CombineData()
		{
			this.type_taskList_array[(int)((uint)((UIntPtr)0uL))] = new ListView<CTask>();
			this.type_taskList_array[(int)((uint)((UIntPtr)1uL))] = new ListView<CTask>();
			this.type_taskList_array[(int)((uint)((UIntPtr)2uL))] = new ListView<CTask>();
		}
		...
		public ListView<CTask> GetListView(int type)
		{
			if (type >= 0 && type < 3)
			{
				return this.type_taskList_array[(int)((uint)((UIntPtr)((ulong)((long)type))))];
			}
			return null;
		}
		...
		public ListView<CTask> GetListView(uint type)
		{
			if (type >= 0u && type < 3u)
			{
				return this.type_taskList_array[(int)((uint)((UIntPtr)type))];
			}
			return null;
		}
