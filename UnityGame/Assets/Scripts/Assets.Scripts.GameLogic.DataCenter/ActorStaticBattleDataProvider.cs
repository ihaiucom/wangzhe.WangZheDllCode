...
namespace Assets.Scripts.GameLogic.DataCenter
{
	internal class ActorStaticBattleDataProvider : ActorStaticDataProviderBase
	{
		...
		protected override bool BuildMonsterData(ref ActorMeta actorMeta, ref ActorStaticData actorData)
		{
			...
			actorData.TheBaseAttribute.BaseHp = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iBaseHP : resMonsterCfgInfo.iBaseHP);
			actorData.TheBaseAttribute.PerLvHp = 0;
			actorData.TheBaseAttribute.BaseAd = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iAD : resMonsterCfgInfo.iBaseATT);
			actorData.TheBaseAttribute.PerLvAd = 0;
			actorData.TheBaseAttribute.BaseAp = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iAP : resMonsterCfgInfo.iBaseINT);
			actorData.TheBaseAttribute.PerLvAp = 0;
			actorData.TheBaseAttribute.BaseAtkSpeed = 0;
			actorData.TheBaseAttribute.PerLvAtkSpeed = 0;
			actorData.TheBaseAttribute.BaseDef = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iDef : resMonsterCfgInfo.iBaseDEF);
			actorData.TheBaseAttribute.PerLvDef = 0;
			actorData.TheBaseAttribute.BaseRes = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iRes : resMonsterCfgInfo.iBaseRES);
		...
		protected override bool BuildOrganData(ref ActorMeta actorMeta, ref ActorStaticData actorData)
		{
			...
			actorData.TheBaseAttribute.EpType = 1u;
			actorData.TheBaseAttribute.BaseHp = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iBaseHP : dataCfgInfoByCurLevelDiff.iBaseHP);
			actorData.TheBaseAttribute.PerLvHp = dataCfgInfoByCurLevelDiff.iHPLvlup;
			actorData.TheBaseAttribute.BaseAd = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iAD : dataCfgInfoByCurLevelDiff.iBaseATT);
			actorData.TheBaseAttribute.PerLvAd = dataCfgInfoByCurLevelDiff.iATTLvlup;
			actorData.TheBaseAttribute.BaseAp = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iAP : dataCfgInfoByCurLevelDiff.iBaseINT);
			...
			actorData.TheBaseAttribute.BaseDef = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iDef : dataCfgInfoByCurLevelDiff.iBaseDEF);
			actorData.TheBaseAttribute.PerLvDef = dataCfgInfoByCurLevelDiff.iDEFLvlup;
			actorData.TheBaseAttribute.BaseRes = ((dynamicAttributeInfo != null) ? dynamicAttributeInfo.iRes : dataCfgInfoByCurLevelDiff.iBaseRES);
