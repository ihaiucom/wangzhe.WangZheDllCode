...
namespace behaviac
{
	internal class Condition_bt_WrapperAI_Monster_BTMonsterPassive_zhouwang_node246 : Condition
	{
		private int opl_p1;

		public Condition_bt_WrapperAI_Monster_BTMonsterPassive_zhouwang_node246()
		{
			this.opl_p1 = 600;
		}
