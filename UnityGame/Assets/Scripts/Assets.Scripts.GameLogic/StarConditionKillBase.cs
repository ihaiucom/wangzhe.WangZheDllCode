...
namespace Assets.Scripts.GameLogic
{
	public abstract class StarConditionKillBase : StarCondition
	{
		...
		public override StarEvaluationStatus status
		{
			get
			{
				return this.bCachedResult ? StarEvaluationStatus.Success : StarEvaluationStatus.Failure;
			}
		}
		...
		public override string description
		{
			get
			{
				return string.Format("[{0}/{1}]", (this.killCnt > this.targetCount) ? this.targetCount : this.killCnt, this.targetCount);
			}
		}
