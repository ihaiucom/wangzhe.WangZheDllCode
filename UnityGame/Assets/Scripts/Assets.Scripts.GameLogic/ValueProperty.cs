...
namespace Assets.Scripts.GameLogic
{
	public class ValueProperty : LogicComponent
	{
		...
		public int actorHp
		{
			...
			set
			{
				int num = (value > this.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MAXHP].totalValue) ? this.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MAXHP].totalValue : ((value < 0) ? 0 : value);
		...
		public int actorEp
		{
			get
			{
				return (this.mEnergy != null) ? this.mEnergy._actorEp : 0;
			}
			set
			{
		...
		public int actorEpTotal
		{
			get
			{
				return (this.mEnergy != null) ? this.mEnergy.actorEpTotal : 1;
			}
		}
		...
		public int actorEpRecTotal
		{
			get
			{
				return (this.mEnergy != null) ? this.mEnergy.actorEpRecTotal : 0;
			}
		}
		...
		public void AddSoulExp(int addVal, bool bFloatDigit, AddSoulType type)
		{
			...
			while (this.actorSoulExp >= this.actorSoulMaxExp)
			{
				...
				this.ObjValueStatistic.iSoulExpMax = ((this.ObjValueStatistic.iSoulExpMax > addVal) ? this.ObjValueStatistic.iSoulExpMax : addVal);
			}
