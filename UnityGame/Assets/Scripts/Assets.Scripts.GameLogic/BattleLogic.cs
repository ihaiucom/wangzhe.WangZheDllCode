	...
	public class BattleLogic : Singleton<BattleLogic>, IUpdateLogic
	{
		...
		protected void OnFinish(PoolObjHandle<ActorRoot> src, PoolObjHandle<ActorRoot> atker, int dialogID)
		{
			...
			if (dialogID > 0)
			{
				...
				GameObject inAtker = atker ? atker.handle.gameObject : null;
		...
		public bool PrepareFight()
		{
			...
			Singleton<CBattleSystem>.GetInstance().OpenForm(Singleton<WatchController>.GetInstance().IsWatching ? CBattleSystem.FormType.Watch : CBattleSystem.FormType.Fight);
		...
		private void SendSecureStartInfoReq()
		{
			...
			cSPkg.stPkgData.stSecureInfoStartReq.dwClientStartTime = (uint)timeSpan.get_TotalSeconds();
			...
			{
				stSecureInfoStartReq.iSvrBossHPMax = ((stSecureInfoStartReq.iSvrBossHPMax > list.get_Item(i).handle.ValueComponent.actorHp) ? stSecureInfoStartReq.iSvrBossHPMax : list.get_Item(i).handle.ValueComponent.actorHp);
				if (stSecureInfoStartReq.iSvrBossHPMin == 0)
				{
					stSecureInfoStartReq.iSvrBossHPMin = list.get_Item(i).handle.ValueComponent.actorHp;
				}
				else
				{
					stSecureInfoStartReq.iSvrBossHPMin = ((stSecureInfoStartReq.iSvrBossHPMin < list.get_Item(i).handle.ValueComponent.actorHp) ? stSecureInfoStartReq.iSvrBossHPMin : list.get_Item(i).handle.ValueComponent.actorHp);
				}
				stSecureInfoStartReq.iSvrBossHPTotal += list.get_Item(i).handle.ValueComponent.actorHp;
				int totalValue = list.get_Item(i).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
				stSecureInfoStartReq.iSvrBossAttackMax = ((stSecureInfoStartReq.iSvrBossAttackMax > totalValue) ? stSecureInfoStartReq.iSvrBossAttackMax : totalValue);
				...
				{
					stSecureInfoStartReq.iSvrBossAttackMin = ((stSecureInfoStartReq.iSvrBossAttackMin < totalValue) ? stSecureInfoStartReq.iSvrBossAttackMin : totalValue);
				}
				if (list.get_Count() > 0)
				{
					stSecureInfoStartReq.iSvrEmenyCardID1 = list.get_Item(0).handle.TheActorMeta.ConfigId;
					stSecureInfoStartReq.iSvrEmenyCardHP1 = list.get_Item(0).handle.ValueComponent.actorHp;
					int num = list.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardATN1 = num;
					num = list.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardINT1 = num;
					num = list.get_Item(0).handle.ValueComponent.actorMoveSpeed;
					stSecureInfoStartReq.iSvrEmenyCardSpeed1 = num;
					num = list.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardPhyDef1 = num;
					num = list.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardSpellDef1 = num;
				}
				if (list.get_Count() > 1)
				{
					stSecureInfoStartReq.iSvrEmenyCardID2 = list.get_Item(1).handle.TheActorMeta.ConfigId;
					stSecureInfoStartReq.iSvrEmenyCardHP2 = list.get_Item(1).handle.ValueComponent.actorHp;
					int num2 = list.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardATN2 = num2;
					num2 = list.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardINT2 = num2;
					num2 = list.get_Item(1).handle.ValueComponent.actorMoveSpeed;
					stSecureInfoStartReq.iSvrEmenyCardSpeed2 = num2;
					num2 = list.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardPhyDef2 = num2;
					num2 = list.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardSpellDef2 = num2;
				}
				if (list.get_Count() > 2)
				{
					stSecureInfoStartReq.iSvrEmenyCardID3 = list.get_Item(2).handle.TheActorMeta.ConfigId;
					stSecureInfoStartReq.iSvrEmenyCardHP3 = list.get_Item(2).handle.ValueComponent.actorHp;
					int num3 = list.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardATN3 = num3;
					num3 = list.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardINT3 = num3;
					num3 = list.get_Item(2).handle.ValueComponent.actorMoveSpeed;
					stSecureInfoStartReq.iSvrEmenyCardSpeed3 = num3;
					num3 = list.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
					stSecureInfoStartReq.iSvrEmenyCardPhyDef3 = num3;
					num3 = list.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
			...
			for (int j = 0; j < organActors.get_Count(); j++)
			{
				...
				{
					stSecureInfoStartReq.iSvrEmenyBuildingHPMax = ((stSecureInfoStartReq.iSvrEmenyBuildingHPMax > actorHp) ? stSecureInfoStartReq.iSvrEmenyBuildingHPMax : actorHp);
					...
					{
						stSecureInfoStartReq.iSvrEmenyBuildingHPMin = ((stSecureInfoStartReq.iSvrEmenyBuildingHPMin < actorHp) ? stSecureInfoStartReq.iSvrEmenyBuildingHPMin : actorHp);
					}
					stSecureInfoStartReq.iSvrEmenyHPTotal += actorHp;
					stSecureInfoStartReq.iSvrEmenyBuildingAttackMax = ((stSecureInfoStartReq.iSvrEmenyBuildingAttackMax > totalValue2) ? stSecureInfoStartReq.iSvrEmenyBuildingAttackMax : totalValue2);
					...
					{
						stSecureInfoStartReq.iSvrEmenyBuildingAttackMin = ((stSecureInfoStartReq.iSvrEmenyBuildingAttackMin < totalValue2) ? stSecureInfoStartReq.iSvrEmenyBuildingAttackMin : totalValue2);
					}
				}
				else
				{
					stSecureInfoStartReq.iSvrBuildingHPMax = ((stSecureInfoStartReq.iSvrBuildingHPMax > actorHp) ? stSecureInfoStartReq.iSvrBuildingHPMax : actorHp);
					...
					{
						stSecureInfoStartReq.iSvrBuildingHPMin = ((stSecureInfoStartReq.iSvrBuildingHPMin < actorHp) ? stSecureInfoStartReq.iSvrBuildingHPMin : actorHp);
					}
					stSecureInfoStartReq.iSvrBuildingAttackMax = ((stSecureInfoStartReq.iSvrBuildingAttackMax > totalValue2) ? stSecureInfoStartReq.iSvrBuildingAttackMax : totalValue2);
					...
					{
						stSecureInfoStartReq.iSvrBuildingAttackMin = ((stSecureInfoStartReq.iSvrBuildingAttackMin < totalValue2) ? stSecureInfoStartReq.iSvrBuildingAttackMin : totalValue2);
					}
				}
			}
			...
			for (int k = 0; k < list2.get_Count(); k++)
			{
				...
				stSecureInfoStartReq.iSvrEmenyHPMax = ((stSecureInfoStartReq.iSvrEmenyHPMax > actorHp2) ? stSecureInfoStartReq.iSvrEmenyHPMax : actorHp2);
				...
				{
					stSecureInfoStartReq.iSvrEmenyHPMin = ((stSecureInfoStartReq.iSvrEmenyHPMin < actorHp2) ? stSecureInfoStartReq.iSvrEmenyHPMin : actorHp2);
				}
				stSecureInfoStartReq.iSvrEmenyAttackMax = ((stSecureInfoStartReq.iSvrEmenyAttackMax > totalValue3) ? stSecureInfoStartReq.iSvrEmenyAttackMax : totalValue3);
				...
				{
					stSecureInfoStartReq.iSvrEmenyAttackMin = ((stSecureInfoStartReq.iSvrEmenyAttackMin < totalValue3) ? stSecureInfoStartReq.iSvrEmenyAttackMin : totalValue3);
				}
			}
			...
			{
				stSecureInfoStartReq.iSvrUserCardID1 = list3.get_Item(0).handle.TheActorMeta.ConfigId;
				stSecureInfoStartReq.iSvrUserCardHP1 = list3.get_Item(0).handle.ValueComponent.actorHp;
				int num4 = list3.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardATN1 = num4;
				num4 = list3.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardINT1 = num4;
				num4 = list3.get_Item(0).handle.ValueComponent.actorMoveSpeed;
				stSecureInfoStartReq.iSvrUserCardSpeed1 = num4;
				num4 = list3.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardPhyDef1 = num4;
				num4 = list3.get_Item(0).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardSpellDef1 = num4;
			}
			if (list3.get_Count() > 1)
			{
				stSecureInfoStartReq.iSvrUserCardID2 = list3.get_Item(1).handle.TheActorMeta.ConfigId;
				stSecureInfoStartReq.iSvrUserCardHP2 = list3.get_Item(1).handle.ValueComponent.actorHp;
				int num5 = list3.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardATN2 = num5;
				num5 = list3.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardINT2 = num5;
				num5 = list3.get_Item(1).handle.ValueComponent.actorMoveSpeed;
				stSecureInfoStartReq.iSvrUserCardSpeed2 = num5;
				num5 = list3.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardPhyDef2 = num5;
				num5 = list3.get_Item(1).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardSpellDef2 = num5;
			}
			if (list3.get_Count() > 2)
			{
				stSecureInfoStartReq.iSvrUserCardID3 = list3.get_Item(2).handle.TheActorMeta.ConfigId;
				stSecureInfoStartReq.iSvrUserCardHP3 = list3.get_Item(2).handle.ValueComponent.actorHp;
				int num6 = list3.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardATN3 = num6;
				num6 = list3.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCATKPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardINT3 = num6;
				num6 = list3.get_Item(2).handle.ValueComponent.actorMoveSpeed;
				stSecureInfoStartReq.iSvrUserCardSpeed3 = num6;
				num6 = list3.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_PHYDEFPT].totalValue;
				stSecureInfoStartReq.iSvrUserCardPhyDef3 = num6;
				num6 = list3.get_Item(2).handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_FUNCEFT_MGCDEFPT].totalValue;
		...
		public void DealGameSurrender(byte bWinCamp)
		{
			...
			this.battleStat.iBattleResult = (((byte)playerCamp == bWinCamp) ? 1 : 2);
			COM_PLAYERCAMP camp;
		...
		private void OnActorDamage(ref HurtEventResultInfo hri)
		{
			...
			if ((ptr && ActorHelper.IsHostActor(ref ptr)) || (ptr2 && ActorHelper.IsHostActor(ref ptr2)))
			{
				...
				{
					dIGIT_TYPE = ((hri.critValue > 0) ? DIGIT_TYPE.MagicAttackCrit : DIGIT_TYPE.MagicAttackNormal);
				}
				else if (hri.hurtInfo.hurtType == HurtTypeDef.PhysHurt)
				{
					dIGIT_TYPE = ((hri.critValue > 0) ? DIGIT_TYPE.PhysicalAttackCrit : DIGIT_TYPE.PhysicalAttackNormal);
				}
				else
				{
					dIGIT_TYPE = ((hri.critValue > 0) ? DIGIT_TYPE.RealAttackCrit : DIGIT_TYPE.RealAttackNormal);
				}
			}
			if (dIGIT_TYPE != DIGIT_TYPE.Invalid)
			{
				...
				if (hri.hpChanged != 0)
				{
					int value = (dIGIT_TYPE == DIGIT_TYPE.ReviveHp) ? hri.hpChanged : hri.hurtTotal;
		...
		public int JudgeBattleResult(PoolObjHandle<ActorRoot> src, PoolObjHandle<ActorRoot> atker)
		{
			...
			if (Singleton<WinLoseByStarSys>.instance.bStarted)
			{
				...
				if (src)
				{
					...
					return (playerCamp != (int)src.handle.TheActorMeta.ActorCamp) ? 1 : 2;
				}
				return 0;
			}
			else
		...
		public static COM_PLAYERCAMP[] GetOthersCmp(COM_PLAYERCAMP InCamp)
		{
			...
			for (int i = 0; i < num; i++)
			{
				if (i != (int)InCamp)
				{
					array[((i > (int)InCamp) ? 0 : num) + (i - (int)InCamp) - 1] = (COM_PLAYERCAMP)i;
				}
			}
			return array;
		}
		...
		{
			return ((otherCamp > myCamp) ? 0 : 3) + (otherCamp - myCamp) - 1;
		}
		...
		public int GetDragonBuffId(RES_SKILL_SRC_TYPE type)
		{
			...
			this.s_dragonBuffIds.TryGetValue((uint)type, ref result);
			return result;
		}
		...
		public static HashSet<uint> GetAssistSet(PoolObjHandle<ActorRoot> victim, PoolObjHandle<ActorRoot> attker, bool excludeAttker)
		{
			...
			uint num = attker ? attker.handle.ObjID : 0u;
			if (victim)
			{
