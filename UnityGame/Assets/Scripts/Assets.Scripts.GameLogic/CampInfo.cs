...
namespace Assets.Scripts.GameLogic
{
	public class CampInfo
	{
		...
		public event CampInfo.CampInfoValueChanged onCampScoreChanged
		{
			...
			add
			{
				this.onCampScoreChanged = (CampInfo.CampInfoValueChanged)Delegate.Combine(this.onCampScoreChanged, value);
			}
			[MethodImpl(32)]
			remove
			{
				this.onCampScoreChanged = (CampInfo.CampInfoValueChanged)Delegate.Remove(this.onCampScoreChanged, value);
			}
		}
