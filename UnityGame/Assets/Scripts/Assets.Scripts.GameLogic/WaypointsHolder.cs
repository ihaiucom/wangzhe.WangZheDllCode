...
namespace Assets.Scripts.GameLogic
{
	public class WaypointsHolder : FuncRegion
	{
		...
		public Waypoint startPoint
		{
			get
			{
				return (this.wayPoints != null && this.wayPoints.Length > 0) ? this.wayPoints[0] : null;
			}
		}
		...
		public Waypoint endPoint
		{
			get
			{
				return (this.wayPoints != null && this.wayPoints.Length > 0) ? this.wayPoints[this.wayPoints.Length - 1] : null;
			}
		}
		...
		public Waypoint GetNextPoint(Waypoint InPoint)
		{
			...
			return (InPoint.AccessIndex < this.wayPoints.Length - 1) ? this.wayPoints[InPoint.AccessIndex + 1] : null;
		}
		...
		public Waypoint GetPrePoint(Waypoint InPoint)
		{
			...
			return (InPoint.AccessIndex > 0) ? this.wayPoints[InPoint.AccessIndex - 1] : null;
		}
		...
		private Waypoint[] FindChildrenPoints()
		{
			...
			if (componentsInChildren.Length > 0)
			{
				...
				{
					array[num] = (enumerator.get_Current() as Waypoint);
