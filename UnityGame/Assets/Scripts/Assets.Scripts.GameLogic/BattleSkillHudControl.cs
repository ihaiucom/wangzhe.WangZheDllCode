		...
		public void AddHighlightForActor(PoolObjHandle<ActorRoot> actor, bool bPauseGame)
		{
			...
			if (gameObject != null)
			{
				...
				if (gameObject2 != null)
				{
					...
					CUIEventScript cUIEventScript2 = cUIEventScript;
					cUIEventScript2.onClick = (CUIEventScript.OnUIEventHandler)Delegate.Combine(cUIEventScript2.onClick, new CUIEventScript.OnUIEventHandler(this.HighliterForActorClickHandler));
