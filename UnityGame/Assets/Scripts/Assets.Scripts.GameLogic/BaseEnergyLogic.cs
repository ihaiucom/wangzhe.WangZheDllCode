...
namespace Assets.Scripts.GameLogic
{
	public class BaseEnergyLogic
	{
		...
		public virtual int _actorEp
		{
			...
			protected set
			{
				int num = (value > this.actor.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_PROPERTY_MAXEP].totalValue) ? this.actor.handle.ValueComponent.mActorValue[RES_FUNCEFT_TYPE.RES_PROPERTY_MAXEP].totalValue : ((value < 0) ? 0 : value);
