...
namespace com.tencent.gsdk
{
	public class GSDK
	{
		...
		private static event GSDK.GSDKKartinObserver sKartinNotifyEvent
		{
			...
			add
			{
				GSDK.sKartinNotifyEvent = (GSDK.GSDKKartinObserver)Delegate.Combine(GSDK.sKartinNotifyEvent, value);
			}
			[MethodImpl(32)]
			remove
			{
				GSDK.sKartinNotifyEvent = (GSDK.GSDKKartinObserver)Delegate.Remove(GSDK.sKartinNotifyEvent, value);
			}
		}
