...
namespace com.tencent.pandora
{
	public class Pandora
	{
		...
		public void SetPanelParent(GameObject thePanelParent, string panelParentName)
		{
			...
			{
				this.panelParentDic.set_Item(panelParentName, thePanelParent);
			}
			else
			{
		...
		public string GetGameImgPath(int rankClass, int rankGrade)
		{
			...
			{
				result = this.callbackForGameImgPath.Invoke(rankClass, rankGrade);
			}
			return result;
		}
		...
		public int ShowGameImgByPath(GameObject go, string iconPath)
		{
			...
			{
				result = this.callbackForSetGameImgByPath.Invoke(go, iconPath);
			}
			return result;
		}
		...
		public string QueryFriendsList()
		{
			...
			{
				result = this.callbackForFriendsList.Invoke();
			}
			return result;
		}
		...
		public string QuerySearchConfig()
		{
			...
			{
				result = this.callbackForSearchConfig.Invoke();
			}
			return result;
		}
		...
		public string QueryRankShowName(int rankClass, int rankShowGrade)
		{
			...
			{
				return this.callbackForRankShowName.Invoke(rankClass, rankShowGrade);
			}
			return string.Empty;
		}
		...
		{
			Logger.DEBUG(string.Empty);
			if (this.panelParentDic.ContainsKey(panelParentName) && this.panelParentDic.get_Item(panelParentName) != null)
			{
				return this.panelParentDic.get_Item(panelParentName);
			}
			return null;
		}
