...
public class NewbieGuideScriptControl : MonoBehaviour
{
	...
	public event NewbieGuideScriptControl.NewbieGuideScriptControlDelegate CompleteEvent
	{
		...
		add
		{
			this.CompleteEvent = (NewbieGuideScriptControl.NewbieGuideScriptControlDelegate)Delegate.Combine(this.CompleteEvent, value);
		}
		[MethodImpl(32)]
		remove
		{
			this.CompleteEvent = (NewbieGuideScriptControl.NewbieGuideScriptControlDelegate)Delegate.Remove(this.CompleteEvent, value);
		}
	}
	...
	public event NewbieGuideScriptControl.NewbieGuideScriptControlDelegate SaveEvent
	{
		...
		add
		{
			this.SaveEvent = (NewbieGuideScriptControl.NewbieGuideScriptControlDelegate)Delegate.Combine(this.SaveEvent, value);
		}
		[MethodImpl(32)]
		remove
		{
			this.SaveEvent = (NewbieGuideScriptControl.NewbieGuideScriptControlDelegate)Delegate.Remove(this.SaveEvent, value);
		}
	}
