...
namespace ResData
{
	public class ResDT_WealCommon : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResDT_WealCommon.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResDT_WealCommon.LENGTH_szTitle)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResDT_WealCommon.LENGTH_szWidgets)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResDT_WealCommon.LENGTH_szBrief)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResDT_WealCommon.LENGTH_szIcon)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num11 > (ulong)ResDT_WealCommon.LENGTH_szDescContent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num13 > (ulong)ResDT_WealCommon.LENGTH_szTips)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num15 > (ulong)ResDT_WealCommon.LENGTH_szTimeDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
