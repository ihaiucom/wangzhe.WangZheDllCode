...
namespace ResData
{
	public class ResRareExchange : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResRareExchange.LENGTH_szOnTime)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResRareExchange.LENGTH_szOffTime)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
