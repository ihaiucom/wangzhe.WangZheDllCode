...
namespace ResData
{
	public class ResSkillCombineCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResSkillCombineCfgInfo.LENGTH_szSkillCombineName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResSkillCombineCfgInfo.LENGTH_szSkillCombineDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResSkillCombineCfgInfo.LENGTH_szPrefab)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResSkillCombineCfgInfo.LENGTH_szIconPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResSkillCombineCfgInfo.LENGTH_szNameReplacement)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num11 > (ulong)ResSkillCombineCfgInfo.LENGTH_szNameReplacementColor)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
