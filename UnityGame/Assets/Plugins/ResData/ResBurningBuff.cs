...
namespace ResData
{
	public class ResBurningBuff : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResBurningBuff.LENGTH_szBuffDesc)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResBurningBuff.LENGTH_szBuffIcon)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
