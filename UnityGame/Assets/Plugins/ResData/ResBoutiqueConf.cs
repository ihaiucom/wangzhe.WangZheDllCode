...
namespace ResData
{
	public class ResBoutiqueConf : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResBoutiqueConf.LENGTH_szOnTime)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResBoutiqueConf.LENGTH_szOffTime)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
