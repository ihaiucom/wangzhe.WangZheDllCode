...
namespace ResData
{
	public class ResFakeAcnt : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResFakeAcnt.LENGTH_szAcntName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResFakeAcnt.LENGTH_szAcntHeadUrl)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
