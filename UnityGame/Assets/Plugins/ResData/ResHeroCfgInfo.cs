...
namespace ResData
{
	public class ResHeroCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResHeroCfgInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResHeroCfgInfo.LENGTH_szNamePinYin)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResHeroCfgInfo.LENGTH_szHeroTitle)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResHeroCfgInfo.LENGTH_szStoryUrl)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResHeroCfgInfo.LENGTH_szImagePath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num11 > (ulong)ResHeroCfgInfo.LENGTH_szCharacterInfo)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num13 > (ulong)ResHeroCfgInfo.LENGTH_szHeroDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num15 > (ulong)ResHeroCfgInfo.LENGTH_szAI_Entry)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num17 > (ulong)ResHeroCfgInfo.LENGTH_szAI_Simple)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num19 > (ulong)ResHeroCfgInfo.LENGTH_szAI_Normal)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num21 > (ulong)ResHeroCfgInfo.LENGTH_szAI_Hard)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num23 > (ulong)ResHeroCfgInfo.LENGTH_szAI_WarmSimple)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num25 > (ulong)ResHeroCfgInfo.LENGTH_szAI_Warm)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num27 > (ulong)ResHeroCfgInfo.LENGTH_szWakeDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num29 > (ulong)ResHeroCfgInfo.LENGTH_szAttackRangeDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num31 > (ulong)ResHeroCfgInfo.LENGTH_szHeroTips)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num33 > (ulong)ResHeroCfgInfo.LENGTH_szHeroSound)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num35 > (ulong)ResHeroCfgInfo.LENGTH_szBorn_Age)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num37 > (ulong)ResHeroCfgInfo.LENGTH_szRevive_Age)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
