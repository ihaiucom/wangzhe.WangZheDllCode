...
namespace ResData
{
	public class ResHeroSkin : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResHeroSkin.LENGTH_szHeroName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResHeroSkin.LENGTH_szSkinName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResHeroSkin.LENGTH_szSkinPicID)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResHeroSkin.LENGTH_szSkinSoundResPack)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResHeroSkin.LENGTH_szSoundSwitchEvent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num11 > (ulong)ResHeroSkin.LENGTH_szShareSkinUrl)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num13 > (ulong)ResHeroSkin.LENGTH_szUrl)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
