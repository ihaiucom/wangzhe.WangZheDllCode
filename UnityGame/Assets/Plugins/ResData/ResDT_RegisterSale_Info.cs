...
namespace ResData
{
	public class ResDT_RegisterSale_Info : tsf4g_csharp_interface, IUnpackable
	{
		public byte bIsValid;

		public byte[] szStartTimeStr_ByteArray;

		public uint dwStartTimeGen;

		public uint dwValidTime;
		...
		public string szStartTimeStr;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly uint LENGTH_szStartTimeStr = 16u;

		public ResDT_RegisterSale_Info()
		{
			this.szStartTimeStr_ByteArray = new byte[1];
			this.szStartTimeStr = string.Empty;
		}

		private void TransferData()
		{
			this.szStartTimeStr = StringHelper.UTF8BytesToString(ref this.szStartTimeStr_ByteArray);
			this.szStartTimeStr_ByteArray = null;
		}
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			int num = 16;
			if (this.szStartTimeStr_ByteArray.GetLength(0) < num)
			{
				this.szStartTimeStr_ByteArray = new byte[ResDT_RegisterSale_Info.LENGTH_szStartTimeStr];
			}
			errorType = srcBuf.readCString(ref this.szStartTimeStr_ByteArray, num);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
