...
namespace ResData
{
	public class ResBattleFloatText : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResBattleFloatText.LENGTH_szText)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResBattleFloatText.LENGTH_szAnimation)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
