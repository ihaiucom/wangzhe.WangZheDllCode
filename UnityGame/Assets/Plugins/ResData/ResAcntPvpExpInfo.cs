...
namespace ResData
{
	public class ResAcntPvpExpInfo : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResAcntPvpExpInfo.LENGTH_szTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResAcntPvpExpInfo.LENGTH_szTitleIcon)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
