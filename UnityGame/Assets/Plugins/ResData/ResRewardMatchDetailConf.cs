...
namespace ResData
{
	public class ResRewardMatchDetailConf : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwId;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResRewardMatchDetailConf.LENGTH_szMailTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResRewardMatchDetailConf.LENGTH_szMailBody)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
