...
namespace ResData
{
	public class ResRewardInfo : tsf4g_csharp_interface, IUnpackable
	{
		...
		{
			if (cutVer == 0u || ResRewardInfo.CURRVERSION < cutVer)
			{
				cutVer = ResRewardInfo.CURRVERSION;
			}
			if (ResRewardInfo.BASEVERSION > cutVer)
			{
