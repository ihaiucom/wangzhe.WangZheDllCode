...
namespace ResData
{
	public class ResOrganCfgInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public int iNoEnemyBlockHeroAtkDamage;

		public int iNoEnemyBlockHeroAtkDamageMSec;

		public int iDetectedRadius;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResOrganCfgInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResOrganCfgInfo.LENGTH_szCharacterInfo)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			errorType = srcBuf.readInt32(ref this.iDetectedRadius);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
