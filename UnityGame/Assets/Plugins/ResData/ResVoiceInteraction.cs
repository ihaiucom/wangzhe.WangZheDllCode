...
namespace ResData
{
	public class ResVoiceInteraction : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResVoiceInteraction.LENGTH_szHeroName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResVoiceInteraction.LENGTH_szVoiceEvent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
