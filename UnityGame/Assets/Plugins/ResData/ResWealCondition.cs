...
namespace ResData
{
	public class ResWealCondition : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResWealCondition.LENGTH_szMailTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResWealCondition.LENGTH_szMailContent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
