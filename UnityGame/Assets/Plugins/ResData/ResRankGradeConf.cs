...
namespace ResData
{
	public class ResRankGradeConf : tsf4g_csharp_interface, IUnpackable
	{
		public byte bGrade;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResRankGradeConf.LENGTH_szGradeDesc)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResRankGradeConf.LENGTH_szGradePicturePath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResRankGradeConf.LENGTH_szGradePicturePathSuperMaster)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResRankGradeConf.LENGTH_szGradeSmallPicPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResRankGradeConf.LENGTH_szGradeSmallPicPathSuperMaster)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num11 > (ulong)ResRankGradeConf.LENGTH_szGradeFramePicPath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num13 > (ulong)ResRankGradeConf.LENGTH_szGradeFramePicPathSuperMaster)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num15 > (ulong)ResRankGradeConf.LENGTH_szGradeParticleBg)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num17 > (ulong)ResRankGradeConf.LENGTH_szGradeParticleBgSuperMaster)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num19 > (ulong)ResRankGradeConf.LENGTH_szBigGradeName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num21 > (ulong)ResRankGradeConf.LENGTH_szRewardDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
