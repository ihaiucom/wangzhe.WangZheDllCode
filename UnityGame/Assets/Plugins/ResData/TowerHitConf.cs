...
namespace ResData
{
	public class TowerHitConf : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)TowerHitConf.LENGTH_szVoice)
				{
			...
			{
				if ((ulong)num3 > (ulong)TowerHitConf.LENGTH_szEffect)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
