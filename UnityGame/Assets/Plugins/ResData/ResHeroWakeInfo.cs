...
namespace ResData
{
	public class ResHeroWakeInfo : tsf4g_csharp_interface, IUnpackable
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResHeroWakeInfo.LENGTH_szWakeTitle)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResHeroWakeInfo.LENGTH_szWakeDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
