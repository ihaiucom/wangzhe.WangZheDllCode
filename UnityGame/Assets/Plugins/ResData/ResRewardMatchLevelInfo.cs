...
namespace ResData
{
	public class ResRewardMatchLevelInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwMapId;

		public uint dwMatchType;

		public byte[] szMatchName_ByteArray;

		public ResDT_LevelCommonInfo stLevelCommonInfo;
		...
		public static readonly uint LENGTH_szMatchName = 128u;
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			int num = 128;
			if (this.szMatchName_ByteArray.GetLength(0) < num)
			{
				this.szMatchName_ByteArray = new byte[ResRewardMatchLevelInfo.LENGTH_szMatchName];
			}
			errorType = srcBuf.readCString(ref this.szMatchName_ByteArray, num);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = this.stLevelCommonInfo.load(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
