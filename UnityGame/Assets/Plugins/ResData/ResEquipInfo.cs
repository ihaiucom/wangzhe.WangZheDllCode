...
namespace ResData
{
	public class ResEquipInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResEquipInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResEquipInfo.LENGTH_szDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
