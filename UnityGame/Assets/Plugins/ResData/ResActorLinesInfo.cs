...
namespace ResData
{
	public class ResActorLinesInfo : tsf4g_csharp_interface, IUnpackable
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResActorLinesInfo.LENGTH_szAnimName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResActorLinesInfo.LENGTH_szImagePath)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResActorLinesInfo.LENGTH_szAgeActionName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num7 > (ulong)ResActorLinesInfo.LENGTH_szDialogTitle)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num9 > (ulong)ResActorLinesInfo.LENGTH_szDialogContent)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
