...
namespace ResData
{
	public class ResMiShuInfo : tsf4g_csharp_interface, IUnpackable
	{
		public uint dwID;
		...
		public byte[] szUnOpenDesc_ByteArray;
		...
		public static readonly uint LENGTH_szUnOpenDesc = 256u;

		public ResMiShuInfo()
		{
			this.szName_ByteArray = new byte[1];
			this.szDesc_ByteArray = new byte[1];
			this.szUnOpenDesc_ByteArray = new byte[1];
			this.szName = string.Empty;
			this.szDesc = string.Empty;
			this.szUnOpenDesc = string.Empty;
		}
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)ResMiShuInfo.LENGTH_szName)
				{
			...
			{
				if ((ulong)num3 > (ulong)ResMiShuInfo.LENGTH_szDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((ulong)num5 > (ulong)ResMiShuInfo.LENGTH_szUnOpenDesc)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
