...
public static class StringExtension
{
	...
	public static string FullPathToAssetPath(this string s)
	{
		...
		string text = StringExtension.asset_str + s.Substring(Application.dataPath.get_Length() + 1);
		return text.Replace('\\', '/');
	}
	...
	public static string AssetPathToFullPath(this string s)
	{
		...
		text += "/";
		return text + s.Remove(0, StringExtension.asset_str.get_Length());
	}
