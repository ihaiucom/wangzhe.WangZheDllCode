...
public class NcSpriteTexture : NcEffectBehaviour
{
	...
	public void SetSpriteFactoryIndex(int nSpriteFactoryIndex, int nFrameIndex, bool bRunImmediate)
	{
		...
		this.m_nFrameIndex = ((0 <= nFrameIndex) ? nFrameIndex : this.m_nFrameIndex);
		this.m_nFrameIndex = ((this.m_NcSpriteFrameInfos.Length == 0 || this.m_NcSpriteFrameInfos.Length <= this.m_nFrameIndex) ? 0 : this.m_nFrameIndex);
