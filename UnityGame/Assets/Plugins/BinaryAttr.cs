...
public struct BinaryAttr
{
	...
	public string GetValueString(Encoding encoding)
	{
		...
		return Encoding.get_UTF8().GetString(this.m_data, this.m_valueOffset, this.m_valueLen);
	}

	public string GetName()
	{
		return Encoding.get_UTF8().GetString(this.m_data, this.m_nameOffset + BinaryAttr.INT_LEN, this.m_nameLen);
	}
}
