...
{
	public class SCPKG_CMD_SEARCH_PLAYER : ProtocolObject
	{
		...
		public SCPKG_CMD_SEARCH_PLAYER()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_SEARCH_PLAYER.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_SEARCH_PLAYER.CURRVERSION;
			}
			if (SCPKG_CMD_SEARCH_PLAYER.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_SEARCH_PLAYER.CLASS_ID;
		}
