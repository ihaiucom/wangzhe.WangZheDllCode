...
namespace CSProtocol
{
	public class COMDT_WEAL_DETAIL : ProtocolObject
	{
		...
		public COMDT_WEAL_UNION stWealDetail;
		...
		{
			if (cutVer == 0u || COMDT_WEAL_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_WEAL_DETAIL.CURRVERSION;
			}
			if (COMDT_WEAL_DETAIL.BASEVERSION > cutVer)
			{
			...
			errorType = this.stWealDetail.pack(selector, ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			long selector = (long)this.bWealType;
			errorType = this.stWealDetail.unpack(selector, ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_WEAL_DETAIL.CLASS_ID;
		}
