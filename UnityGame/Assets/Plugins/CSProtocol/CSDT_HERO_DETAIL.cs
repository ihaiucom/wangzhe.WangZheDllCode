...
namespace CSProtocol
{
	public class CSDT_HERO_DETAIL : ProtocolObject
	{
		...
		public CSDT_HERO_WEARINFO[] astGearWear;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 208u;

		public static readonly int CLASS_ID = 862;
		...
		{
			if (cutVer == 0u || CSDT_HERO_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = CSDT_HERO_DETAIL.CURRVERSION;
			}
			if (CSDT_HERO_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_HERO_DETAIL.CLASS_ID;
		}
