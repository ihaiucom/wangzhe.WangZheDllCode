...
{
	public class SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP : ProtocolObject
	{
		public byte bPos1;
		...
		public static readonly int CLASS_ID = 1572;

		public SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP.CURRVERSION;
			}
			if (SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP.LENGTH_szBeiZhu)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return SCPKG_GUILD_MATCH_SELFSIGNUPINFO_RSP.CLASS_ID;
		}
