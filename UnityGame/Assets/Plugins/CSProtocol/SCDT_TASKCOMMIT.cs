...
{
	public class SCDT_TASKCOMMIT : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1105;
		...
		{
			if (cutVer == 0u || SCDT_TASKCOMMIT.CURRVERSION < cutVer)
			{
				cutVer = SCDT_TASKCOMMIT.CURRVERSION;
			}
			if (SCDT_TASKCOMMIT.BASEVERSION > cutVer)
			{
		...
		{
			return SCDT_TASKCOMMIT.CLASS_ID;
		}
