...
{
	public class CSDT_SNS_NICKNAME : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 1066;

		public CSDT_SNS_NICKNAME()
		{
		...
		{
			if (cutVer == 0u || CSDT_SNS_NICKNAME.CURRVERSION < cutVer)
			{
				cutVer = CSDT_SNS_NICKNAME.CURRVERSION;
			}
			if (CSDT_SNS_NICKNAME.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((ulong)num > (ulong)CSDT_SNS_NICKNAME.LENGTH_szNickName)
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSDT_SNS_NICKNAME.CLASS_ID;
		}
