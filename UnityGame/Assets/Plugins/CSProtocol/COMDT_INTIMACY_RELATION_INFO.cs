...
namespace CSProtocol
{
	public class COMDT_INTIMACY_RELATION_INFO : ProtocolObject
	{
		...
		public COMDT_INTIMACY_CARD_INFO stIntimacyRelationData;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 625;

		public COMDT_INTIMACY_RELATION_INFO()
		{
			this.stIntimacyRelationData = (COMDT_INTIMACY_CARD_INFO)ProtocolObjectPool.Get(COMDT_INTIMACY_CARD_INFO.CLASS_ID);
		}
