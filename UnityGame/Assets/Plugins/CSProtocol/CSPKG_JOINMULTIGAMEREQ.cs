...
namespace CSProtocol
{
	public class CSPKG_JOINMULTIGAMEREQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1514;
		...
		{
			if (cutVer == 0u || CSPKG_JOINMULTIGAMEREQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_JOINMULTIGAMEREQ.CURRVERSION;
			}
			if (CSPKG_JOINMULTIGAMEREQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_JOINMULTIGAMEREQ.CLASS_ID;
		}
