...
{
	public class SCPKG_MASTERSTUDENT_DEL : ProtocolObject
	{
		public byte bType;
		...
		public static readonly int CLASS_ID = 1629;

		public SCPKG_MASTERSTUDENT_DEL()
		{
		...
		{
			if (cutVer == 0u || SCPKG_MASTERSTUDENT_DEL.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_MASTERSTUDENT_DEL.CURRVERSION;
			}
			if (SCPKG_MASTERSTUDENT_DEL.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_MASTERSTUDENT_DEL.CLASS_ID;
		}
