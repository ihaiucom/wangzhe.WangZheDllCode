...
{
	public class COMDT_ACNT_UNIQ : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 44;
		...
		{
			if (cutVer == 0u || COMDT_ACNT_UNIQ.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ACNT_UNIQ.CURRVERSION;
			}
			if (COMDT_ACNT_UNIQ.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ACNT_UNIQ.CLASS_ID;
		}
