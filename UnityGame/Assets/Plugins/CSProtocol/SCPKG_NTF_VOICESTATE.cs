...
{
	public class SCPKG_NTF_VOICESTATE : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1550;
		...
		{
			if (cutVer == 0u || SCPKG_NTF_VOICESTATE.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_NTF_VOICESTATE.CURRVERSION;
			}
			if (SCPKG_NTF_VOICESTATE.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_NTF_VOICESTATE.CLASS_ID;
		}
