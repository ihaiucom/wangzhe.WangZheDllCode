...
namespace CSProtocol
{
	public class CSPKG_GET_RANKING_LIST_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1221;
		...
		{
			if (cutVer == 0u || CSPKG_GET_RANKING_LIST_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_GET_RANKING_LIST_REQ.CURRVERSION;
			}
			if (CSPKG_GET_RANKING_LIST_REQ.BASEVERSION > cutVer)
			{
			...
			errorType = destBuf.writeInt32(this.iImageFlag);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readInt32(ref this.iImageFlag);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSPKG_GET_RANKING_LIST_REQ.CLASS_ID;
		}
