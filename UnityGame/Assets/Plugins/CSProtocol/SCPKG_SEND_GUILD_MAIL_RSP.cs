...
{
	public class SCPKG_SEND_GUILD_MAIL_RSP : ProtocolObject
	{
		public int iResult;
		...
		public static readonly int CLASS_ID = 1542;
		...
		{
			if (cutVer == 0u || SCPKG_SEND_GUILD_MAIL_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_SEND_GUILD_MAIL_RSP.CURRVERSION;
			}
			if (SCPKG_SEND_GUILD_MAIL_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_SEND_GUILD_MAIL_RSP.CLASS_ID;
		}
