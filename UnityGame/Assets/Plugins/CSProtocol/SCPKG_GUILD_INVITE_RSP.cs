...
{
	public class SCPKG_GUILD_INVITE_RSP : ProtocolObject
	{
		public byte bResult;
		...
		public static readonly int CLASS_ID = 1331;
		...
		{
			if (cutVer == 0u || SCPKG_GUILD_INVITE_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GUILD_INVITE_RSP.CURRVERSION;
			}
			if (SCPKG_GUILD_INVITE_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_GUILD_INVITE_RSP.CLASS_ID;
		}
