...
namespace CSProtocol
{
	public class COMDT_TRANSACTION_TCAPLUS_DETAIL : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 654;
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_TCAPLUS_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_TCAPLUS_DETAIL.CURRVERSION;
			}
			if (COMDT_TRANSACTION_TCAPLUS_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TRANSACTION_TCAPLUS_DETAIL.CLASS_ID;
		}
