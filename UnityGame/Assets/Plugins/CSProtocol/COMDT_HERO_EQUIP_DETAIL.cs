...
{
	public class COMDT_HERO_EQUIP_DETAIL : ProtocolObject
	{
		public byte bSelfDefine;
		...
		public static readonly int CLASS_ID = 125;

		public COMDT_HERO_EQUIP_DETAIL()
		{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt8(ref this.bSelfDefine);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_HERO_EQUIP_DETAIL.CLASS_ID;
		}
