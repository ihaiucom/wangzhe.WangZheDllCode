...
{
	public class CSPKG_CMD_EQUIPENCHANT : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 982;
		...
		{
			if (cutVer == 0u || CSPKG_CMD_EQUIPENCHANT.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_EQUIPENCHANT.CURRVERSION;
			}
			if (CSPKG_CMD_EQUIPENCHANT.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_EQUIPENCHANT.CLASS_ID;
		}
