...
namespace CSProtocol
{
	public class CSDT_CHEAT_PASS_SINGLE_GAME : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 831;
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_PASS_SINGLE_GAME.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_PASS_SINGLE_GAME.CURRVERSION;
			}
			if (CSDT_CHEAT_PASS_SINGLE_GAME.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_CHEAT_PASS_SINGLE_GAME.CLASS_ID;
		}
