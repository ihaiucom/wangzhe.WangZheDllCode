...
{
	public class CSDT_CHEAT_SET_MOBA_INFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 854;

		public CSDT_CHEAT_SET_MOBA_INFO()
		{
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_SET_MOBA_INFO.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_SET_MOBA_INFO.CURRVERSION;
			}
			if (CSDT_CHEAT_SET_MOBA_INFO.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_CHEAT_SET_MOBA_INFO.CLASS_ID;
		}
