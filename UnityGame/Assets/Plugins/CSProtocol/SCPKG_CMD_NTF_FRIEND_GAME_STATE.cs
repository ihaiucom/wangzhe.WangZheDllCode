...
{
	public class SCPKG_CMD_NTF_FRIEND_GAME_STATE : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1077;
		...
		{
			if (cutVer == 0u || SCPKG_CMD_NTF_FRIEND_GAME_STATE.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_NTF_FRIEND_GAME_STATE.CURRVERSION;
			}
			if (SCPKG_CMD_NTF_FRIEND_GAME_STATE.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_NTF_FRIEND_GAME_STATE.CLASS_ID;
		}
