...
{
	public class COMDT_GUILD_MATCH_MEMBER_SCORE_CHG : ProtocolObject
	{
		public ulong ullUid;
		...
		public byte bWeekMatchCnt;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 388;
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readUInt8(ref this.bWeekMatchCnt);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_GUILD_MATCH_MEMBER_SCORE_CHG.CLASS_ID;
		}
