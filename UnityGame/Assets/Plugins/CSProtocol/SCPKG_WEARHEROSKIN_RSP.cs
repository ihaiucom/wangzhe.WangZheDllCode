...
{
	public class SCPKG_WEARHEROSKIN_RSP : ProtocolObject
	{
		public int iResult;
		...
		public static readonly int CLASS_ID = 905;
		...
		{
			if (cutVer == 0u || SCPKG_WEARHEROSKIN_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_WEARHEROSKIN_RSP.CURRVERSION;
			}
			if (SCPKG_WEARHEROSKIN_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_WEARHEROSKIN_RSP.CLASS_ID;
		}
