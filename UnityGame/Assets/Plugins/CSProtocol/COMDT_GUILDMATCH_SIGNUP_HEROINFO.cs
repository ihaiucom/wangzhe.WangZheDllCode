...
{
	public class COMDT_GUILDMATCH_SIGNUP_HEROINFO : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || COMDT_GUILDMATCH_SIGNUP_HEROINFO.CURRVERSION < cutVer)
			{
				cutVer = COMDT_GUILDMATCH_SIGNUP_HEROINFO.CURRVERSION;
			}
			if (COMDT_GUILDMATCH_SIGNUP_HEROINFO.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_GUILDMATCH_SIGNUP_HEROINFO.CLASS_ID;
		}
