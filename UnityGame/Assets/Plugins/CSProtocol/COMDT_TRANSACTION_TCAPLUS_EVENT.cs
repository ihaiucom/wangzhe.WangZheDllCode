...
namespace CSProtocol
{
	public class COMDT_TRANSACTION_TCAPLUS_EVENT : ProtocolObject
	{
		...
		public COMDT_TRANSACTION_TCAPLUS_DETAIL stDetail;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 655;

		public COMDT_TRANSACTION_TCAPLUS_EVENT()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_TCAPLUS_EVENT.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_TCAPLUS_EVENT.CURRVERSION;
			}
			if (COMDT_TRANSACTION_TCAPLUS_EVENT.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TRANSACTION_TCAPLUS_EVENT.CLASS_ID;
		}
