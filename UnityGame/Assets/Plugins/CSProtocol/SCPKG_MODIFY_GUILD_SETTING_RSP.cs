...
{
	public class SCPKG_MODIFY_GUILD_SETTING_RSP : ProtocolObject
	{
		public byte bResult;
		...
		public static readonly int CLASS_ID = 1319;
		...
		{
			if (cutVer == 0u || SCPKG_MODIFY_GUILD_SETTING_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_MODIFY_GUILD_SETTING_RSP.CURRVERSION;
			}
			if (SCPKG_MODIFY_GUILD_SETTING_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_MODIFY_GUILD_SETTING_RSP.CLASS_ID;
		}
