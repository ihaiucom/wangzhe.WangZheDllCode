...
{
	public class COMDT_ARENAFIGHT_RSP_DETAIL : ProtocolObject
	{
		...
		public COMDT_ARENA_DESK_INFO stFightSucc
		{
			get
			{
				return this.dataObject as COMDT_ARENA_DESK_INFO;
			}
			set
			{
		...
		{
			if (cutVer == 0u || COMDT_ARENAFIGHT_RSP_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ARENAFIGHT_RSP_DETAIL.CURRVERSION;
			}
			if (COMDT_ARENAFIGHT_RSP_DETAIL.BASEVERSION > cutVer)
			{
		...
		private void select_0_0(long selector)
		{
			...
			else if (!(this.dataObject is COMDT_ARENA_DESK_INFO))
			{
				if (this.dataObject != null)
				{
					this.dataObject.Release();
		...
		{
			return COMDT_ARENAFIGHT_RSP_DETAIL.CLASS_ID;
		}
