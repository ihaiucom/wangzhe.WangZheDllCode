...
namespace CSProtocol
{
	public class CSDT_ACNT_DETAIL : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1239;
		...
		{
			if (cutVer == 0u || CSDT_ACNT_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = CSDT_ACNT_DETAIL.CURRVERSION;
			}
			if (CSDT_ACNT_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_ACNT_DETAIL.CLASS_ID;
		}
