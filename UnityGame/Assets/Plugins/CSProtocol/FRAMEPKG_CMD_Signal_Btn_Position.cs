...
{
	public class FRAMEPKG_CMD_Signal_Btn_Position : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || FRAMEPKG_CMD_Signal_Btn_Position.CURRVERSION < cutVer)
			{
				cutVer = FRAMEPKG_CMD_Signal_Btn_Position.CURRVERSION;
			}
			if (FRAMEPKG_CMD_Signal_Btn_Position.BASEVERSION > cutVer)
			{
		...
		{
			return FRAMEPKG_CMD_Signal_Btn_Position.CLASS_ID;
		}
