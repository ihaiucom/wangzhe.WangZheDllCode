...
namespace CSProtocol
{
	public class SCPKG_NTF_CUR_BAN_PICK_INFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1516;
		...
		{
			if (cutVer == 0u || SCPKG_NTF_CUR_BAN_PICK_INFO.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_NTF_CUR_BAN_PICK_INFO.CURRVERSION;
			}
			if (SCPKG_NTF_CUR_BAN_PICK_INFO.BASEVERSION > cutVer)
			{
				return TdrError.ErrorType.TDR_ERR_CUTVER_TOO_SMALL;
			}
			TdrError.ErrorType errorType = this.stCurState.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = this.stCurState.unpack(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_NTF_CUR_BAN_PICK_INFO.CLASS_ID;
		}
