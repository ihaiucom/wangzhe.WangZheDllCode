...
{
	public class SCPKG_MEMBER_ONLINE_NTF : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1316;
		...
		{
			if (cutVer == 0u || SCPKG_MEMBER_ONLINE_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_MEMBER_ONLINE_NTF.CURRVERSION;
			}
			if (SCPKG_MEMBER_ONLINE_NTF.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_MEMBER_ONLINE_NTF.CLASS_ID;
		}
