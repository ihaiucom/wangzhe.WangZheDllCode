...
{
	public class SCPKG_HONORINFOCHG_RSP : ProtocolObject
	{
		public int iHonorID;
		...
		public static readonly int CLASS_ID = 961;
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readInt32(ref this.iCurUseHonorID);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_HONORINFOCHG_RSP.CLASS_ID;
		}
