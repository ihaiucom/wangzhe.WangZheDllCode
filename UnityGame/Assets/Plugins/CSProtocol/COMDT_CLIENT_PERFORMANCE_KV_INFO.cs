...
{
	public class COMDT_CLIENT_PERFORMANCE_KV_INFO : ProtocolObject
	{
		public ushort wTime;
		...
		public static readonly int CLASS_ID = 192;
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = destBuf.writeUInt16(this.wTime);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt16(this.wValue);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_CLIENT_PERFORMANCE_KV_INFO.CLASS_ID;
		}
