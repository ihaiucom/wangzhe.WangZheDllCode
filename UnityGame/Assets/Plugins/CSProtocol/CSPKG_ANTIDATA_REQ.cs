...
{
	public class CSPKG_ANTIDATA_REQ : ProtocolObject
	{
		public ushort wLen;
		...
		public static readonly int CLASS_ID = 839;

		public CSPKG_ANTIDATA_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_ANTIDATA_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_ANTIDATA_REQ.CURRVERSION;
			}
			if (CSPKG_ANTIDATA_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_ANTIDATA_REQ.CLASS_ID;
		}
