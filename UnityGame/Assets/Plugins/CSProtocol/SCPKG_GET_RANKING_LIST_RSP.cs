...
{
	public class SCPKG_GET_RANKING_LIST_RSP : ProtocolObject
	{
		...
		public CSDT_RANKING_LIST_DETAIL stRankingListDetail;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 240u;

		public static readonly int CLASS_ID = 1222;
		...
		{
			if (cutVer == 0u || SCPKG_GET_RANKING_LIST_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GET_RANKING_LIST_RSP.CURRVERSION;
			}
			if (SCPKG_GET_RANKING_LIST_RSP.BASEVERSION > cutVer)
			{
			...
			errorType = this.stRankingListDetail.pack(selector, ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			long selector = (long)this.iErrCode;
			errorType = this.stRankingListDetail.unpack(selector, ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_GET_RANKING_LIST_RSP.CLASS_ID;
		}
