...
{
	public class SCPKG_CMD_ASKFORREQ_SEND : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1141;

		public SCPKG_CMD_ASKFORREQ_SEND()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_ASKFORREQ_SEND.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_ASKFORREQ_SEND.CURRVERSION;
			}
			if (SCPKG_CMD_ASKFORREQ_SEND.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_ASKFORREQ_SEND.CLASS_ID;
		}
