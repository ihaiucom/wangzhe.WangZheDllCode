...
{
	public class SCPKG_CMD_DEL_FRIEND : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1022;

		public SCPKG_CMD_DEL_FRIEND()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_DEL_FRIEND.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_DEL_FRIEND.CURRVERSION;
			}
			if (SCPKG_CMD_DEL_FRIEND.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_CMD_DEL_FRIEND.CLASS_ID;
		}
