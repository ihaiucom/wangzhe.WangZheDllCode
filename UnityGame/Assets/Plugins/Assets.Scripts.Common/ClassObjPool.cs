...
namespace Assets.Scripts.Common
{
	public class ClassObjPool<T> : ClassObjPoolBase where T : PooledClassObject, new()
	{
		...
		public static T Get()
		{
			...
			if (ClassObjPool<T>.instance.pool.get_Count() > 0)
			{
				T t = (T)((object)ClassObjPool<T>.instance.pool.get_Item(ClassObjPool<T>.instance.pool.get_Count() - 1));
				ClassObjPool<T>.instance.pool.RemoveAt(ClassObjPool<T>.instance.pool.get_Count() - 1);
				ClassObjPool<T>.instance.reqSeq += 1u;
