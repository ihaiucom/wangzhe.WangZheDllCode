...
public class CResourcePackerInfo
{
	...
	{
		CResourcePackerInfo.<ASyncLoadAssetBundle>c__Iterator6 <ASyncLoadAssetBundle>c__Iterator = new CResourcePackerInfo.<ASyncLoadAssetBundle>c__Iterator6();
		<ASyncLoadAssetBundle>c__Iterator.ifsExtractPath = ifsExtractPath;
		<ASyncLoadAssetBundle>c__Iterator.<$>ifsExtractPath = ifsExtractPath;
		<ASyncLoadAssetBundle>c__Iterator.<>f__this = this;
		return <ASyncLoadAssetBundle>c__Iterator;
	}
	...
	public string GetRename(string pathInResourcesFolderWithoutExt)
	{
		...
		if (this.m_renameMap.TryGetValue(pathInResourcesFolderWithoutExt.JavaHashCodeIgnoreCase(), ref empty))
		{
			return empty;
		}
		return string.Empty;
