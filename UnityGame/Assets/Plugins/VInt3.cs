...
public struct VInt3
{
	...
	public VInt3 RotateY(ref VFactor radians)
	{
		...
		vInt.z = (int)IntMath.Divide(-(long)this.x * num2 + (long)this.z * num, b);
		vInt.y = 0;
	...
	{
		return new VInt3(MMGame_Math.RoundToInt((double)(ob.x * 1000f)), MMGame_Math.RoundToInt((double)(ob.y * 1000f)), MMGame_Math.RoundToInt((double)(ob.z * 1000f)));
	}
