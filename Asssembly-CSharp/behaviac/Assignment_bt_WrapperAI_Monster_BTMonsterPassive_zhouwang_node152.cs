...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterPassive_zhouwang_node152 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterPassive_zhouwang_node152()
		{
			this.opr_p1 = 3000;
		}
