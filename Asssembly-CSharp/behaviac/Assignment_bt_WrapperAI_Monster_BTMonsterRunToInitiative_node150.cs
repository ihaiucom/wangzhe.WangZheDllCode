...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterRunToInitiative_node150 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterRunToInitiative_node150()
		{
			this.opr_p1 = 3000;
		}
