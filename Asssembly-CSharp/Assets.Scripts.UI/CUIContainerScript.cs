...
namespace Assets.Scripts.UI
{
	public class CUIContainerScript : CUIComponent
	{
		...
		public int GetElement()
		{
			...
			if (this.m_unusedElements.get_Count() > 0)
			{
				gameObject = this.m_unusedElements.get_Item(0);
		...
		public GameObject GetElement(int sequence)
		{
			...
			return (this.m_usedElements[sequence] == null) ? null : this.m_usedElements[sequence].gameObject;
		}
