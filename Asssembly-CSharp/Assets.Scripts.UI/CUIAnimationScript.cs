...
namespace Assets.Scripts.UI
{
	public class CUIAnimationScript : CUIComponent
	{
		...
		[HideInInspector]
		public enUIEventID[] m_eventIDs = new enUIEventID[Enum.GetValues(typeof(enAnimationEventType)).get_Length()];

		public stUIEventParams[] m_eventParams = new stUIEventParams[Enum.GetValues(typeof(enAnimationEventType)).get_Length()];
		...
		{
			return (this.m_currentAnimationState == null) ? null : this.m_currentAnimationState.name;
		}
