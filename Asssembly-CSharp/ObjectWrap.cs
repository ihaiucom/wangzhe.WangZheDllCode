...
public class ObjectWrap
{
	...
	private static int Equals(IntPtr L)
	{
		...
		Object @object = LuaScriptMgr.GetVarObject(L, 1) as Object;
		object varObject = LuaScriptMgr.GetVarObject(L, 2);
		bool b = (@object != null) ? @object.Equals(varObject) : (varObject == null);
	...
	private static int GetHashCode(IntPtr L)
	{
		...
		Object @object = (Object)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Object");
	...
	private static int Instantiate(IntPtr L)
	{
		...
		if (num == 1)
		{
			Object unityObject = LuaScriptMgr.GetUnityObject(L, 1, typeof(Object));
			Object obj = Object.Instantiate(unityObject);
			LuaScriptMgr.Push(L, obj);
			return 1;
		}
		if (num == 3)
		{
			Object unityObject2 = LuaScriptMgr.GetUnityObject(L, 1, typeof(Object));
			Vector3 vector = LuaScriptMgr.GetVector3(L, 2);
			Quaternion quaternion = LuaScriptMgr.GetQuaternion(L, 3);
			Object obj2 = Object.Instantiate(unityObject2, vector, quaternion);
	...
	private static int FindObjectsOfType(IntPtr L)
	{
		...
		Object[] o = Object.FindObjectsOfType(typeObject);
	...
	private static int FindObjectOfType(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Type typeObject = LuaScriptMgr.GetTypeObject(L, 1);
		Object obj = Object.FindObjectOfType(typeObject);
		LuaScriptMgr.Push(L, obj);
		return 1;
	}
	...
	private static int DontDestroyOnLoad(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Object unityObject = LuaScriptMgr.GetUnityObject(L, 1, typeof(Object));
		Object.DontDestroyOnLoad(unityObject);
		return 0;
	}
	...
	private static int DestroyObject(IntPtr L)
	{
		...
		if (num == 2)
		{
			Object obj2 = (Object)LuaScriptMgr.GetLuaObject(L, 1);
			float t = (float)LuaScriptMgr.GetNumber(L, 2);
			Object.DestroyObject(obj2, t);
			return 0;
		}
	...
	private static int DestroyImmediate(IntPtr L)
	{
		...
		if (num == 2)
		{
			...
			Object.DestroyImmediate(obj2, boolean);
			return 0;
		}
