...
namespace Assets.Scripts.GameSystem
{
	...
	public class RankingSystem : Singleton<RankingSystem>
	{
		...
		private RankingSystem.LocalRankingInfo GetLocalRankingInfo(RankingSystem.RankingType rankingType, uint subType = 0u)
		{
			...
			{
				return this._godRankInfo.get_Item(subType);
			}
		...
		internal void InitWidget(bool isShowAllRankTypeBtn = true)
		{
			...
			this._scroll.set_elasticity(0.08f);
			...
			if (elemenet != null)
			{
				...
				elemenet.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(this._allViewName);
			}
			elemenet = this._viewList.GetElemenet(1);
			if (elemenet != null)
			{
				elemenet.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(this._friendViewName);
			}
		...
		private void SetMenuElementText()
		{
			...
			if (gameObject != null)
			{
				...
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_LadderRankName"));
				transform = gameObject.transform.FindChild("ListElement1");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_HeroCountRankName"));
				transform = gameObject.transform.FindChild("ListElement2");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_SkinCountRankName"));
				transform = gameObject.transform.FindChild("ListElement3");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_AchieveRankName"));
				transform = gameObject.transform.FindChild("ListElement4");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_WinCountRankName"));
				transform = gameObject.transform.FindChild("ListElement5");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_ConWinRankName"));
				transform = gameObject.transform.FindChild("ListElement6");
				transform.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("ranking_GameVIPRankName"));
			}
		}
		...
		private void UpdateTabText()
		{
			...
			else
			{
				if (this._curRankingType == RankingSystem.RankingType.Arena)
				{
					...
					elemenet.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(text);
					return;
				}
			...
			if (curSubViewType != RankingSystem.RankingSubView.All)
			{
				...
				{
					elemenet.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(string.Format("{0}{1}", this._friendViewName, text));
				}
			}
			else
			{
				elemenet.gameObject.transform.FindChild("Text").GetComponent<Text>().set_text(string.Format("{0}{1}", this._allViewName, text));
			}
		}
		...
		{
			stFriendByUUIDAndLogicID stFriendByUUIDAndLogicID = new stFriendByUUIDAndLogicID(uiEvent.m_eventParams.commonUInt64Param1, (uint)uiEvent.m_eventParams.commonUInt64Param2, CFriendModel.FriendType.SNS);
			if (!this._coinSentFriendDic.ContainsKey(stFriendByUUIDAndLogicID))
			{
				this._coinSentFriendDic.Add(stFriendByUUIDAndLogicID, uiEvent.m_eventParams.tag);
			}
		...
		{
			stFriendByUUIDAndLogicID stFriendByUUIDAndLogicID = new stFriendByUUIDAndLogicID(uiEvent.m_eventParams.commonUInt64Param1, (uint)uiEvent.m_eventParams.commonUInt64Param2, CFriendModel.FriendType.GameFriend);
			if (!this._coinSentFriendDic.ContainsKey(stFriendByUUIDAndLogicID))
			{
				this._coinSentFriendDic.Add(stFriendByUUIDAndLogicID, uiEvent.m_eventParams.tag);
			}
		...
		private void UpdateOneElement(GameObject objElement, int viewIndex)
		{
			...
			if (this._curSubViewType == RankingSystem.RankingSubView.Friend)
			{
				if (this.IsMyFriendRankIndex(viewIndex))
				{
					...
					if (selfInfo != null && Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo() != null)
					{
						...
						RankingView.SetGameObjChildText(this._myselfInfo, "PlayerLv", string.Format("Lv.{0}", Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo().PvpLevel.ToString(CultureInfo.get_InvariantCulture())));
					}
				}
				else
				{
			...
			case RankingSystem.RankingType.PvpRank:
			{
				...
				RankingView.SetGameObjChildText(objElement, "Value", num9.ToString(CultureInfo.get_InvariantCulture()));
				break;
			}
			case RankingSystem.RankingType.HeroNum:
				...
				RankingView.SetGameObjChildText(objElement, "Value", num.ToString(CultureInfo.get_InvariantCulture()));
				break;
			...
			case RankingSystem.RankingType.Ladder:
			{
				...
				if (num2 >= CLadderSystem.REQ_PLAYER_LEVEL && (Utility.IsSelf(num3, (int)num4) ? Singleton<CLadderSystem>.GetInstance().IsHaveFightRecord(true, -1, -1) : Singleton<CLadderSystem>.GetInstance().IsHaveFightRecord(false, (int)rankGrade, (int)num10)))
				{
					CLadderView.ShowRankDetail(component.LadderGo, rankGrade, this.GetRankClass(num3), 1u, false, true, false, true, true);
					component.LadderXing.GetComponent<Text>().set_text(string.Format("x{0}", num10));
				}
				else
				{
			...
			case RankingSystem.RankingType.Achievement:
			{
				...
				{
					RankingView.SetGameObjChildText(objElement, "Value", trophyRewardInfoByPoint.Cfg.dwTrophyLvl.ToString(CultureInfo.get_InvariantCulture()));
				}
				else
				{
					RankingView.SetGameObjChildText(objElement, "Value", 1.ToString(CultureInfo.get_InvariantCulture()));
				}
				break;
			}
			...
			if (flag2)
			{
				...
				if (component.Online != null)
				{
					...
					if (componetInChild != null)
					{
						...
						{
							componetInChild.set_text(string.Format("<color=#00ff00>{0}</color>", Singleton<CTextManager>.instance.GetText("Common_Online")));
						}
						else
						{
							componetInChild.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Offline"));
						}
					}
				}
			}
			else if (flag)
			{
				...
				if (component.Online != null)
				{
					...
					if (componetInChild2 != null)
					{
						...
						{
							componetInChild2.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Offline"));
						}
					}
				}
			}
		...
		private static string GetPvpRankName(int level)
		{
			...
			return (dataByKey == null) ? string.Empty : string.Format("Lv.{0}", dataByKey.bLevel);
		}
		...
		protected void UpdateSelfInfo()
		{
			...
			RankingView.SetGameObjChildText(this._myselfInfo, "NameGroup/PlayerName", Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo().Name);
			RankingView.SetGameObjChildText(this._myselfInfo, "PlayerLv", string.Format("Lv.{0}", pvpLevel.ToString(CultureInfo.get_InvariantCulture())));
			...
			case RankingSystem.RankingType.PvpRank:
			{
				...
				RankingView.SetGameObjChildText(this._myselfInfo, "Value", num2.ToString(CultureInfo.get_InvariantCulture()));
			...
			case RankingSystem.RankingType.HeroNum:
				...
				RankingView.SetGameObjChildText(this._myselfInfo, "Value", selfInfo.dwScore.ToString(CultureInfo.get_InvariantCulture()));
				break;
			case RankingSystem.RankingType.SkinNum:
			...
			case RankingSystem.RankingType.Ladder:
				if (pvpLevel >= CLadderSystem.REQ_PLAYER_LEVEL && Singleton<CLadderSystem>.GetInstance().IsHaveFightRecord(true, -1, -1))
				{
					...
					if (masterRoleInfo2 != null)
					{
						...
						component.LadderXing.GetComponent<Text>().set_text(string.Format("x{0}", rankScore));
					}
				}
				else
				{
			...
			case RankingSystem.RankingType.Achievement:
			{
				...
				if (trophyRewardInfoByPoint != null)
				{
					RankingView.SetGameObjChildText(this._myselfInfo, "Value", trophyRewardInfoByPoint.Cfg.dwTrophyLvl.ToString(CultureInfo.get_InvariantCulture()));
				}
				else
				{
					RankingView.SetGameObjChildText(this._myselfInfo, "Value", 1.ToString(CultureInfo.get_InvariantCulture()));
				}
				break;
			}
			case RankingSystem.RankingType.WinCount:
			...
			else if (selfInfo.iRankChgNo > 0)
			{
				...
				RankingView.SetGameObjChildText(this._myselfInfo, "ChangeNum", selfInfo.iRankChgNo.ToString(CultureInfo.get_InvariantCulture()));
			}
			else if (selfInfo.iRankChgNo < 0)
			{
				component.RankingUpDownIcon.CustomSetActive(true);
		...
		public void ImpResRankingList(SCPKG_GET_RANKING_LIST_RSP rsp)
		{
			...
			if (rsp.stRankingListDetail.stOfSucc.iStart == 1)
			{
				...
				else if (rsp.stRankingListDetail.stOfSucc.bNumberType == 65)
				{
					...
					RankingSystem.LocalRankingInfo localRankingInfo = default(RankingSystem.LocalRankingInfo);
					localRankingInfo.ListInfo = rsp.stRankingListDetail.stOfSucc;
					localRankingInfo.LastRetrieveTime = (uint)CRoleInfo.GetCurrentUTCTime();
					bool flag = false;
					localRankingInfo.SelfInfo = new CSDT_GET_RANKING_ACNT_DETAIL_SELF();
					int num = 0;
					while ((long)num < (long)((ulong)localRankingInfo.ListInfo.dwItemNum))
					{
						COMDT_RANKING_LIST_ITEM_EXTRA_PLAYER stAcntInfo = localRankingInfo.ListInfo.astItemDetail[num].stExtraInfo.stDetailInfo.stMasterHero.stAcntInfo;
						if (stAcntInfo.ullUid == masterRoleInfo.playerUllUID)
						{
							localRankingInfo.SelfInfo.bNumberType = localRankingInfo.ListInfo.bNumberType;
							localRankingInfo.SelfInfo.dwScore = 0u;
							localRankingInfo.SelfInfo.dwRankNo = (uint)(num + 1);
							localRankingInfo.SelfInfo.iRankChgNo = 0;
							flag = true;
							break;
						}
						num++;
					...
					if (!flag)
					{
						localRankingInfo.SelfInfo.bNumberType = localRankingInfo.ListInfo.bNumberType;
						localRankingInfo.SelfInfo.dwScore = 0u;
						localRankingInfo.SelfInfo.dwRankNo = 0u;
						localRankingInfo.SelfInfo.iRankChgNo = 0;
					}
					if (!this._godRankInfo.ContainsKey(dwSubType))
					{
						this._godRankInfo.Add(dwSubType, localRankingInfo);
					}
					else
					{
						this._godRankInfo.set_Item(dwSubType, localRankingInfo);
					}
		...
		private CSDT_RANKING_LIST_SUCC GetLadderRankingInfoList(CSDT_RANKING_LIST_SUCC realTimeInfo)
		{
			...
			while ((long)num2 < (long)((ulong)this._dailyRankMatchInfo.dwItemNum))
			{
				...
				while ((long)num3 < (long)((ulong)realTimeInfo.dwItemNum))
				{
					if (this._dailyRankMatchInfo.astItemDetail[num2].stExtraInfo.stDetailInfo.stDailyRankMatch.ullUid == realTimeInfo.astItemDetail[num3].stExtraInfo.stDetailInfo.stDailyRankMatch.ullUid)
					{
						...
						{
							cSDT_RANKING_LIST_SUCC.astItemDetail[(int)((uint)((UIntPtr)num))] = realTimeInfo.astItemDetail[num3];
							cSDT_RANKING_LIST_SUCC.astItemDetail[(int)((uint)((UIntPtr)num))].dwRankNo = num + 1u;
							num += 1u;
							array[num3] = true;
						}
						break;
			...
			while ((long)num4 < (long)((ulong)realTimeInfo.dwItemNum))
			{
				if (!array[num4])
				{
					cSDT_RANKING_LIST_SUCC.astItemDetail[(int)((uint)((UIntPtr)num))] = realTimeInfo.astItemDetail[num4];
					cSDT_RANKING_LIST_SUCC.astItemDetail[(int)((uint)((UIntPtr)num))].dwRankNo = num + 1u;
					num += 1u;
				}
				num4++;
		...
		private void OnCoinSent(SCPKG_CMD_DONATE_FRIEND_POINT data)
		{
			...
			stFriendByUUIDAndLogicID stFriendByUUIDAndLogicID = new stFriendByUUIDAndLogicID(ullUid, dwLogicWorldId, type);
			int num = -1;
			if (this._coinSentFriendDic.TryGetValue(stFriendByUUIDAndLogicID, ref num))
			{
				this._coinSentFriendDic.Remove(stFriendByUUIDAndLogicID);
			}
			else
			{
				num = -1;
