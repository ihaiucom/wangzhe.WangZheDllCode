...
namespace Assets.Scripts.GameSystem
{
	public class GiftCenter
	{
		...
		private void SetCurSortTitleName()
		{
			...
			{
				this._sortTitle.GetComponent<Text>().set_text(CMallSortHelper.CreateHeroSorter().GetSortTypeName(this._curHeroSortType));
			}
			else
			{
				this._sortTitle.GetComponent<Text>().set_text(CMallSortHelper.CreateSkinSorter().GetSortTypeName(this._curSkinSortType));
			}
		}
		...
		private void UpdateItemList()
		{
			...
			{
				this._itemList.SetElementAmount((this._curJobView == enHeroJobType.All) ? this._skinTotalNum : this._tempListNum);
			}
			else
			{
				this._itemList.SetElementAmount((this._curJobView == enHeroJobType.All) ? this._heroTotalNum : this._tempListNum);
			}
		}
