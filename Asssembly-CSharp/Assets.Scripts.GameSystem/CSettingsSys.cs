	...
	internal class CSettingsSys : Singleton<CSettingsSys>
	{
		...
		private void InitWidget(string formPath)
		{
			...
			if (isRuning)
			{
				...
				this.GetSliderBarScript(this._form.m_formWidgets[66]).value = (float)(GameSettings.EnableHeroInfo ? 1 : 0);
			...
			else
			{
				...
				this.GetSliderBarScript(this._form.m_formWidgets[49]).value = (float)(GameSettings.EnableHDMode ? 1 : 0);
				this.GetSliderBarScript(this._form.m_formWidgets[44]).value = (float)(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().IsPrivacyOpen(COM_USER_PRIVACY_MASK.COM_USER_PRIVACY_MASK_FIGHT_HISTORY) ? 0 : 1);
				this.GetSliderBarScript(this._form.m_formWidgets[45]).value = (float)(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().IsPrivacyOpen(COM_USER_PRIVACY_MASK.COM_USER_PRIVACY_MASK_VIDEO) ? 0 : 1);
				this.GetSliderBarScript(this._form.m_formWidgets[46]).value = (float)(Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().IsPrivacyOpen(COM_USER_PRIVACY_MASK.COM_USER_PRIVACY_MASK_VIP_LEVEL) ? 0 : 1);
				this.SetAntiDisturbUI(COM_OTHERSTATE_BIT_MASK.COM_OTHERSTATE_BIT_MASK_DND, ((Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().OtherStatebBits & 1u) == 0u) ? 0 : 1);
				CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo();
				if (masterRoleInfo != null)
				{
					bool flag = (masterRoleInfo.snsSwitchBits & 16u) == 0u;
					this.GetSliderBarScript(this._form.m_formWidgets[101]).value = (float)(flag ? 1 : 0);
				}
				if (GameSettings.HeroSelectHeroViewSortType == CMallSortHelper.HeroViewSortType.Name)
				{
					...
					this._form.m_formWidgets[71].GetComponent<Toggle>().set_isOn(false);
				}
				else
				{
					this._form.m_formWidgets[70].GetComponent<Toggle>().set_isOn(false);
					this._form.m_formWidgets[71].GetComponent<Toggle>().set_isOn(true);
				}
				...
				if (accountInfo != null)
				{
					...
					{
						component2.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Login_QQ"));
					}
					else if (accountInfo.Platform == ApolloPlatform.Wechat)
					{
						component2.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Login_Weixin"));
					}
					else if (accountInfo.Platform == ApolloPlatform.WTLogin)
					{
						component2.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Login_PC"));
					}
					else if (accountInfo.Platform == ApolloPlatform.Guest)
					{
						component2.set_text(Singleton<CTextManager>.GetInstance().GetText("Common_Login_Guest"));
					}
				}
			}
			this.GetSliderBarScript(this._form.m_formWidgets[16]).value = (float)GameSettings.CameraHeight;
			this.GetSliderBarScript(this._form.m_formWidgets[8]).value = (float)(GameSettings.EnableOutline ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[38]).value = (float)GameSettings.InBattleInputChatEnable;
			this.GetSliderBarScript(this._form.m_formWidgets[82]).value = (float)(GameSettings.Unity3DTouchEnable ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[90]).value = (float)(GameSettings.ShowEquipInfo ? 1 : 0);
			...
			this._form.m_formWidgets[24].GetComponent<Toggle>().set_isOn(GameSettings.TheCommonAttackType == CommonAttactType.Type1);
			this._form.m_formWidgets[25].GetComponent<Toggle>().set_isOn(GameSettings.TheCommonAttackType == CommonAttactType.Type2);
			this._form.m_formWidgets[73].GetComponent<Toggle>().set_isOn(GameSettings.TheLastHitMode == LastHitMode.None || GameSettings.TheAttackOrganMode == AttackOrganMode.None);
			this._form.m_formWidgets[74].GetComponent<Toggle>().set_isOn(GameSettings.TheLastHitMode == LastHitMode.LastHit && GameSettings.TheAttackOrganMode == AttackOrganMode.AttackOrgan);
			this._form.m_formWidgets[20].GetComponent<Toggle>().set_isOn(GameSettings.JoyStickShowType == 0);
			this._form.m_formWidgets[21].GetComponent<Toggle>().set_isOn(GameSettings.JoyStickShowType == 1);
			this._form.m_formWidgets[39].GetComponent<Toggle>().set_isOn(GameSettings.TheSkillCancleType == SkillCancleType.AreaCancle);
			...
			this._form.m_formWidgets[67].GetComponent<Toggle>().set_isOn(GameSettings.LunPanLockEnemyHeroMode);
			this._form.m_formWidgets[68].GetComponent<Toggle>().set_isOn(!GameSettings.LunPanLockEnemyHeroMode);
			this._form.m_formWidgets[75].GetComponent<Toggle>().set_isOn(GameSettings.ShowEnemyHeroHeadBtnMode);
			this._form.m_formWidgets[76].GetComponent<Toggle>().set_isOn(!GameSettings.ShowEnemyHeroHeadBtnMode);
			this._form.m_formWidgets[98].GetComponent<Toggle>().set_isOn(GameSettings.MiniMapPosMode == MiniMapPosType.MiniMapLeftMode);
			this._form.m_formWidgets[99].GetComponent<Toggle>().set_isOn(GameSettings.MiniMapPosMode == MiniMapPosType.MiniMapRightMode);
			this._form.m_formWidgets[102].GetComponent<Toggle>().set_isOn(GameSettings.EquipPosMode == EquipPosType.EquipPosLeftMode);
			this._form.m_formWidgets[103].GetComponent<Toggle>().set_isOn(GameSettings.EquipPosMode == EquipPosType.EquipPosRightMode);
			...
			this.GetSliderBarScript(this._form.m_formWidgets[4]).value = (float)(GameSettings.EnableMusic ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[5]).value = (float)(GameSettings.EnableSound ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[23]).value = (float)(GameSettings.EnableVoice ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[41]).value = (float)(GameSettings.EnableVibrate ? 1 : 0);
			this.InitVoiceSetting();
			this.GetSliderBarScript(this._form.m_formWidgets[35]).value = (float)(NetworkAccelerator.IsNetAccConfigOpen() ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[36]).value = (float)(NetworkAccelerator.IsAutoNetAccConfigOpen() ? 1 : 0);
			CRoleInfo masterRoleInfo2 = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
			if (masterRoleInfo2 != null)
			{
				this._form.m_formWidgets[88].GetComponent<Toggle>().set_isOn(!CLadderSystem.IsRecentUsedHeroMaskSet(ref masterRoleInfo2.recentUseHero.dwCtrlMask, COM_RECENT_USED_HERO_MASK.COM_RECENT_USED_HERO_HIDE));
				this._form.m_formWidgets[89].GetComponent<Toggle>().set_isOn(CLadderSystem.IsRecentUsedHeroMaskSet(ref masterRoleInfo2.recentUseHero.dwCtrlMask, COM_RECENT_USED_HERO_MASK.COM_RECENT_USED_HERO_HIDE));
			}
			if (isRuning)
			{
		...
		private void InitRecorderWidget()
		{
			...
			if (gameObject != null)
			{
				...
				else
				{
					...
					if (transform2 != null)
					{
						...
						if (component2 != null)
						{
							component2.set_text(Singleton<CTextManager>.GetInstance().GetText("RecordKingTimeDesc"));
						}
					}
					...
					if (transform3 != null)
					{
						...
						if (component3 != null)
						{
							...
							if (dataByKey != null)
							{
								component3.set_text(dataByKey.szContent);
							}
						}
					}
					CUISliderEventScript sliderBarScript = this.GetSliderBarScript(gameObject);
					int num = GameSettings.EnableKingTimeMode ? 1 : 0;
			...
			if (gameObject2 != null)
			{
				...
				else
				{
					...
					if (transform4 != null)
					{
						...
						if (component4 != null)
						{
							component4.set_text(Singleton<CTextManager>.GetInstance().GetText("RecordRecorderName"));
						}
					}
					...
					if (transform5 != null)
					{
						...
						if (component5 != null)
						{
							component5.set_text(Singleton<CTextManager>.GetInstance().GetText("RecordRecorderDesc"));
						}
					}
					CUISliderEventScript sliderBarScript2 = this.GetSliderBarScript(gameObject2);
					int num2 = GameSettings.EnableRecorderMode ? 1 : 0;
			...
			if (gameObject3)
			{
				...
				int num3 = GameSettings.EnableRecordVideoHighQualityMode ? 1 : 0;
		...
		private void ProcessLayeroutGroupElem(Transform layeroutGroup)
		{
			if (layeroutGroup != null)
			{
				...
				for (int i = 0; i < childCount; i++)
				{
					...
					if (!(child.name == "Title") && this.SetBasicLayeroutElemActive(child))
					{
						flag = false;
					}
				}
		...
		private static void sliderMoveCameraAdjustment()
		{
			...
			CUISliderEventScript cUISliderEventScript = (instance._form != null) ? instance._form.m_formWidgets[42].transform.FindChild("Slider").GetComponent<CUISliderEventScript>() : null;
			if (Singleton<BattleLogic>.instance.isRuning)
			{
		...
		private void InitReplayKitSetting()
		{
			...
			if (text != null)
			{
				text.set_text(Singleton<CTextManager>.GetInstance().GetText("ReplayKit_Enable_Desc"));
			}
			if (text2 != null)
			{
				text2.set_text(Singleton<CTextManager>.GetInstance().GetText("ReplayKit_Mode_Desc"));
			}
			this.GetSliderBarScript(this._form.m_formWidgets[84]).value = (float)(GameSettings.EnableReplayKit ? 1 : 0);
			this.GetSliderBarScript(this._form.m_formWidgets[85]).value = (float)(GameSettings.EnableReplayKitAutoMode ? 1 : 0);
		}
		...
		private void InitSecurePwdSetting()
		{
			...
			this.GetSliderBarScript(this._form.m_formWidgets[61]).value = (float)(flag ? 1 : 0);
			if (flag2)
			{
		...
		private void ChangeText(CUIListElementScript element, string InText)
		{
			...
			if (element != null)
			{
				...
				Text text = (transform2 != null) ? transform2.GetComponent<Text>() : null;
			...
			if (bEnable)
			{
				...
				if (soundObj)
				{
					...
					if (transform)
					{
						...
						if (component3)
						{
							component3.set_color(CSettingsSys.s_sliderFillColor);
						}
					}
				}
			}
			else
			{
				...
				if (soundObj)
				{
					...
					if (transform2)
					{
						...
						if (component4)
						{
							component4.set_color(CUIUtility.s_Color_GrayShader);
						}
					}
					...
					if (transform2)
					{
						...
						if (component6)
						{
							component6.set_color(CUIUtility.s_Color_Grey);
						}
					}
				}
			}
		...
		private void SliderStatusChange(bool bEnable, Slider slliderObj, SettingFormWidget widgetEnum)
		{
			...
			if (slliderObj)
			{
				...
				Color color = bEnable ? CUIUtility.s_Color_White : CUIUtility.s_Color_GrayShader;
				...
				this.ChangeImageColor(imageTransform, bEnable ? CSettingsSys.s_sliderFillColor : CUIUtility.s_Color_Grey);
			}
		}
		...
		private void ToggleStatusChange(bool bEnable, SettingFormWidget widgetEnum)
		{
			...
			if (component)
			{
				...
				Color color = bEnable ? new Color(1f, 1f, 1f, 1f) : new Color(0f, 1f, 1f, 1f);
		...
		private void OnCancelAntiDisturbChange(CUIEvent uiEvent)
		{
			...
			int num = 1;
			this.SetAntiDisturbUI(COM_OTHERSTATE_BIT_MASK.COM_OTHERSTATE_BIT_MASK_DND, (((ulong)masterRoleInfo.OtherStatebBits & (ulong)((long)num)) == 0uL) ? 0 : 1);
		}
		...
		public void SetAntiDisturbUI(COM_OTHERSTATE_BIT_MASK otherStateBits, byte bChgType)
		{
			if (otherStateBits == COM_OTHERSTATE_BIT_MASK.COM_OTHERSTATE_BIT_MASK_DND)
			{
				...
				sliderBarScript.value = (float)((bChgType == 0) ? 0 : 1);
		...
		private void OnAllowReservChange(CUIEvent uiEvent)
		{
			...
			FriendSysNetCore.Send_Request_Sns_Switch(COM_REFUSE_TYPE.COM_REFUSE_TYPE_RESERVE_MSG, (sliderValue == 1f) ? 0 : 1);
		}
			...
			if (gameObject)
			{
				...
				if (pauseControl != null)
				{
					...
					if (enablePause)
					{
						...
						{
							componetInChild.set_text(string.Concat(new object[]
							{
								text,
								"(",
		...
		{
			int num = (int)uiEvent.m_eventParams.sliderValue;
			int num2 = NetworkAccelerator.IsAutoNetAccConfigOpen() ? 1 : 0;
		...
		private void OnUpdateTimer(CUIEvent uiEvent)
		{
			if (this._form != null && NetworkAccelerator.Inited)
			{
				...
				this._form.m_formWidgets[33].GetComponent<Text>().set_text(text);
				SLevelContext curLvelContext = Singleton<BattleLogic>.GetInstance().GetCurLvelContext();
				if (curLvelContext == null || !curLvelContext.IsMobaMode())
				{
					if (NetworkAccelerator.started)
					{
						this._form.m_formWidgets[34].GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("NETWORK_ACCELERATOR_LEBEL_NETWORK_DETAIL_ACC_STATE_UNKNOWN"));
					}
					else
					{
						this._form.m_formWidgets[34].GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("NETWORK_ACCELERATOR_LEBEL_NETWORK_DETAIL_ACC_STATE_CLOSE"));
					}
					this._form.m_formWidgets[31].GetComponent<Text>().set_text(this.PLAYCEHOLDER);
				}
				else
				{
					if (Singleton<CBattleSystem>.GetInstance().FightForm != null)
					{
						this._form.m_formWidgets[31].GetComponent<Text>().set_text(Singleton<CBattleSystem>.GetInstance().FightForm.GetDisplayPing() + "ms");
					}
					if (!NetworkAccelerator.started)
					{
						this._form.m_formWidgets[34].GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("NETWORK_ACCELERATOR_LEBEL_NETWORK_DETAIL_ACC_STATE_CLOSE"));
					...
					{
						this._form.m_formWidgets[34].GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("NETWORK_ACCELERATOR_LEBEL_NETWORK_DETAIL_ACC_STATE_ACC"));
					}
					else
					{
						this._form.m_formWidgets[34].GetComponent<Text>().set_text(Singleton<CTextManager>.GetInstance().GetText("NETWORK_ACCELERATOR_LEBEL_NETWORK_DETAIL_ACC_STATE_DIRECT"));
					}
				}
			}
		}
		...
		public void reqOperateUserPrivacyBit(bool bOpen, COM_USER_PRIVACY_MASK bit)
		{
			...
			cSPkg.stPkgData.stOperateUserPrivacyReq.bOpenOrClose = (bOpen ? 1 : 0);
