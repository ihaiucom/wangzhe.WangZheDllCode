...
public class CRoleRegisterView
{
	...
	public static string RoleName
	{
		get
		{
			...
			if (form != null)
			{
				return CUIUtility.RemoveEmoji(form.transform.FindChild("NameInputText").GetComponent<InputField>().get_text());
			}
			return string.Empty;
		}
		set
		...
		if (form != null)
		{
			...
			if (form != null)
			{
				...
				case 1:
					...
					gameObject.GetComponent<Button>().set_interactable(true);
					gameObject.GetComponentInChildren<Text>().set_color(Color.white);
					break;
				case 2:
					gameObject.GetComponent<CUIEventScript>().enabled = true;
					gameObject.GetComponent<Button>().set_interactable(true);
				...
				default:
					...
					gameObject.GetComponentInChildren<Text>().set_color(Color.gray);
					break;
				}
			}
		}
