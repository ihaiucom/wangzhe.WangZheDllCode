...
namespace com.tencent.pandora
{
	public class LuaTable : LuaBase
	{
		...
		public int Count
		{
			get
			{
				return this._Interpreter.GetTableDict(this).get_Count();
			}
		}
		...
		public ICollection Keys
		{
			get
			{
				return this._Interpreter.GetTableDict(this).get_Keys();
			}
		}
		...
		public ICollection Values
		{
			get
			{
				return this._Interpreter.GetTableDict(this).get_Values();
			}
		}
