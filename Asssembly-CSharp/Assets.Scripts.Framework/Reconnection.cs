...
namespace Assets.Scripts.Framework
{
	...
	public class Reconnection : MonoSingleton<Reconnection>, IGameModule
	{
		...
		{
			Reconnection.<ProcessRelaySyncCache>c__IteratorE <ProcessRelaySyncCache>c__IteratorE = new Reconnection.<ProcessRelaySyncCache>c__IteratorE();
			<ProcessRelaySyncCache>c__IteratorE.<>f__this = this;
			return <ProcessRelaySyncCache>c__IteratorE;
		}
