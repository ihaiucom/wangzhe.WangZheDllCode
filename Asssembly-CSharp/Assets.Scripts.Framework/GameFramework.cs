...
namespace Assets.Scripts.Framework
{
	...
	public class GameFramework : MonoSingleton<GameFramework>
	{
		...
		{
			return new GameFramework.<InitPUN>c__Iterator8();
		}
		...
		{
			GameFramework.<PrepareBaseSystem>c__Iterator9 <PrepareBaseSystem>c__Iterator = new GameFramework.<PrepareBaseSystem>c__Iterator9();
		...
		{
			GameFramework.<PrepareGameSystem>c__IteratorA <PrepareGameSystem>c__IteratorA = new GameFramework.<PrepareGameSystem>c__IteratorA();
			<PrepareGameSystem>c__IteratorA.<>f__this = this;
			return <PrepareGameSystem>c__IteratorA;
		}

		[DebuggerHidden]
		private IEnumerator SGame_WaitForTargetFrameRate()
		{
			GameFramework.<SGame_WaitForTargetFrameRate>c__IteratorB <SGame_WaitForTargetFrameRate>c__IteratorB = new GameFramework.<SGame_WaitForTargetFrameRate>c__IteratorB();
			<SGame_WaitForTargetFrameRate>c__IteratorB.<>f__this = this;
			return <SGame_WaitForTargetFrameRate>c__IteratorB;
		}
