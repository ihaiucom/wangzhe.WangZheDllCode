...
namespace AGE
{
	...
	internal class RotateActorDuration : DurationCondition
	{
		...
		public void ActionRotateLerp(ActorRoot actor, uint nDelta)
		{
			...
			actor.myTransform.rotation = Quaternion.RotateTowards(actor.myTransform.rotation, quaternion, (float)((long)Mathf.Abs(this.curRotateSpd) * (long)((ulong)nDelta)) * 0.001f);
		}
	}
}
