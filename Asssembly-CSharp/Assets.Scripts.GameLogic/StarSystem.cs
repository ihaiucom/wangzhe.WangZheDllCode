	...
	public class StarSystem : Singleton<StarSystem>
	{
		...
		public void StartFight()
		{
			...
			if (curLvelContext != null && !Singleton<LobbyLogic>.instance.inMultiGame && !curLvelContext.IsMobaMode())
			{
				...
				StarSystem instance = Singleton<StarSystem>.instance;
				instance.OnEvaluationChanged = (OnEvaluationChangedDelegate)Delegate.Combine(instance.OnEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnStarSystemChanged));
				StarSystem instance2 = Singleton<StarSystem>.instance;
				instance2.OnFailureEvaluationChanged = (OnEvaluationChangedDelegate)Delegate.Combine(instance2.OnFailureEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnFailureEvaluationChanged));
		...
		{
			StarSystem instance = Singleton<StarSystem>.instance;
			instance.OnFailureEvaluationChanged = (OnEvaluationChangedDelegate)Delegate.Remove(instance.OnFailureEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnFailureEvaluationChanged));
			StarSystem instance2 = Singleton<StarSystem>.instance;
			instance2.OnEvaluationChanged = (OnEvaluationChangedDelegate)Delegate.Remove(instance2.OnEvaluationChanged, new OnEvaluationChangedDelegate(BattleLogic.OnStarSystemChanged));
		}
