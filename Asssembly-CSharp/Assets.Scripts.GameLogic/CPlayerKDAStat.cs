...
namespace Assets.Scripts.GameLogic
{
	public class CPlayerKDAStat
	{
		...
		public float GetTeamKDA(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					...
					num = num2 + current2.get_Value().KDAValue;
				}
			}
			return num;
		}
		...
		public int GetTeamDeadNum(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					int num2 = num;
					KeyValuePair<uint, PlayerKDA> current2 = enumerator.Current;
					num = num2 + current2.get_Value().numDead;
				}
			}
			return num;
		}
		...
		public int GetTeamAssistNum(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					int num2 = num;
					KeyValuePair<uint, PlayerKDA> current2 = enumerator.Current;
					num = num2 + current2.get_Value().numAssist;
				}
			}
			return num;
		}
		...
		public int GetTeamHurtToHero(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					int num2 = num;
					KeyValuePair<uint, PlayerKDA> current2 = enumerator.Current;
					num = num2 + current2.get_Value().TotalHurtToHero;
				}
			}
			return num;
		}
		...
		public int GetTeamBeHurtByHero(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					int num2 = num;
					KeyValuePair<uint, PlayerKDA> current2 = enumerator.Current;
					num = num2 + current2.get_Value().TotalBeHurtByHero;
				}
			}
			return num;
		}
		...
		public int GetTeamCoin(COM_PLAYERCAMP camp)
		{
			...
			while (enumerator.MoveNext())
			{
				...
				if (current.get_Value().PlayerCamp == camp)
				{
					int num2 = num;
					KeyValuePair<uint, PlayerKDA> current2 = enumerator.Current;
					num = num2 + current2.get_Value().TotalCoin;
				}
			}
			return num;
		}
		...
		public void DumpDebugInfo()
		{
			...
			while (enumerator.MoveNext())
			{
				string text = "PlayerKDA Id {0}";
				KeyValuePair<uint, PlayerKDA> current = enumerator.Current;
				Debug.Log(string.Format(text, current.get_Key()));
			}
		}
