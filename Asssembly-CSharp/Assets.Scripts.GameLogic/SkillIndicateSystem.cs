...
namespace Assets.Scripts.GameLogic
{
	internal class SkillIndicateSystem : Singleton<SkillIndicateSystem>
	{
		...
		private void OnFightPrepare(ref DefaultGameEventParam prm)
		{
			...
			if (gameObject != null)
			{
				this.indicatePrefab = (GameObject)Object.Instantiate(gameObject);
			...
			if (gameObject != null)
			{
				this.commonAttackPrefab = (GameObject)Object.Instantiate(gameObject);
			...
			if (gameObject != null)
			{
				this.lockTargetPrefab = (GameObject)Object.Instantiate(gameObject);
			...
			if (gameObject != null)
			{
				this.lockHeroPrefab = (GameObject)Object.Instantiate(gameObject);
