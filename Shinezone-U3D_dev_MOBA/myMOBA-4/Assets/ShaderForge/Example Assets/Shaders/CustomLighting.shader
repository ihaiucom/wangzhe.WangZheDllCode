...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _Gloss ("Gloss", Range(1, 11)) = 4.504273
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
