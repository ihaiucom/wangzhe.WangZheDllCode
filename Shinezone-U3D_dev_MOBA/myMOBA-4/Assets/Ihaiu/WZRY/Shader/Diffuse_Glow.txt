Shader "S_Game_Scene/Light/Diffuse_Glow" {
Properties {
...
void main ()
{
  ...
  c_2.xyz = tmpvar_5;
  lowp vec3 tmpvar_6;
  tmpvar_6 = (c_2.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz);
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_6 * _LightColor0.xyz) * (max (0.0, 
    dot (xlv_TEXCOORD4, _WorldSpaceLightPos0.xyz)
  ) * 2.0));
  c_7.w = 1.0;
  c_1.w = c_7.w;
  c_1.xyz = (c_7.xyz + (tmpvar_6 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_2.xyz = tmpvar_5;
  lowp vec3 tmpvar_6;
  tmpvar_6 = (c_2.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz);
  lowp vec4 c_7;
  c_7.xyz = ((tmpvar_6 * _LightColor0.xyz) * (max (0.0, 
    dot (xlv_TEXCOORD4, _WorldSpaceLightPos0.xyz)
  ) * 2.0));
...
void main ()
{
  ...
  tmpvar_5 = (tmpvar_4.xyz * xlv_TEXCOORD2.xyz);
  c_2.xyz = tmpvar_5;
  c_1.xyz = ((c_2.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_5 = (tmpvar_4.xyz * xlv_TEXCOORD2.xyz);
  c_2.xyz = tmpvar_5;
  c_1.xyz = ((c_2.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD4).xyz));
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_7 = tmpvar_12;
  lowp vec4 c_13;
  c_13.xyz = ((tmpvar_6 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, _WorldSpaceLightPos0.xyz))
   * tmpvar_7) * 2.0));
  c_13.w = 1.0;
  c_1.w = c_13.w;
  c_1.xyz = (c_13.xyz + (tmpvar_6 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_6 = tmpvar_11;
  c_1.xyz = ((c_2.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((tmpvar_6 * 2.0))));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_16 = (tmpvar_6 * min (lm_13, tmpvar_15));
  c_1.xyz = tmpvar_16;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp float shadow_7;
  lowp float tmpvar_8;
  tmpvar_8 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD6.xyz);
  highp float tmpvar_9;
  tmpvar_9 = (_LightShadowData.x + (tmpvar_8 * (1.0 - _LightShadowData.x)));
  shadow_7 = tmpvar_9;
  lowp vec4 c_10;
  c_10.xyz = ((tmpvar_6 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, _WorldSpaceLightPos0.xyz))
   * shadow_7) * 2.0));
  c_10.w = 1.0;
  c_1.w = c_10.w;
  c_1.xyz = (c_10.xyz + (tmpvar_6 * xlv_TEXCOORD5));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_7 = tmpvar_10;
  lowp vec4 c_11;
  c_11.xyz = ((tmpvar_6 * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, _WorldSpaceLightPos0.xyz))
   * shadow_7) * 2.0));
  c_11.w = 1.0;
  c_1.w = c_11.w;
  c_1.xyz = (c_11.xyz + (tmpvar_6 * xlv_TEXCOORD5));
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  shadow_6 = tmpvar_8;
  c_1.xyz = ((c_2.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((shadow_6 * 2.0))));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_9 = (_LightShadowData.x + (tmpvar_8 * (1.0 - _LightShadowData.x)));
  shadow_6 = tmpvar_9;
  c_1.xyz = ((c_2.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD4).xyz), vec3((shadow_6 * 2.0))));
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_10;
  lowp vec3 tmpvar_11;
  tmpvar_11 = (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD4).xyz);
  lm_10 = tmpvar_11;
  lowp vec3 tmpvar_12;
  tmpvar_12 = vec3((shadow_7 * 2.0));
  mediump vec3 tmpvar_13;
  tmpvar_13 = (tmpvar_6 * min (lm_10, tmpvar_12));
  c_1.xyz = tmpvar_13;
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lm_11 = tmpvar_12;
  lowp vec3 tmpvar_13;
  tmpvar_13 = vec3((shadow_7 * 2.0));
  mediump vec3 tmpvar_14;
  tmpvar_14 = (tmpvar_6 * min (lm_11, tmpvar_13));
  c_1.xyz = tmpvar_14;
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec4 tmpvar_6;
  highp vec4 tmpvar_7;
  tmpvar_7 = (_MMultiplier * _Color);
  tmpvar_5 = tmpvar_7;
  highp vec2 tmpvar_8;
  tmpvar_8.x = _Scroll2X;
  tmpvar_8.y = _Scroll2Y;
  highp vec2 tmpvar_9;
  tmpvar_9 = fract((tmpvar_8 * _Time.x));
  tmpvar_6.zw = tmpvar_9;
  highp vec2 tmpvar_10;
  ...
  tmpvar_14 = (tmpvar_13 * (normalize(_glesNormal) * unity_Scale.w));
  tmpvar_3 = tmpvar_14;
  highp vec3 tmpvar_15;
  highp vec4 cse_16;
  cse_16 = (_Object2World * _glesVertex);
  tmpvar_15 = (_WorldSpaceLightPos0.xyz - cse_16.xyz);
  tmpvar_4 = tmpvar_15;
  gl_Position = (glstate_matrix_mvp * _glesVertex);
  xlv_TEXCOORD0 = tmpvar_1;
  xlv_TEXCOORD1 = tmpvar_2;
...
void main ()
{
  ...
  lightDir_2 = tmpvar_7;
  highp float tmpvar_8;
  tmpvar_8 = dot (xlv_TEXCOORD6, xlv_TEXCOORD6);
  lowp vec4 c_9;
  c_9.xyz = (((c_3.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
...
void main ()
{
  ...
  tmpvar_8 = dot (xlv_TEXCOORD6, xlv_TEXCOORD6);
  lowp vec4 c_9;
  c_9.xyz = (((c_3.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
...
void main ()
{
  ...
  lowp vec4 c_7;
  c_7.xyz = (((c_3.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * (max (0.0, 
    dot (xlv_TEXCOORD4, lightDir_2)
  ) * 2.0));
  c_7.w = 1.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD5;
  lowp vec4 c_7;
  c_7.xyz = (((c_3.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * (max (0.0, 
    dot (xlv_TEXCOORD4, lightDir_2)
  ) * 2.0));
  c_7.w = 1.0;
  c_1.xyz = c_7.xyz;
...
void main ()
{
  ...
  xlv_TEXCOORD4 = tmpvar_3;
  xlv_TEXCOORD5 = tmpvar_4;
  xlv_TEXCOORD6 = (_LightMatrix0 * cse_16);
}
...
void main ()
{
  ...
  lightDir_2 = tmpvar_7;
  highp vec2 P_8;
  P_8 = ((xlv_TEXCOORD6.xy / xlv_TEXCOORD6.w) + 0.5);
  highp float tmpvar_9;
  tmpvar_9 = dot (xlv_TEXCOORD6.xyz, xlv_TEXCOORD6.xyz);
  lowp float atten_10;
  atten_10 = ((float(
    (xlv_TEXCOORD6.z > 0.0)
  ) * texture2D (_LightTexture0, P_8).w) * texture2D (_LightTextureB0, vec2(tmpvar_9)).w);
  lowp vec4 c_11;
  c_11.xyz = (((c_3.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * atten_10) * 2.0));
  c_11.w = 1.0;
  c_1.xyz = c_11.xyz;
...
void main ()
{
  ...
  lowp vec4 c_11;
  c_11.xyz = (((c_3.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * atten_10) * 2.0));
  c_11.w = 1.0;
  c_1.xyz = c_11.xyz;
...
void main ()
{
  ...
  c_9.xyz = (((c_3.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * 
    (texture2D (_LightTextureB0, vec2(tmpvar_8)).w * textureCube (_LightTexture0, xlv_TEXCOORD6).w)
  ) * 2.0));
  c_9.w = 1.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
...
void main ()
{
  ...
  c_9.xyz = (((c_3.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * 
    (texture (_LightTextureB0, vec2(tmpvar_8)).w * texture (_LightTexture0, xlv_TEXCOORD6).w)
  ) * 2.0));
  c_9.w = 1.0;
  c_1.xyz = c_9.xyz;
  c_1.w = 0.0;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD5;
  lowp vec4 c_7;
  c_7.xyz = (((c_3.xyz + texture2D (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * texture2D (_LightTexture0, xlv_TEXCOORD6).w) * 2.0));
  c_7.w = 1.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  gl_FragData[0] = c_1;
...
void main ()
{
  ...
  lightDir_2 = xlv_TEXCOORD5;
  lowp vec4 c_7;
  c_7.xyz = (((c_3.xyz + texture (_MainTex, xlv_TEXCOORD0.xy).xyz) * _LightColor0.xyz) * ((
    max (0.0, dot (xlv_TEXCOORD4, lightDir_2))
   * texture (_LightTexture0, xlv_TEXCOORD6).w) * 2.0));
  c_7.w = 1.0;
  c_1.xyz = c_7.xyz;
  c_1.w = 0.0;
  _glesFragData[0] = c_1;
...
void main ()
{
  ...
  lowp vec4 c_12;
  mediump vec3 tmpvar_13;
  tmpvar_13 = (tmpvar_8 * light_3.xyz);
  c_12.xyz = tmpvar_13;
  c_12.w = 1.0;
  c_2 = c_12;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  lowp vec4 c_17;
  mediump vec3 tmpvar_18;
  tmpvar_18 = (tmpvar_11 * light_6.xyz);
  c_17.xyz = tmpvar_18;
  c_17.w = 1.0;
  c_2 = c_17;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  mediump vec3 lm_10;
  lowp vec3 tmpvar_11;
  tmpvar_11 = (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD5).xyz);
  lm_10 = tmpvar_11;
  ...
  tmpvar_15 = (tmpvar_8 * tmpvar_13.xyz);
  c_14.xyz = tmpvar_15;
  c_14.w = 1.0;
  c_2 = c_14;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  mediump vec3 lm_10;
  lowp vec3 tmpvar_11;
  tmpvar_11 = (2.0 * texture (unity_Lightmap, xlv_TEXCOORD5).xyz);
  lm_10 = tmpvar_11;
  mediump vec4 tmpvar_12;
  tmpvar_12.w = 0.0;
  tmpvar_12.xyz = lm_10;
