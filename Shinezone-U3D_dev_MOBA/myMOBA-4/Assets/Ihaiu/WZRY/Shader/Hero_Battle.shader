...
void main ()
{
  ...
  tmpvar_3 = (tmpvar_2.xyz + (_RimColor.xyz * pow (
    (1.0 - clamp (dot (normalize(xlv_TEXCOORD2), normalize(xlv_TEXCOORD1)), 0.0, 1.0))
  , _RimColor.w)));
...
SubProgram "gles " {
Keywords { "_DUMMY" "_EFFECT_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_DUMMY" "_RIM_COLOR_ON" "_EFFECT_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_DUMMY" "_HURT_EFFECT_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_DUMMY" "_RIM_COLOR_ON" "_HURT_EFFECT_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_DUMMY" "_EFFECT_TEX_ON" "_HURT_EFFECT_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_DUMMY" "_RIM_COLOR_ON" "_EFFECT_TEX_ON" "_HURT_EFFECT_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_RIM_COLOR_ON" }
"!!GLES
...
void main ()
{
  ...
  mediump vec2 tmpvar_3;
  mediump vec3 cse_4;
  cse_4 = normalize(xlv_TEXCOORD1);
  tmpvar_3 = ((cse_4.xy * 0.5) + 0.5);
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture2D (_LightTex, tmpvar_3);
  mediump vec3 tmpvar_6;
  tmpvar_6 = (tmpvar_2.xyz * (tmpvar_5.xyz * _LightScale));
  color_1.xyz = tmpvar_6;
  mediump vec3 tmpvar_7;
  tmpvar_7 = (color_1.xyz + (_RimColor.xyz * pow (
    (1.0 - clamp (dot (normalize(xlv_TEXCOORD2), cse_4), 0.0, 1.0))
  , _RimColor.w)));
...
void main ()
{
  ...
  tmpvar_3 = ((cse_4.xy * 0.5) + 0.5);
  lowp vec4 tmpvar_5;
  tmpvar_5 = texture (_LightTex, tmpvar_3);
  mediump vec3 tmpvar_6;
  tmpvar_6 = (tmpvar_2.xyz * (tmpvar_5.xyz * _LightScale));
  color_1.xyz = tmpvar_6;
  mediump vec3 tmpvar_7;
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_EFFECT_TEX_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_RIM_COLOR_ON" "_EFFECT_TEX_ON" }
"!!GLES
...
void main ()
{
  ...
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture2D (_LightTex, tmpvar_4);
  mediump vec3 tmpvar_7;
  tmpvar_7 = (tmpvar_3.xyz * (tmpvar_6.xyz * _LightScale));
  color_2.xyz = tmpvar_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = texture2D (_EffectTex, xlv_TEXCOORD0).xyz;
  hc_1 = tmpvar_8;
  mediump vec3 tmpvar_9;
  tmpvar_9 = mix (color_2.xyz, (hc_1 * _EffectTexScale), vec3(_EffectFactor));
  color_2.xyz = tmpvar_9;
  mediump vec3 tmpvar_10;
  tmpvar_10 = (color_2.xyz + (_RimColor.xyz * pow (
    (1.0 - clamp (dot (normalize(xlv_TEXCOORD2), cse_5), 0.0, 1.0))
  , _RimColor.w)));
...
void main ()
{
  ...
  tmpvar_4 = ((cse_5.xy * 0.5) + 0.5);
  lowp vec4 tmpvar_6;
  tmpvar_6 = texture (_LightTex, tmpvar_4);
  mediump vec3 tmpvar_7;
  tmpvar_7 = (tmpvar_3.xyz * (tmpvar_6.xyz * _LightScale));
  color_2.xyz = tmpvar_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = texture (_EffectTex, xlv_TEXCOORD0).xyz;
  hc_1 = tmpvar_8;
  mediump vec3 tmpvar_9;
  tmpvar_9 = mix (color_2.xyz, (hc_1 * _EffectTexScale), vec3(_EffectFactor));
  color_2.xyz = tmpvar_9;
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_HURT_EFFECT_ON" }
"!!GLES
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_RIM_COLOR_ON" "_HURT_EFFECT_ON" }
"!!GLES
...
void main ()
{
  ...
  color_1.xyz = tmpvar_6;
  mediump vec3 tmpvar_7;
  tmpvar_7 = (color_1.xyz + _HurtColor);
  color_1.xyz = tmpvar_7;
  mediump vec3 tmpvar_8;
  tmpvar_8 = (color_1.xyz + (_RimColor.xyz * pow (
    (1.0 - clamp (dot (normalize(xlv_TEXCOORD2), cse_4), 0.0, 1.0))
  , _RimColor.w)));
  color_1.xyz = tmpvar_8;
  color_1.w = _PlayerId;
  gl_FragData[0] = color_1;
}
...
SubProgram "gles " {
Keywords { "_LIGHT_TEX_ON" "_DUMMY" "_EFFECT_TEX_ON" "_HURT_EFFECT_ON" }
"!!GLES
...
void main ()
{
  ...
  color_2.xyz = tmpvar_9;
  mediump vec3 tmpvar_10;
  tmpvar_10 = (color_2.xyz + _HurtColor);
  color_2.xyz = tmpvar_10;
  mediump vec3 tmpvar_11;
  tmpvar_11 = (color_2.xyz + (_RimColor.xyz * pow (
    (1.0 - clamp (dot (normalize(xlv_TEXCOORD2), cse_5), 0.0, 1.0))
  , _RimColor.w)));
