...
{
	public class SCPKG_MULTGAME_BEGINPICK : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 761;
		...
		{
			if (cutVer == 0u || SCPKG_MULTGAME_BEGINPICK.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_MULTGAME_BEGINPICK.CURRVERSION;
			}
			if (SCPKG_MULTGAME_BEGINPICK.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_MULTGAME_BEGINPICK.CLASS_ID;
		}
