...
{
	public class CSDT_CHEAT_CHG_NEW_NORMALMMR : ProtocolObject
	{
		public byte bMMRType;
		...
		public static readonly int CLASS_ID = 814;
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_CHG_NEW_NORMALMMR.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_CHG_NEW_NORMALMMR.CURRVERSION;
			}
			if (CSDT_CHEAT_CHG_NEW_NORMALMMR.BASEVERSION > cutVer)
			{
				return TdrError.ErrorType.TDR_ERR_CUTVER_TOO_SMALL;
			}
			TdrError.ErrorType errorType = destBuf.writeUInt8(this.bMMRType);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt8(ref this.bMMRType);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSDT_CHEAT_CHG_NEW_NORMALMMR.CLASS_ID;
		}
