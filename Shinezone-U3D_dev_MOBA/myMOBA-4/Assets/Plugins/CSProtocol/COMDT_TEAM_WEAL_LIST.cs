...
namespace CSProtocol
{
	public class COMDT_TEAM_WEAL_LIST : ProtocolObject
	{
		...
		public COMDT_TEAM_WEAL_DETAIL[] astWealDetail;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 545;

		public COMDT_TEAM_WEAL_LIST()
		{
			this.astWealDetail = new COMDT_TEAM_WEAL_DETAIL[10];
			for (int i = 0; i < 10; i++)
			{
		...
		{
			if (cutVer == 0u || COMDT_TEAM_WEAL_LIST.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TEAM_WEAL_LIST.CURRVERSION;
			}
			if (COMDT_TEAM_WEAL_LIST.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TEAM_WEAL_LIST.CLASS_ID;
		}
