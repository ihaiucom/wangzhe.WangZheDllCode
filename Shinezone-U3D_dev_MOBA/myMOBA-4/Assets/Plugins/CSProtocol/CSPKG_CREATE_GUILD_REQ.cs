...
{
	public class CSPKG_CREATE_GUILD_REQ : ProtocolObject
	{
		public byte[] szName;
		...
		public static readonly int CLASS_ID = 1310;

		public CSPKG_CREATE_GUILD_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CREATE_GUILD_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CREATE_GUILD_REQ.CURRVERSION;
			}
			if (CSPKG_CREATE_GUILD_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_CREATE_GUILD_REQ.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)CSPKG_CREATE_GUILD_REQ.LENGTH_szNotice))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_CREATE_GUILD_REQ.CLASS_ID;
		}
