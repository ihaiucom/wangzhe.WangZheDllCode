...
{
	public class SCPKG_SET_GUILD_GROUP_OPENID_NTF : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1507;

		public SCPKG_SET_GUILD_GROUP_OPENID_NTF()
		{
		...
		{
			if (cutVer == 0u || SCPKG_SET_GUILD_GROUP_OPENID_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_SET_GUILD_GROUP_OPENID_NTF.CURRVERSION;
			}
			if (SCPKG_SET_GUILD_GROUP_OPENID_NTF.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)SCPKG_SET_GUILD_GROUP_OPENID_NTF.LENGTH_szGroupOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return SCPKG_SET_GUILD_GROUP_OPENID_NTF.CLASS_ID;
		}
