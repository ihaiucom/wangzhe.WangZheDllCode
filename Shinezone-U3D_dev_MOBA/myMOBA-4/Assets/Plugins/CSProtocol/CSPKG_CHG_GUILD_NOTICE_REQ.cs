...
{
	public class CSPKG_CHG_GUILD_NOTICE_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1358;

		public CSPKG_CHG_GUILD_NOTICE_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CHG_GUILD_NOTICE_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CHG_GUILD_NOTICE_REQ.CURRVERSION;
			}
			if (CSPKG_CHG_GUILD_NOTICE_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_CHG_GUILD_NOTICE_REQ.LENGTH_szNotice))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_CHG_GUILD_NOTICE_REQ.CLASS_ID;
		}
