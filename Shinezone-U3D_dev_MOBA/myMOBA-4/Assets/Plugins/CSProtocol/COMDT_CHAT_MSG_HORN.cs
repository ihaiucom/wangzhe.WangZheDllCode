...
{
	public class COMDT_CHAT_MSG_HORN : ProtocolObject
	{
		public uint dwHornID;

		public uint dwBeginShowSec;

		public uint dwEndShowSec;
		...
		public static readonly uint LENGTH_szContent = 256u;

		public static readonly int CLASS_ID = 292;

		public COMDT_CHAT_MSG_HORN()
		{
			this.stFrom = (COMDT_CHAT_PLAYER_INFO)ProtocolObjectPool.Get(COMDT_CHAT_PLAYER_INFO.CLASS_ID);
			this.szContent = new byte[256];
		}
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = destBuf.writeUInt32(this.dwHornID);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt32(this.dwBeginShowSec);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt32(this.dwEndShowSec);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = this.stFrom.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_CHAT_MSG_HORN.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_CHAT_MSG_HORN.CLASS_ID;
		}
