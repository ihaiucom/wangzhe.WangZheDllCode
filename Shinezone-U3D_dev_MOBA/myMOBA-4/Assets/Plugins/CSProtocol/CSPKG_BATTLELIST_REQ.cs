...
{
	public class CSPKG_BATTLELIST_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 883;
		...
		{
			if (cutVer == 0u || CSPKG_BATTLELIST_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_BATTLELIST_REQ.CURRVERSION;
			}
			if (CSPKG_BATTLELIST_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_BATTLELIST_REQ.CLASS_ID;
		}
