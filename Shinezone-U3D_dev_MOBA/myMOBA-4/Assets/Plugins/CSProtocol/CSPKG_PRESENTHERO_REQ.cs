...
{
	public class CSPKG_PRESENTHERO_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 907;

		public CSPKG_PRESENTHERO_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_PRESENTHERO_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_PRESENTHERO_REQ.CURRVERSION;
			}
			if (CSPKG_PRESENTHERO_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_PRESENTHERO_REQ.LENGTH_szPresentMsg))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_PRESENTHERO_REQ.CLASS_ID;
		}
