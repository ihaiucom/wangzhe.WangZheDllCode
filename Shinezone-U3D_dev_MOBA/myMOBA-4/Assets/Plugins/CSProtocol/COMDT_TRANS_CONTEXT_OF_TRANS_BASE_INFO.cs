...
{
	public class COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO : ProtocolObject
	{
		...
		public byte bRevertTransFlag;

		public byte bRevertRegisterName;

		public byte bRevertAcntInfo;

		public byte bRevertHeroInfo;

		public byte bRevertItemInfo;
		...
		public static readonly int CLASS_ID = 424;

		public COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.BASEVERSION > cutVer)
			{
			...
			errorType = destBuf.writeUInt8(this.bRevertTransFlag);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt8(this.bRevertRegisterName);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt8(this.bRevertAcntInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt8(this.bRevertHeroInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt8(this.bRevertItemInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readUInt8(ref this.bRevertTransFlag);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt8(ref this.bRevertRegisterName);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt8(ref this.bRevertAcntInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt8(ref this.bRevertHeroInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = srcBuf.readUInt8(ref this.bRevertItemInfo);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.LENGTH_szRegisterName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.LENGTH_szOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_TRANS_BASE_INFO.CLASS_ID;
		}
		...
		public override void OnRelease()
		{
			...
			this.dwAcntSeq = 0u;
			this.iDbVersion = 0;
			this.bRevertTransFlag = 0;
			this.bRevertRegisterName = 0;
			this.bRevertAcntInfo = 0;
			this.bRevertHeroInfo = 0;
			this.bRevertItemInfo = 0;
			this.dwClientIP = 0u;
		}
	}
}
