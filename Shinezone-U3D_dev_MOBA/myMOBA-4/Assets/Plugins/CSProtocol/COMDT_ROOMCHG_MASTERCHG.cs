...
{
	public class COMDT_ROOMCHG_MASTERCHG : ProtocolObject
	{
		public COMDT_ROOM_MASTER stNewMaster;
		...
		{
			if (cutVer == 0u || COMDT_ROOMCHG_MASTERCHG.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ROOMCHG_MASTERCHG.CURRVERSION;
			}
			if (COMDT_ROOMCHG_MASTERCHG.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ROOMCHG_MASTERCHG.CLASS_ID;
		}
