...
{
	public class CSPKG_CMD_HORNUSE : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 931;

		public CSPKG_CMD_HORNUSE()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CMD_HORNUSE.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_HORNUSE.CURRVERSION;
			}
			if (CSPKG_CMD_HORNUSE.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_CMD_HORNUSE.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_CMD_HORNUSE.CLASS_ID;
		}
