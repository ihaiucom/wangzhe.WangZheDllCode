...
namespace CSProtocol
{
	public class COMDT_TRANS_CONTEXT_OF_CHANGE_PLAYER_NAME : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_CHANGE_PLAYER_NAME.LENGTH_szOrgName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_TRANS_CONTEXT_OF_CHANGE_PLAYER_NAME.LENGTH_szNewName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
