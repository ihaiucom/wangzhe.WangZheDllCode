...
{
	public class SCPKG_SKILLUPDATE_RSP : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 896;
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			errorType = destBuf.writeUInt16(this.wSkillLevel);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_SKILLUPDATE_RSP.CLASS_ID;
		}
