...
{
	public class COMDT_APOLLO_PAY_PRESENTSKIN : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 474;

		public COMDT_APOLLO_PAY_PRESENTSKIN()
		{
		...
		{
			if (cutVer == 0u || COMDT_APOLLO_PAY_PRESENTSKIN.CURRVERSION < cutVer)
			{
				cutVer = COMDT_APOLLO_PAY_PRESENTSKIN.CURRVERSION;
			}
			if (COMDT_APOLLO_PAY_PRESENTSKIN.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_APOLLO_PAY_PRESENTSKIN.LENGTH_szPresentMsg))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_APOLLO_PAY_PRESENTSKIN.CLASS_ID;
		}
