...
{
	public class CSPKG_CMD_EQUIPOFF : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 927;
		...
		{
			if (cutVer == 0u || CSPKG_CMD_EQUIPOFF.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CMD_EQUIPOFF.CURRVERSION;
			}
			if (CSPKG_CMD_EQUIPOFF.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_CMD_EQUIPOFF.CLASS_ID;
		}
