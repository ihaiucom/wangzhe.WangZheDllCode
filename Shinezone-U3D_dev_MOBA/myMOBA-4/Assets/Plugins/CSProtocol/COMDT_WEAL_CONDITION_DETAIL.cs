...
{
	public class COMDT_WEAL_CONDITION_DETAIL : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 536;
		...
		{
			if (cutVer == 0u || COMDT_WEAL_CONDITION_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_WEAL_CONDITION_DETAIL.CURRVERSION;
			}
			if (COMDT_WEAL_CONDITION_DETAIL.BASEVERSION > cutVer)
			{
				return TdrError.ErrorType.TDR_ERR_CUTVER_TOO_SMALL;
			}
			TdrError.ErrorType errorType = destBuf.writeUInt32(this.dwRewardMask);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			TdrError.ErrorType errorType = srcBuf.readUInt32(ref this.dwRewardMask);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_WEAL_CONDITION_DETAIL.CLASS_ID;
		}
