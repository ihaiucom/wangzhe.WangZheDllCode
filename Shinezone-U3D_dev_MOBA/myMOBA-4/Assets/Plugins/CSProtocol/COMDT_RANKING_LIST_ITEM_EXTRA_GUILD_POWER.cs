...
namespace CSProtocol
{
	public class COMDT_RANKING_LIST_ITEM_EXTRA_GUILD_POWER : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_RANKING_LIST_ITEM_EXTRA_GUILD_POWER.LENGTH_szGuildName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_RANKING_LIST_ITEM_EXTRA_GUILD_POWER.LENGTH_szChairManHeadUrl))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)COMDT_RANKING_LIST_ITEM_EXTRA_GUILD_POWER.LENGTH_szChairManName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)COMDT_RANKING_LIST_ITEM_EXTRA_GUILD_POWER.LENGTH_szGuildNotice))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
