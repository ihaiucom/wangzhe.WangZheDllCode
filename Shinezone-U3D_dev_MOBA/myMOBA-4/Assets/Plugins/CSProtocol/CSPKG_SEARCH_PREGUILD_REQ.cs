...
{
	public class CSPKG_SEARCH_PREGUILD_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1341;

		public CSPKG_SEARCH_PREGUILD_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_SEARCH_PREGUILD_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_SEARCH_PREGUILD_REQ.CURRVERSION;
			}
			if (CSPKG_SEARCH_PREGUILD_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_SEARCH_PREGUILD_REQ.LENGTH_szGuildName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_SEARCH_PREGUILD_REQ.CLASS_ID;
		}
