...
{
	public class CSDT_MULTIGAMEDATA : ProtocolObject
	{
		public uint dwAcntObjID;

		public ushort wKillCnt;

		public ushort wDeadCnt;

		public ushort wAssistCnt;

		public uint dwBattleCoin;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 890;
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			errorType = destBuf.writeUInt16(this.wKillCnt);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt16(this.wDeadCnt);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt16(this.wAssistCnt);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			errorType = destBuf.writeUInt32(this.dwBattleCoin);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return CSDT_MULTIGAMEDATA.CLASS_ID;
		}
