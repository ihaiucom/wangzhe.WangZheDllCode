...
{
	public class COMDT_MULTIGAME_MEMBER_BRIEF_INFO : ProtocolObject
	{
		public byte[] szAcntOpenID;

		public ulong ullAcntUid;

		public int iAcntLogicWorldID;

		public byte[] szAcntName;

		public byte bAcntCamp;

		public byte bBeComplainted;
		...
		public uint dwNoAIKillCnt;

		public uint dwNoAIDeadCnt;

		public uint dwNoAIAssistCnt;

		public uint dwTotalHurtHeroCnt;

		public uint dwTotalBeHurtCnt;

		public uint dwTotalInBattleCoin;

		public uint dwHangupRatio;

		public byte[] szCodeName;

		public int iMVPScore;

		public uint dwMatchMMR;
		...
		public static readonly uint LENGTH_szCodeName = 64u;

		public static readonly int CLASS_ID = 197;

		public COMDT_MULTIGAME_MEMBER_BRIEF_INFO()
		{
			this.szAcntOpenID = new byte[64];
			this.szAcntName = new byte[64];
			this.szCodeName = new byte[64];
		}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_MULTIGAME_MEMBER_BRIEF_INFO.LENGTH_szAcntOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_MULTIGAME_MEMBER_BRIEF_INFO.LENGTH_szAcntName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)COMDT_MULTIGAME_MEMBER_BRIEF_INFO.LENGTH_szCodeName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_MULTIGAME_MEMBER_BRIEF_INFO.CLASS_ID;
		}

		public override void OnRelease()
		{
			this.ullAcntUid = 0uL;
			this.iAcntLogicWorldID = 0;
			this.bAcntCamp = 0;
			this.bBeComplainted = 0;
			this.bGradeOfRank = 0;
			this.dwKillCnt = 0u;
			this.dwDeadCnt = 0u;
			this.dwAssistCnt = 0u;
			this.dwNoAIKillCnt = 0u;
			this.dwNoAIDeadCnt = 0u;
			this.dwNoAIAssistCnt = 0u;
			this.dwTotalHurtHeroCnt = 0u;
			this.dwTotalBeHurtCnt = 0u;
			this.dwTotalInBattleCoin = 0u;
			this.dwHangupRatio = 0u;
			this.iMVPScore = 0;
			this.dwMatchMMR = 0u;
			this.dwMasterLevel = 0u;
			this.ullMasterUid = 0uL;
			this.dwMasterLogicWorldID = 0u;
			this.dwBattleHeroId = 0u;
		}
	}
}
