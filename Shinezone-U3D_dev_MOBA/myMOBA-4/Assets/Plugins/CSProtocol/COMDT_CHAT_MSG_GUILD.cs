...
{
	public class COMDT_CHAT_MSG_GUILD : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 281;

		public COMDT_CHAT_MSG_GUILD()
		{
		...
		{
			if (cutVer == 0u || COMDT_CHAT_MSG_GUILD.CURRVERSION < cutVer)
			{
				cutVer = COMDT_CHAT_MSG_GUILD.CURRVERSION;
			}
			if (COMDT_CHAT_MSG_GUILD.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_CHAT_MSG_GUILD.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_CHAT_MSG_GUILD.CLASS_ID;
		}
