...
namespace CSProtocol
{
	public class VersionControlInfo : IPackable, IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)VersionControlInfo.LENGTH_szAllowedLowVer))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)VersionControlInfo.LENGTH_szCurrentVer))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			for (int j = 0; j < this.iReviewVerCount; j++)
			{
				...
				{
					if ((long)num5 > (long)((ulong)VersionControlInfo.LENGTH_aszReviewVer))
					{
						return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
					}
