...
{
	public class CSPKG_GUILD_BINDQUNLOG_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1499;

		public CSPKG_GUILD_BINDQUNLOG_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_GUILD_BINDQUNLOG_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_GUILD_BINDQUNLOG_REQ.CURRVERSION;
			}
			if (CSPKG_GUILD_BINDQUNLOG_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_GUILD_BINDQUNLOG_REQ.LENGTH_szGroupOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_GUILD_BINDQUNLOG_REQ.CLASS_ID;
		}
