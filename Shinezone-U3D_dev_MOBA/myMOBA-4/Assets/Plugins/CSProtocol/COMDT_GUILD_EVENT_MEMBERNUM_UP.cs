...
{
	public class COMDT_GUILD_EVENT_MEMBERNUM_UP : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 367;

		public COMDT_GUILD_EVENT_MEMBERNUM_UP()
		{
		...
		{
			if (cutVer == 0u || COMDT_GUILD_EVENT_MEMBERNUM_UP.CURRVERSION < cutVer)
			{
				cutVer = COMDT_GUILD_EVENT_MEMBERNUM_UP.CURRVERSION;
			}
			if (COMDT_GUILD_EVENT_MEMBERNUM_UP.BASEVERSION > cutVer)
			{
			...
			errorType = destBuf.writeUInt32(this.dwMemberNum);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_GUILD_EVENT_MEMBERNUM_UP.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			errorType = srcBuf.readUInt32(ref this.dwMemberNum);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_GUILD_EVENT_MEMBERNUM_UP.CLASS_ID;
		}
