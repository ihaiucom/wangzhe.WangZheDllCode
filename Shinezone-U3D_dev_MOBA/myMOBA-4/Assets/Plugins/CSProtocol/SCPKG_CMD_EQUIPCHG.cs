...
namespace CSProtocol
{
	public class SCPKG_CMD_EQUIPCHG : ProtocolObject
	{
		...
		public COMDT_ITEM_ADDINFO stWearItem;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 928;

		public SCPKG_CMD_EQUIPCHG()
		{
		...
		{
			if (cutVer == 0u || SCPKG_CMD_EQUIPCHG.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_CMD_EQUIPCHG.CURRVERSION;
			}
			if (SCPKG_CMD_EQUIPCHG.BASEVERSION > cutVer)
			{
			...
			errorType = this.stWearItem.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = this.stWearItem.unpack(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_CMD_EQUIPCHG.CLASS_ID;
		}
