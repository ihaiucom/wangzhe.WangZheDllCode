...
{
	public class COMDT_TRANS_CONTEXT_OF_QUIT_GUILD : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 403;

		public COMDT_TRANS_CONTEXT_OF_QUIT_GUILD()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.LENGTH_szHeadUrl))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_QUIT_GUILD.CLASS_ID;
		}
