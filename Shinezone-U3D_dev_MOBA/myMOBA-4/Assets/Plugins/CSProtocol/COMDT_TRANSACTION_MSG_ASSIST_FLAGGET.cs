...
{
	public class COMDT_TRANSACTION_MSG_ASSIST_FLAGGET : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 686;

		public COMDT_TRANSACTION_MSG_ASSIST_FLAGGET()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_MSG_ASSIST_FLAGGET.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_MSG_ASSIST_FLAGGET.CURRVERSION;
			}
			if (COMDT_TRANSACTION_MSG_ASSIST_FLAGGET.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANSACTION_MSG_ASSIST_FLAGGET.LENGTH_szOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANSACTION_MSG_ASSIST_FLAGGET.CLASS_ID;
		}
