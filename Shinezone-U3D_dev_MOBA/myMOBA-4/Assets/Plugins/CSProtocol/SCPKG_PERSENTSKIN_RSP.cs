...
namespace CSProtocol
{
	public class SCPKG_PERSENTSKIN_RSP : ProtocolObject
	{
		...
		{
			if (cutVer == 0u || SCPKG_PERSENTSKIN_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_PERSENTSKIN_RSP.CURRVERSION;
			}
			if (SCPKG_PERSENTSKIN_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_PERSENTSKIN_RSP.CLASS_ID;
		}
