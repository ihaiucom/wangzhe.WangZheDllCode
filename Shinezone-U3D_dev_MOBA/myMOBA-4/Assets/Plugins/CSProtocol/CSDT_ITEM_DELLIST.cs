...
namespace CSProtocol
{
	public class CSDT_ITEM_DELLIST : ProtocolObject
	{
		...
		public CSDT_ITEM_DELINFO[] astItemList;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 918;

		public CSDT_ITEM_DELLIST()
		{
			this.astItemList = new CSDT_ITEM_DELINFO[400];
			for (int i = 0; i < 400; i++)
			{
		...
		{
			if (cutVer == 0u || CSDT_ITEM_DELLIST.CURRVERSION < cutVer)
			{
				cutVer = CSDT_ITEM_DELLIST.CURRVERSION;
			}
			if (CSDT_ITEM_DELLIST.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_ITEM_DELLIST.CLASS_ID;
		}
