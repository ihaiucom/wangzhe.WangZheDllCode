...
{
	public class PlayerInfo : IPackable, IUnpackable, tsf4g_csharp_interface
	{
		...
		public static readonly uint LENGTH_szNickName = 64u;
		...
		{
			if (cutVer == 0u || PlayerInfo.CURRVERSION < cutVer)
			{
				cutVer = PlayerInfo.CURRVERSION;
			}
			if (PlayerInfo.BASEVERSION > cutVer)
			{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)PlayerInfo.LENGTH_szOpenid))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)PlayerInfo.LENGTH_szNickName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
