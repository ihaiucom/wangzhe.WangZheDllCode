...
{
	public class COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 405;

		public COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME.LENGTH_szGuildName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_GUILD_GETNAME.CLASS_ID;
		}
