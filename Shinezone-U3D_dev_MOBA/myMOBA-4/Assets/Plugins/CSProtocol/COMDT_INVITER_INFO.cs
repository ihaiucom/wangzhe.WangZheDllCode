...
{
	public class COMDT_INVITER_INFO : ProtocolObject
	{
		public ulong ullUid;

		public int iGameEntity;

		public byte[] szName;

		public uint dwLogicWorldID;

		public uint dwRelationMask;
		...
		public static readonly int CLASS_ID = 338;

		public COMDT_INVITER_INFO()
		{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readInt32(ref this.iGameEntity);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			...
			{
				if ((long)num > (long)((ulong)COMDT_INVITER_INFO.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			errorType = srcBuf.readUInt32(ref this.dwRelationMask);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_INVITER_INFO.LENGTH_szHeadUrl))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_INVITER_INFO.CLASS_ID;
		}
