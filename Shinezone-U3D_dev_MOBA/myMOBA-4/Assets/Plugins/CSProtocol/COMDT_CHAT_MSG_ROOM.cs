...
{
	public class COMDT_CHAT_MSG_ROOM : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 280;
		...
		{
			if (cutVer == 0u || COMDT_CHAT_MSG_ROOM.CURRVERSION < cutVer)
			{
				cutVer = COMDT_CHAT_MSG_ROOM.CURRVERSION;
			}
			if (COMDT_CHAT_MSG_ROOM.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_CHAT_MSG_ROOM.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_CHAT_MSG_ROOM.CLASS_ID;
		}
