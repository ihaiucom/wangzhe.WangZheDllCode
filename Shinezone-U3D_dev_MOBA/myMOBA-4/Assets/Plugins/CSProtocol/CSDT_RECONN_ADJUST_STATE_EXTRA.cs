...
{
	public class CSDT_RECONN_ADJUST_STATE_EXTRA : ProtocolObject
	{
		public byte bPickType;

		public CSDT_RECONN_ADJUST_STATE_EXTRA_DETAIL stPickDetail;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 1282;

		public CSDT_RECONN_ADJUST_STATE_EXTRA()
		{
			this.stPickDetail = (CSDT_RECONN_ADJUST_STATE_EXTRA_DETAIL)ProtocolObjectPool.Get(CSDT_RECONN_ADJUST_STATE_EXTRA_DETAIL.CLASS_ID);
		}
		...
		{
			return CSDT_RECONN_ADJUST_STATE_EXTRA.CLASS_ID;
		}
