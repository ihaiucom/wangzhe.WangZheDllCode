...
{
	public class COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE : ProtocolObject
	{
		public ulong ullUid;
		...
		public COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE()
		{
		...
		{
			if (cutVer == 0u || COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE.CURRVERSION < cutVer)
			{
				cutVer = COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE.CURRVERSION;
			}
			if (COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_GUILD_EVENT_MEMBERUPTO_WANGZHE.CLASS_ID;
		}
