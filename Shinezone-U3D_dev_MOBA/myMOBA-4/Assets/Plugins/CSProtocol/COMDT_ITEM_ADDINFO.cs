...
{
	public class COMDT_ITEM_ADDINFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 227;

		public COMDT_ITEM_ADDINFO()
		{
		...
		{
			if (cutVer == 0u || COMDT_ITEM_ADDINFO.CURRVERSION < cutVer)
			{
				cutVer = COMDT_ITEM_ADDINFO.CURRVERSION;
			}
			if (COMDT_ITEM_ADDINFO.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_ITEM_ADDINFO.CLASS_ID;
		}
