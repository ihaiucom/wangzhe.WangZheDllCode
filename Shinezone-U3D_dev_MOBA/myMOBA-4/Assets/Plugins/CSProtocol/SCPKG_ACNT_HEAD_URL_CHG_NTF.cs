...
{
	public class SCPKG_ACNT_HEAD_URL_CHG_NTF : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1157;

		public SCPKG_ACNT_HEAD_URL_CHG_NTF()
		{
		...
		{
			if (cutVer == 0u || SCPKG_ACNT_HEAD_URL_CHG_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_ACNT_HEAD_URL_CHG_NTF.CURRVERSION;
			}
			if (SCPKG_ACNT_HEAD_URL_CHG_NTF.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)SCPKG_ACNT_HEAD_URL_CHG_NTF.LENGTH_szHeadUrl))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return SCPKG_ACNT_HEAD_URL_CHG_NTF.CLASS_ID;
		}
