...
namespace CSProtocol
{
	public class SCPKG_GET_VIDEOFRAPS_RSP : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1534;

		public SCPKG_GET_VIDEOFRAPS_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_GET_VIDEOFRAPS_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GET_VIDEOFRAPS_RSP.CURRVERSION;
			}
			if (SCPKG_GET_VIDEOFRAPS_RSP.BASEVERSION > cutVer)
			{
			...
			errorType = destBuf.writeUInt8(this.bAllOver);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readUInt8(ref this.bAllOver);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_GET_VIDEOFRAPS_RSP.CLASS_ID;
		}
