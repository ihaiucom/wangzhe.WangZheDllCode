...
{
	public class CSPKG_DEAL_GUILD_INVITE : ProtocolObject
	{
		public byte bAgree;
		...
		public static readonly int CLASS_ID = 1334;
		...
		{
			if (cutVer == 0u || CSPKG_DEAL_GUILD_INVITE.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_DEAL_GUILD_INVITE.CURRVERSION;
			}
			if (CSPKG_DEAL_GUILD_INVITE.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_DEAL_GUILD_INVITE.CLASS_ID;
		}
