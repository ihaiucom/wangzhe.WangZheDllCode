...
{
	public class COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 439;

		public COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO.LENGTH_szOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_GETACNTMOBAINFO.CLASS_ID;
		}
