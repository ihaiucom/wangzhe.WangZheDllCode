...
namespace CSProtocol
{
	public class COMDT_TRANSACTION_MSG_IDIP_ADDITEMREQ : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANSACTION_MSG_IDIP_ADDITEMREQ.LENGTH_szIdipMailContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_TRANSACTION_MSG_IDIP_ADDITEMREQ.LENGTH_szIdipMailTitle))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
