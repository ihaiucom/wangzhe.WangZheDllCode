...
{
	public class COMDT_GUILD_EVENT_QUIT : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 364;

		public COMDT_GUILD_EVENT_QUIT()
		{
		...
		{
			if (cutVer == 0u || COMDT_GUILD_EVENT_QUIT.CURRVERSION < cutVer)
			{
				cutVer = COMDT_GUILD_EVENT_QUIT.CURRVERSION;
			}
			if (COMDT_GUILD_EVENT_QUIT.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_GUILD_EVENT_QUIT.LENGTH_szName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_GUILD_EVENT_QUIT.CLASS_ID;
		}
