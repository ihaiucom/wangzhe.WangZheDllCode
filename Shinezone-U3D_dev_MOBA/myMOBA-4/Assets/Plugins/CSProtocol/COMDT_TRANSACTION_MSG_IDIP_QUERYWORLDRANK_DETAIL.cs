...
{
	public class COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_DETAIL : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 693;

		public COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_INFO stWorldRankDetail
		{
			get
			{
				return this.dataObject as COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_INFO;
			}
			set
			{
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_DETAIL.CURRVERSION;
			}
			if (COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_TRANSACTION_MSG_IDIP_QUERYWORLDRANK_DETAIL.CLASS_ID;
		}
