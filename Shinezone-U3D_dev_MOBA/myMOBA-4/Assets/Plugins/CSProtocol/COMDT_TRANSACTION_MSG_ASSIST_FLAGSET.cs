...
{
	public class COMDT_TRANSACTION_MSG_ASSIST_FLAGSET : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 685;

		public COMDT_TRANSACTION_MSG_ASSIST_FLAGSET()
		{
		...
		{
			if (cutVer == 0u || COMDT_TRANSACTION_MSG_ASSIST_FLAGSET.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANSACTION_MSG_ASSIST_FLAGSET.CURRVERSION;
			}
			if (COMDT_TRANSACTION_MSG_ASSIST_FLAGSET.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANSACTION_MSG_ASSIST_FLAGSET.LENGTH_szOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANSACTION_MSG_ASSIST_FLAGSET.CLASS_ID;
		}
