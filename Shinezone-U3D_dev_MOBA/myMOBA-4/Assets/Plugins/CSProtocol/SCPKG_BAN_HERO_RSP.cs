...
{
	public class SCPKG_BAN_HERO_RSP : ProtocolObject
	{
		public int iErrCode;
		...
		public static readonly int CLASS_ID = 1518;
		...
		{
			if (cutVer == 0u || SCPKG_BAN_HERO_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_BAN_HERO_RSP.CURRVERSION;
			}
			if (SCPKG_BAN_HERO_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_BAN_HERO_RSP.CLASS_ID;
		}
