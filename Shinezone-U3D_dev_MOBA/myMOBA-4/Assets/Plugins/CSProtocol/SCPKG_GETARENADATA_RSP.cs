...
{
	public class SCPKG_GETARENADATA_RSP : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1375;

		public SCPKG_GETARENADATA_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_GETARENADATA_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_GETARENADATA_RSP.CURRVERSION;
			}
			if (SCPKG_GETARENADATA_RSP.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_GETARENADATA_RSP.CLASS_ID;
		}
