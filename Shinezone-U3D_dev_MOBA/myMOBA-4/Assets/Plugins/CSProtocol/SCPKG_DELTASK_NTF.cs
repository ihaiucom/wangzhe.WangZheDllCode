...
{
	public class SCPKG_DELTASK_NTF : ProtocolObject
	{
		public uint dwTaskCnt;

		public SCDT_DELTASK[] astNewTask;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 1u;

		public static readonly int CLASS_ID = 1110;

		public SCPKG_DELTASK_NTF()
		{
			this.astNewTask = new SCDT_DELTASK[85];
			for (int i = 0; i < 85; i++)
			{
				this.astNewTask[i] = (SCDT_DELTASK)ProtocolObjectPool.Get(SCDT_DELTASK.CLASS_ID);
			}
		}
		...
		{
			if (cutVer == 0u || SCPKG_DELTASK_NTF.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_DELTASK_NTF.CURRVERSION;
			}
			if (SCPKG_DELTASK_NTF.BASEVERSION > cutVer)
			{
		...
		{
			return SCPKG_DELTASK_NTF.CLASS_ID;
		}
