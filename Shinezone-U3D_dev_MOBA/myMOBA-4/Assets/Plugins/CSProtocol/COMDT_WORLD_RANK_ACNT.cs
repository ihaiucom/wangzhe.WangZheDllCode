...
{
	public class COMDT_WORLD_RANK_ACNT : ProtocolObject
	{
		...
		public static readonly uint CURRVERSION = 211u;

		public static readonly uint VERSION_szOpenID = 211u;

		public static readonly uint LENGTH_szOpenID = 64u;

		public static readonly int CLASS_ID = 521;

		public COMDT_WORLD_RANK_ACNT()
		{
		...
		{
			if (cutVer == 0u || COMDT_WORLD_RANK_ACNT.CURRVERSION < cutVer)
			{
				cutVer = COMDT_WORLD_RANK_ACNT.CURRVERSION;
			}
			if (COMDT_WORLD_RANK_ACNT.BASEVERSION > cutVer)
			{
			...
			if (COMDT_WORLD_RANK_ACNT.VERSION_szOpenID <= cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			if (COMDT_WORLD_RANK_ACNT.VERSION_szOpenID <= cutVer)
			{
				...
				{
					if ((long)num > (long)((ulong)COMDT_WORLD_RANK_ACNT.LENGTH_szOpenID))
					{
						return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
					}
		...
		{
			return COMDT_WORLD_RANK_ACNT.CLASS_ID;
		}
