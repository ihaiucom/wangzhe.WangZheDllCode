...
{
	public class COMDT_CHAT_MSG_LOGIC_WORLD : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 278;

		public COMDT_CHAT_MSG_LOGIC_WORLD()
		{
		...
		{
			if (cutVer == 0u || COMDT_CHAT_MSG_LOGIC_WORLD.CURRVERSION < cutVer)
			{
				cutVer = COMDT_CHAT_MSG_LOGIC_WORLD.CURRVERSION;
			}
			if (COMDT_CHAT_MSG_LOGIC_WORLD.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_CHAT_MSG_LOGIC_WORLD.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_CHAT_MSG_LOGIC_WORLD.CLASS_ID;
		}
