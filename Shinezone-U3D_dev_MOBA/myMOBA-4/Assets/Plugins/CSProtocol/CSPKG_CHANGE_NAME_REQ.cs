...
{
	public class CSPKG_CHANGE_NAME_REQ : ProtocolObject
	{
		public byte bType;
		...
		public static readonly int CLASS_ID = 1470;

		public CSPKG_CHANGE_NAME_REQ()
		{
		...
		{
			if (cutVer == 0u || CSPKG_CHANGE_NAME_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_CHANGE_NAME_REQ.CURRVERSION;
			}
			if (CSPKG_CHANGE_NAME_REQ.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_CHANGE_NAME_REQ.LENGTH_szNewName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_CHANGE_NAME_REQ.CLASS_ID;
		}
