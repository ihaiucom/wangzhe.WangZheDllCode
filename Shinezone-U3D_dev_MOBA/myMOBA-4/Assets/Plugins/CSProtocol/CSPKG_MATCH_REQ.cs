...
{
	public class CSPKG_MATCH_REQ : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1170;
		...
		{
			if (cutVer == 0u || CSPKG_MATCH_REQ.CURRVERSION < cutVer)
			{
				cutVer = CSPKG_MATCH_REQ.CURRVERSION;
			}
			if (CSPKG_MATCH_REQ.BASEVERSION > cutVer)
			{
		...
		{
			return CSPKG_MATCH_REQ.CLASS_ID;
		}
