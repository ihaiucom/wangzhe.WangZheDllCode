...
{
	public class COMDT_HEROINFO_LIST : ProtocolObject
	{
		public uint dwHeroNum;

		public COMDT_HEROINFO[] astHeroInfoList;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 208u;

		public static readonly int CLASS_ID = 114;

		public COMDT_HEROINFO_LIST()
		{
			this.astHeroInfoList = new COMDT_HEROINFO[200];
			for (int i = 0; i < 200; i++)
			{
				this.astHeroInfoList[i] = (COMDT_HEROINFO)ProtocolObjectPool.Get(COMDT_HEROINFO.CLASS_ID);
			}
		}
		...
		{
			if (cutVer == 0u || COMDT_HEROINFO_LIST.CURRVERSION < cutVer)
			{
				cutVer = COMDT_HEROINFO_LIST.CURRVERSION;
			}
			if (COMDT_HEROINFO_LIST.BASEVERSION > cutVer)
			{
		...
		{
			return COMDT_HEROINFO_LIST.CLASS_ID;
		}
