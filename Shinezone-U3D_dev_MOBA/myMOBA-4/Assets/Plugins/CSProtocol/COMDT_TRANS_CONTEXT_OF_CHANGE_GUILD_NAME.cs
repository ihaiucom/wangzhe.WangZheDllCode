...
{
	public class COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME : ProtocolObject
	{
		...
		public static readonly uint LENGTH_szOrgName = 32u;

		public static readonly uint LENGTH_szNewName = 32u;

		public static readonly int CLASS_ID = 648;

		public COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME()
		{
			this.szOrgName = new byte[32];
			this.szNewName = new byte[32];
		}
		...
		{
			if (cutVer == 0u || COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.CURRVERSION < cutVer)
			{
				cutVer = COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.CURRVERSION;
			}
			if (COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.LENGTH_szOrgName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.LENGTH_szNewName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME.CLASS_ID;
		}
