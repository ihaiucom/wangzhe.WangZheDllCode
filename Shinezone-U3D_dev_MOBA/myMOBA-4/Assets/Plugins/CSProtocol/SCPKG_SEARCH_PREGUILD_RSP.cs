...
{
	public class SCPKG_SEARCH_PREGUILD_RSP : ProtocolObject
	{
		public byte bResult;

		public COMDT_PREPARE_GUILD_BRIEF_INFO stPreGuildBriefInfo;
		...
		public static readonly int CLASS_ID = 1342;
		...
		{
			if (cutVer == 0u || SCPKG_SEARCH_PREGUILD_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_SEARCH_PREGUILD_RSP.CURRVERSION;
			}
			if (SCPKG_SEARCH_PREGUILD_RSP.BASEVERSION > cutVer)
			{
			...
			errorType = this.stPreGuildBriefInfo.pack(ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = this.stPreGuildBriefInfo.unpack(ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_SEARCH_PREGUILD_RSP.CLASS_ID;
		}
