...
namespace CSProtocol
{
	public class SCPKG_JOIN_TEAM_RSP : ProtocolObject
	{
		...
		public COMDT_JOIN_TEAM_RSP stJoinRsp;

		public static readonly uint BASEVERSION = 1u;

		public static readonly uint CURRVERSION = 92u;

		public static readonly int CLASS_ID = 1196;

		public SCPKG_JOIN_TEAM_RSP()
		{
		...
		{
			if (cutVer == 0u || SCPKG_JOIN_TEAM_RSP.CURRVERSION < cutVer)
			{
				cutVer = SCPKG_JOIN_TEAM_RSP.CURRVERSION;
			}
			if (SCPKG_JOIN_TEAM_RSP.BASEVERSION > cutVer)
			{
			...
			errorType = this.stJoinRsp.pack(selector, ref destBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			long selector = (long)this.bErrCode;
			errorType = this.stJoinRsp.unpack(selector, ref srcBuf, cutVer);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return SCPKG_JOIN_TEAM_RSP.CLASS_ID;
		}
