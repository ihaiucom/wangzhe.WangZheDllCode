...
{
	public class CSDT_RANKING_LIST_DETAIL : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 1220;

		public CSDT_RANKING_LIST_SUCC stOfSucc
		{
			get
			{
				return this.dataObject as CSDT_RANKING_LIST_SUCC;
			}
			set
			{
		...
		{
			if (cutVer == 0u || CSDT_RANKING_LIST_DETAIL.CURRVERSION < cutVer)
			{
				cutVer = CSDT_RANKING_LIST_DETAIL.CURRVERSION;
			}
			if (CSDT_RANKING_LIST_DETAIL.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_RANKING_LIST_DETAIL.CLASS_ID;
		}
