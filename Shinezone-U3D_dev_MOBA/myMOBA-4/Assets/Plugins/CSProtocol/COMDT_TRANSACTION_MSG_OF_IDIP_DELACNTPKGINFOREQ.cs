...
{
	public class COMDT_TRANSACTION_MSG_OF_IDIP_DELACNTPKGINFOREQ : ProtocolObject
	{
		public ulong ullUid;

		public uint dwLogicWordID;

		public ushort wInfoType;
		...
		public static readonly int CLASS_ID = 678;
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			errorType = srcBuf.readUInt16(ref this.wInfoType);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
			...
			errorType = srcBuf.readInt32(ref this.iItemNum);
			if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
			{
				return errorType;
			}
		...
		{
			return COMDT_TRANSACTION_MSG_OF_IDIP_DELACNTPKGINFOREQ.CLASS_ID;
		}
