...
{
	public class CSDT_GUILDMATCH_SIGNUPINFO : ProtocolObject
	{
		public ulong ullUid;
		...
		public static readonly int CLASS_ID = 1573;

		public CSDT_GUILDMATCH_SIGNUPINFO()
		{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSDT_GUILDMATCH_SIGNUPINFO.LENGTH_szBeiZhu))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSDT_GUILDMATCH_SIGNUPINFO.CLASS_ID;
		}
