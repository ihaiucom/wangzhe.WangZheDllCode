...
{
	public class COMDT_BATTLE_CHAT_STR : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 284;

		public COMDT_BATTLE_CHAT_STR()
		{
		...
		{
			if (cutVer == 0u || COMDT_BATTLE_CHAT_STR.CURRVERSION < cutVer)
			{
				cutVer = COMDT_BATTLE_CHAT_STR.CURRVERSION;
			}
			if (COMDT_BATTLE_CHAT_STR.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_BATTLE_CHAT_STR.LENGTH_szContent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return COMDT_BATTLE_CHAT_STR.CLASS_ID;
		}
