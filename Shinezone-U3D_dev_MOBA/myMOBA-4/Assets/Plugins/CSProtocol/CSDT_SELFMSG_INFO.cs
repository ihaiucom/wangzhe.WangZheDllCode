...
{
	public class CSDT_SELFMSG_INFO : ProtocolObject
	{
		public uint dwMsgID;
		...
		public static readonly int CLASS_ID = 1155;

		public CSDT_SELFMSG_INFO()
		{
			this.szContent = new sbyte[300];
		}
		...
		{
			return CSDT_SELFMSG_INFO.CLASS_ID;
		}
