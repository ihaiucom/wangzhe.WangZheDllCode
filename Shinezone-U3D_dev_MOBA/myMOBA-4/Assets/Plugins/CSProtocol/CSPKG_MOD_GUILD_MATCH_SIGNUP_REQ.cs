...
{
	public class CSPKG_MOD_GUILD_MATCH_SIGNUP_REQ : ProtocolObject
	{
		public byte bPos1;
		...
		public static readonly int CLASS_ID = 1578;

		public CSPKG_MOD_GUILD_MATCH_SIGNUP_REQ()
		{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSPKG_MOD_GUILD_MATCH_SIGNUP_REQ.LENGTH_szBeiZhu))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSPKG_MOD_GUILD_MATCH_SIGNUP_REQ.CLASS_ID;
		}
