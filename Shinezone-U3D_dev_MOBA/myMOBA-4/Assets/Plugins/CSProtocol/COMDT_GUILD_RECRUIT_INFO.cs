...
namespace CSProtocol
{
	public class COMDT_GUILD_RECRUIT_INFO : ProtocolObject
	{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)COMDT_GUILD_RECRUIT_INFO.LENGTH_szGuildName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)COMDT_GUILD_RECRUIT_INFO.LENGTH_szSendName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)COMDT_GUILD_RECRUIT_INFO.LENGTH_szSenderHeadUrl))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
