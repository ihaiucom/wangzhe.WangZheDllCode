...
{
	public class CSDT_CHEAT_GET_MOBA_INFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 855;

		public CSDT_CHEAT_GET_MOBA_INFO()
		{
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_GET_MOBA_INFO.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_GET_MOBA_INFO.CURRVERSION;
			}
			if (CSDT_CHEAT_GET_MOBA_INFO.BASEVERSION > cutVer)
			{
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSDT_CHEAT_GET_MOBA_INFO.LENGTH_szOpenID))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSDT_CHEAT_GET_MOBA_INFO.CLASS_ID;
		}
