...
{
	public class CSDT_MAILOPTREQ_SENDMAIL : ProtocolObject
	{
		...
		public static readonly uint VERSION_bSource = 18u;

		public static readonly uint LENGTH_szFrom = 64u;

		public static readonly uint LENGTH_szTo = 64u;

		public static readonly int CLASS_ID = 1118;

		public CSDT_MAILOPTREQ_SENDMAIL()
		{
		...
		public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
		{
			...
			{
				errorType = destBuf.writeUInt8(this.bSource);
				if (errorType != TdrError.ErrorType.TDR_NO_ERROR)
				{
					return errorType;
				}
		...
		public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)CSDT_MAILOPTREQ_SENDMAIL.LENGTH_szFrom))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num3 > (long)((ulong)CSDT_MAILOPTREQ_SENDMAIL.LENGTH_szTo))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		{
			return CSDT_MAILOPTREQ_SENDMAIL.CLASS_ID;
		}
