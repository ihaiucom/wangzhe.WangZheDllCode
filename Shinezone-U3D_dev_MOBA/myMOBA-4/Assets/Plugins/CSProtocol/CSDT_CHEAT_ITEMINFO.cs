...
{
	public class CSDT_CHEAT_ITEMINFO : ProtocolObject
	{
		...
		public static readonly int CLASS_ID = 816;
		...
		{
			if (cutVer == 0u || CSDT_CHEAT_ITEMINFO.CURRVERSION < cutVer)
			{
				cutVer = CSDT_CHEAT_ITEMINFO.CURRVERSION;
			}
			if (CSDT_CHEAT_ITEMINFO.BASEVERSION > cutVer)
			{
		...
		{
			return CSDT_CHEAT_ITEMINFO.CLASS_ID;
		}
