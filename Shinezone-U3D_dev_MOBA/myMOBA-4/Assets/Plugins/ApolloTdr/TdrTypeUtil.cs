...
namespace ApolloTdr
{
	public class TdrTypeUtil
	{
		...
		public static TdrError.ErrorType str2TdrTime(out uint time, string strTime)
		{
			...
			{
				tdrTime.nHour = (short)dateTime.TimeOfDay.Hours;
				tdrTime.bMin = (byte)dateTime.TimeOfDay.Minutes;
				tdrTime.bSec = (byte)dateTime.TimeOfDay.Seconds;
		...
		public static TdrError.ErrorType str2TdrDate(out uint date, string strDate)
		{
			...
			{
				tdrDate.nYear = (short)dateTime.Year;
				tdrDate.bMon = (byte)dateTime.Month;
				tdrDate.bDay = (byte)dateTime.Day;
		...
		public static TdrError.ErrorType str2TdrDateTime(out ulong datetime, string strDateTime)
		{
			...
			{
				tdrDateTime.tdrDate.nYear = (short)dateTime.Year;
				tdrDateTime.tdrDate.bMon = (byte)dateTime.Month;
				tdrDateTime.tdrDate.bDay = (byte)dateTime.Day;
				tdrDateTime.tdrTime.nHour = (short)dateTime.TimeOfDay.Hours;
				tdrDateTime.tdrTime.bMin = (byte)dateTime.TimeOfDay.Minutes;
				tdrDateTime.tdrTime.bSec = (byte)dateTime.TimeOfDay.Seconds;
