...
namespace ResData
{
	public class ResSpecialFucUnlock : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResSpecialFucUnlock.LENGTH_szLockedTip))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResSpecialFucUnlock.LENGTH_szUnlockTip))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResSpecialFucUnlock.LENGTH_szUnlockTipIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
