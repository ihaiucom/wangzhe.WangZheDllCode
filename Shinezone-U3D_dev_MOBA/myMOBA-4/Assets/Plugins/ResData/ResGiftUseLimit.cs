...
namespace ResData
{
	public class ResGiftUseLimit : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResGiftUseLimit.LENGTH_szBeginTime))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResGiftUseLimit.LENGTH_szEndTime))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
