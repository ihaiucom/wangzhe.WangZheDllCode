...
namespace ResData
{
	public class ResDT_PickRuleInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		{
			if (cutVer == 0u || ResDT_PickRuleInfo.CURRVERSION < cutVer)
			{
				cutVer = ResDT_PickRuleInfo.CURRVERSION;
			}
			if (ResDT_PickRuleInfo.BASEVERSION > cutVer)
			{
