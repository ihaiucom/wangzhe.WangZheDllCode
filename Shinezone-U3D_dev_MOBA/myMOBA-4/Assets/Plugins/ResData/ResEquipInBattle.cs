...
namespace ResData
{
	public class ResEquipInBattle : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResEquipInBattle.LENGTH_szName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResEquipInBattle.LENGTH_szIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResEquipInBattle.LENGTH_szRequireEquip))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResEquipInBattle.LENGTH_szActiveSkillDes))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResEquipInBattle.LENGTH_szDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResEquipInBattle.LENGTH_szExtraDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
