...
namespace ResData
{
	public class ResSkillCfgInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResSkillCfgInfo.LENGTH_szSkillName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResSkillCfgInfo.LENGTH_szSkillDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResSkillCfgInfo.LENGTH_szLobbySkillDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResSkillCfgInfo.LENGTH_szSkillValueDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResSkillCfgInfo.LENGTH_szSkillUpTip))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResSkillCfgInfo.LENGTH_szIconPath))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num13 > (long)((ulong)ResSkillCfgInfo.LENGTH_szGuidePrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num15 > (long)((ulong)ResSkillCfgInfo.LENGTH_szEffectPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num17 > (long)((ulong)ResSkillCfgInfo.LENGTH_szGuideWarnPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num19 > (long)((ulong)ResSkillCfgInfo.LENGTH_szEffectWarnPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num21 > (long)((ulong)ResSkillCfgInfo.LENGTH_szFixedPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num23 > (long)((ulong)ResSkillCfgInfo.LENGTH_szFixedWarnPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num25 > (long)((ulong)ResSkillCfgInfo.LENGTH_szMapIndicatorNormalPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num27 > (long)((ulong)ResSkillCfgInfo.LENGTH_szMapIndicatorRedPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num29 > (long)((ulong)ResSkillCfgInfo.LENGTH_szPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
