...
namespace ResData
{
	public class ResTaskRewardDetail : IUnpackable, tsf4g_csharp_interface
	{
		...
		{
			if (cutVer == 0u || ResTaskRewardDetail.CURRVERSION < cutVer)
			{
				cutVer = ResTaskRewardDetail.CURRVERSION;
			}
			if (ResTaskRewardDetail.BASEVERSION > cutVer)
			{
