...
namespace ResData
{
	public class ResHeroSkinShop : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResHeroSkinShop.LENGTH_szHeroName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResHeroSkinShop.LENGTH_szSkinName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResHeroSkinShop.LENGTH_szSkinDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResHeroSkinShop.LENGTH_szLimitQualityPic))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResHeroSkinShop.LENGTH_szLimitLabelPic))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResHeroSkinShop.LENGTH_szGetPath))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num13 > (long)((ulong)ResHeroSkinShop.LENGTH_szOnTimeStr))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num15 > (long)((ulong)ResHeroSkinShop.LENGTH_szOffTimeStr))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
