...
namespace ResData
{
	public class ResBulletCfgInfo : IUnpackable, tsf4g_csharp_interface
	{
		public int iCfgID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResBulletCfgInfo.LENGTH_szBulletName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResBulletCfgInfo.LENGTH_szBulletDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResBulletCfgInfo.LENGTH_szPrefab))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
