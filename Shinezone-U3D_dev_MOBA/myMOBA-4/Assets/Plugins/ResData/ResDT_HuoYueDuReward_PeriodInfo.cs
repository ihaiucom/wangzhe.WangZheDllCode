...
namespace ResData
{
	public class ResDT_HuoYueDuReward_PeriodInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResDT_HuoYueDuReward_PeriodInfo.LENGTH_szStartTime))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResDT_HuoYueDuReward_PeriodInfo.LENGTH_szEndTime))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResDT_HuoYueDuReward_PeriodInfo.LENGTH_szIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
