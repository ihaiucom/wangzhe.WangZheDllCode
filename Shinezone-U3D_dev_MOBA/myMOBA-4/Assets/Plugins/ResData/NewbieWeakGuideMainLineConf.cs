...
namespace ResData
{
	public class NewbieWeakGuideMainLineConf : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwID;
		...
		public NewbieWeakGuideMainLineConf()
		{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)NewbieWeakGuideMainLineConf.LENGTH_szRemark))
				{
