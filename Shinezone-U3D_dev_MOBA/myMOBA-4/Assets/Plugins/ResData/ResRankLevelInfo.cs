...
namespace ResData
{
	public class ResRankLevelInfo : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwMapId;
		...
		{
			if (cutVer == 0u || ResRankLevelInfo.CURRVERSION < cutVer)
			{
				cutVer = ResRankLevelInfo.CURRVERSION;
			}
			if (ResRankLevelInfo.BASEVERSION > cutVer)
			{
