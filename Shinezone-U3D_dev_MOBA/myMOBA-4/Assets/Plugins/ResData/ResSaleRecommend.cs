...
namespace ResData
{
	public class ResSaleRecommend : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwID;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResSaleRecommend.LENGTH_szOnTime))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResSaleRecommend.LENGTH_szOffTime))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
