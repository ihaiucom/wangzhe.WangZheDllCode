...
namespace ResData
{
	public class ResAccelerator : IUnpackable, tsf4g_csharp_interface
	{
		...
		{
			if (cutVer == 0u || ResAccelerator.CURRVERSION < cutVer)
			{
				cutVer = ResAccelerator.CURRVERSION;
			}
			if (ResAccelerator.BASEVERSION > cutVer)
			{
