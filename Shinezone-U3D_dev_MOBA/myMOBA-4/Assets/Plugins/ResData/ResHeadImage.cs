...
namespace ResData
{
	public class ResHeadImage : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResHeadImage.LENGTH_szHeadDesc))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResHeadImage.LENGTH_szHeadAccess))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResHeadImage.LENGTH_szHeadIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResHeadImage.LENGTH_szShowStartTime))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResHeadImage.LENGTH_szShowEndTime))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResHeadImage.LENGTH_szEffect))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
