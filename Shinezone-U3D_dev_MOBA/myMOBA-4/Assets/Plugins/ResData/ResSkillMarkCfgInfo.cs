...
namespace ResData
{
	public class ResSkillMarkCfgInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szMarkName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szMarkDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szActionName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szLayerEffectName1))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szLayerEffectName2))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szLayerEffectName3))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num13 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szLayerEffectName4))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num15 > (long)((ulong)ResSkillMarkCfgInfo.LENGTH_szLayerEffectName5))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
