...
namespace ResData
{
	public class ResDT_LevelCommonInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szDesignFileName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szArtistFileName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szThumbnailPath))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szMapPath))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num11 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szBigMapPath))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num13 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szMusicStartEvent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num15 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szMusicEndEvent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num17 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szAmbientSoundEvent))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num19 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szBankResourceName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num21 > (long)((ulong)ResDT_LevelCommonInfo.LENGTH_szGameMatchName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
