...
namespace ResData
{
	public class ResDT_Item_Info : IUnpackable, tsf4g_csharp_interface
	{
		...
		{
			if (cutVer == 0u || ResDT_Item_Info.CURRVERSION < cutVer)
			{
				cutVer = ResDT_Item_Info.CURRVERSION;
			}
			if (ResDT_Item_Info.BASEVERSION > cutVer)
			{
