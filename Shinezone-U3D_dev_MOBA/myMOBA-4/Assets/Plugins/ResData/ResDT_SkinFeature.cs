...
namespace ResData
{
	public class ResDT_SkinFeature : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResDT_SkinFeature.LENGTH_szIconPath))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResDT_SkinFeature.LENGTH_szDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
