...
namespace ResData
{
	public class ResGuildGradeConf : IUnpackable, tsf4g_csharp_interface
	{
		public byte bIndex;
		...
		public uint dwGuildHeadImageShopOpenSlotCnt;
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResGuildGradeConf.LENGTH_szGradeDesc))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResGuildGradeConf.LENGTH_szIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				this.szGradeDesc_ByteArray = new byte[ResGuildGradeConf.LENGTH_szGradeDesc];
			}
			...
			{
				this.szIcon_ByteArray = new byte[ResGuildGradeConf.LENGTH_szIcon];
			}
