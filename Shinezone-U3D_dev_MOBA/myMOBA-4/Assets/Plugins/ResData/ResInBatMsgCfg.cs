...
namespace ResData
{
	public class ResInBatMsgCfg : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResInBatMsgCfg.LENGTH_szContent))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResInBatMsgCfg.LENGTH_szSound))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResInBatMsgCfg.LENGTH_szMiniMapEffect))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResInBatMsgCfg.LENGTH_szChannelTitle))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
