...
namespace ResData
{
	public class ResComposeInfo : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwCompID;
		...
		public ResDT_Compose_Obj[] astCompInfo;
		...
		public ResComposeInfo()
		{
			this.szName_ByteArray = new byte[1];
			this.astCompInfo = new ResDT_Compose_Obj[4];
			for (int i = 0; i < 4; i++)
			{
				this.astCompInfo[i] = new ResDT_Compose_Obj();
			}
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResComposeInfo.LENGTH_szName))
				{
