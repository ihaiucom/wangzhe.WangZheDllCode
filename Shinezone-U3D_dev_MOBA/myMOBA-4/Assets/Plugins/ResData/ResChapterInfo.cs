...
namespace ResData
{
	public class ResChapterInfo : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResChapterInfo.LENGTH_szChapterName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResChapterInfo.LENGTH_szChapterIcon))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResChapterInfo.LENGTH_szLockedTip))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num7 > (long)((ulong)ResChapterInfo.LENGTH_szUnlockTip))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num9 > (long)((ulong)ResChapterInfo.LENGTH_szChapterDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
