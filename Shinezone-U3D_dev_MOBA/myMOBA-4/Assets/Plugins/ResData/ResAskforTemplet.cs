...
namespace ResData
{
	public class ResAskforTemplet : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwID;
		...
		public static readonly uint LENGTH_szContent = 512u;

		public ResAskforTemplet()
		{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResAskforTemplet.LENGTH_szContent))
				{
		...
		public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				this.szContent_ByteArray = new byte[ResAskforTemplet.LENGTH_szContent];
			}
