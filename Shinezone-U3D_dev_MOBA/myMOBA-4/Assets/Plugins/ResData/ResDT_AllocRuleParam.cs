...
namespace ResData
{
	public class ResDT_AllocRuleParam : IUnpackable, tsf4g_csharp_interface
	{
		public ushort wMemberChooseType;

		public ushort wDivideType;

		public int iRangeRadius;

		public int iIncomeRate;

		public byte bDeadAddIncome;
