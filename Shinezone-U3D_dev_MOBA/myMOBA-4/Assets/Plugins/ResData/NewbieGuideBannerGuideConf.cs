...
namespace ResData
{
	public class NewbieGuideBannerGuideConf : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)NewbieGuideBannerGuideConf.LENGTH_szRemark))
				{
			...
			{
				if ((long)num3 > (long)((ulong)NewbieGuideBannerGuideConf.LENGTH_szTitleName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)NewbieGuideBannerGuideConf.LENGTH_szBtnName))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
