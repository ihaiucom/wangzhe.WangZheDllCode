...
namespace ResData
{
	public class ResDT_SkillDescription : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResDT_SkillDescription.LENGTH_szSkillDescType))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResDT_SkillDescription.LENGTH_szSkillDescBaseValue))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResDT_SkillDescription.LENGTH_szSkillDescGrowth))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
