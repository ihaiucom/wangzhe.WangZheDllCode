...
namespace ResData
{
	public class ResAchievement : IUnpackable, tsf4g_csharp_interface
	{
		...
		public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
		{
			...
			{
				if ((long)num > (long)((ulong)ResAchievement.LENGTH_szName))
				{
			...
			{
				if ((long)num3 > (long)((ulong)ResAchievement.LENGTH_szDesc))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
			...
			{
				if ((long)num5 > (long)((ulong)ResAchievement.LENGTH_szTips))
				{
					return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
				}
