...
namespace ResData
{
	public class ResNormalWinLoseMMRAdjust : IUnpackable, tsf4g_csharp_interface
	{
		public uint dwCnt;

		public int iWinMMRAdjust;

		public int iLoseMMRAdjust;

		public int iSettleWinMMRAdjust;

		public int iSettleLoseMMRAdjust;
