...
namespace Apollo
{
	internal class ApolloQuickLoginService : ApolloObject, IApolloQuickLoginService, IApolloServiceBase
	{
		...
		[DllImport("MsdkAdapter", CallingConvention = CallingConvention.Cdecl)]
		private static extern void apollo_account_SetQuickLoginBaseCallback([MarshalAs(UnmanagedType.FunctionPtr)] ApolloQuickLoginService.ApolloQuickLoginBaseDelegate callback);
	}
}
