...
namespace TMPro
{
	public static class MaterialManager
	{
		...
		public static Material GetStencilMaterial(Material baseMaterial, int stencilID)
		{
			...
			{
				material = MaterialManager.m_materialList[num].stencilMaterial;
				MaterialManager.m_materialList[num].count++;
			}
		...
		public static Material GetBaseMaterial(Material stencilMaterial)
		{
			...
			return MaterialManager.m_materialList[num].baseMaterial;
		}
		...
		public static void AddMaskingMaterial(Material baseMaterial, Material stencilMaterial, int stencilID)
		{
			...
			{
				stencilMaterial = MaterialManager.m_materialList[num].stencilMaterial;
				MaterialManager.m_materialList[num].count++;
			}
		}
		...
		public static void ReleaseBaseMaterial(Material baseMaterial)
		{
			...
			else if (MaterialManager.m_materialList[num].count > 1)
			{
				MaterialManager.m_materialList[num].count--;
				Debug.Log(string.Concat(new object[]
				{
					"Removed (1) reference to ",
					MaterialManager.m_materialList[num].stencilMaterial.name,
					". There are ",
					MaterialManager.m_materialList[num].count,
					" references left."
				}));
			...
			else
			{
				Debug.Log(string.Concat(new object[]
				{
					...
					MaterialManager.m_materialList[num].stencilMaterial.name,
					" with ID ",
					MaterialManager.m_materialList[num].stencilMaterial.GetInstanceID()
				}));
				UnityEngine.Object.DestroyImmediate(MaterialManager.m_materialList[num].stencilMaterial);
				MaterialManager.m_materialList.RemoveAt(num);
			}
			MaterialManager.ListMaterials();
		}
		...
		public static void ReleaseStencilMaterial(Material stencilMaterial)
		{
			...
			if (num != -1)
			{
				if (MaterialManager.m_materialList[num].count > 1)
				{
					MaterialManager.m_materialList[num].count--;
				}
				else
		...
		{
			if (MaterialManager.m_materialList.Count == 0)
			{
				Debug.Log("Material List has already been cleared.");
				return;
			}
			for (int i = 0; i < MaterialManager.m_materialList.Count; i++)
			{
				Material stencilMaterial = MaterialManager.m_materialList[i].stencilMaterial;
