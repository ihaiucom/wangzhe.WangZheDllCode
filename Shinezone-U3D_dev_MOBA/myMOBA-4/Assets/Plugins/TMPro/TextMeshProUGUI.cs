...
namespace TMPro
{
	...
	public class TextMeshProUGUI : Graphic, ILayoutElement, IMaskable
	{
		...
		protected override void Awake()
		{
			...
			ILayoutController arg_DD_1;
			if ((arg_DD_1 = (base.GetComponent(typeof(ILayoutController)) as ILayoutController)) == null)
			{
				if (base.transform.parent != null)
				{
					ILayoutController layoutController = base.transform.parent.GetComponent(typeof(ILayoutController)) as ILayoutController;
					arg_DD_1 = layoutController;
				}
				else
				{
					arg_DD_1 = null;
			...
			this.m_layoutController = arg_DD_1;
		...
		private void LoadFontAsset()
		{
			...
			if (!this.m_fontAsset.characterDictionary.TryGetValue(95, out this.m_cached_Underline_GlyphInfo))
			{
		...
		private void SetFontBaseMaterial(Material mat)
		{
			Debug.Log(string.Concat(new string[]
			{
				...
				(!(this.m_lastBaseMaterial == null)) ? this.m_lastBaseMaterial.name : "Null",
				"] to [",
				mat.name,
				"]."
			}));
		...
		private Material CreateMaterialInstance(Material source)
		{
			...
			Material expr_1B = material;
			expr_1B.name += " (Instance)";
			return material;
		}
		...
		private void ParseInputText()
		{
			...
			{
			case TextMeshProUGUI.TextInputSources.Text:
				this.StringToCharArray(this.m_text, ref this.m_char_buffer);
				break;
			case TextMeshProUGUI.TextInputSources.SetText:
		...
		private void GenerateTextMesh()
		{
			...
			while (this.m_char_buffer[num8] != 0)
			{
				...
				{
					this.m_fontAssetArray[this.m_fontIndex].characterDictionary.TryGetValue(num9, out this.m_cached_GlyphInfo);
					if (this.m_cached_GlyphInfo == null)
					{
						if (char.IsLower((char)num9))
						{
							if (this.m_fontAssetArray[this.m_fontIndex].characterDictionary.TryGetValue(num9 - 32, out this.m_cached_GlyphInfo))
							{
								num9 -= 32;
							}
						}
						else if (char.IsUpper((char)num9) && this.m_fontAssetArray[this.m_fontIndex].characterDictionary.TryGetValue(num9 + 32, out this.m_cached_GlyphInfo))
						{
							num9 += 32;
						}
						if (this.m_cached_GlyphInfo == null)
				...
				float num13 = (!this.m_isSprite) ? this.m_padding : ((float)((!this.m_enableExtraPadding) ? 0 : 4));
				...
				{
					this.m_maxAscender = ((this.m_maxAscender <= num15) ? num15 : this.m_maxAscender);
				}
				if (this.m_lineOffset == 0f)
				{
					num6 = ((num6 <= num15) ? num15 : num6);
				}
				...
				{
					TMP_LineInfo[] expr_16EE_cp_0 = this.m_textInfo.lineInfo;
					int expr_16EE_cp_1 = this.m_lineNumber;
					expr_16EE_cp_0[expr_16EE_cp_1].spaceCount = expr_16EE_cp_0[expr_16EE_cp_1].spaceCount + 1;
				...
				if (num9 != 13 && num9 != 10 && this.m_pageNumber < 16)
				{
					...
					this.m_textInfo.pageInfo[this.m_pageNumber].descender = ((num16 >= this.m_textInfo.pageInfo[this.m_pageNumber].descender) ? this.m_textInfo.pageInfo[this.m_pageNumber].descender : num16);
				...
				if (this.m_enableWordWrapping || this.m_overflowMode == TextOverflowModes.Truncate || this.m_overflowMode == TextOverflowModes.Ellipsis)
				{
					...
					else if (((flag3 || this.m_isCharacterWrappingEnabled) && this.m_characterCount < num - 1 && !this.m_fontAsset.lineBreakingInfo.leadingCharacters.ContainsKey(num9) && !this.m_fontAsset.lineBreakingInfo.followingCharacters.ContainsKey((int)this.m_VisibleCharacters[this.m_characterCount + 1])) || flag4)
					{
						this.SaveWordWrappingState(ref this.m_SavedWordWrapState, num8, this.m_characterCount);
					}
				}
			...
			else
			{
				...
				for (int j = 0; j < this.m_characterCount; j++)
				{
					...
					int lineNumber = (int)characterInfo[j].lineNumber;
					...
					case TextAlignmentOptions.MidlineJustified:
					{
						int num9 = (int)this.m_textInfo.characterInfo[j].character;
					...
					if (characterInfo[j].isVisible)
					{
						...
						else
						{
							...
							float num40 = this.m_uvLineOffset * (float)lineNumber % 1f + this.m_uvOffset.x;
						...
						if ((this.m_maxVisibleCharacters != -1 && j >= this.m_maxVisibleCharacters) || (this.m_maxVisibleLines != -1 && lineNumber >= this.m_maxVisibleLines) || (this.m_overflowMode == TextOverflowModes.Page && (int)characterInfo[j].pageNumber != this.m_pageToDisplay))
						{
							TMP_CharacterInfo[] expr_429D_cp_0_cp_0 = characterInfo;
							int expr_429D_cp_0_cp_1 = j;
							expr_429D_cp_0_cp_0[expr_429D_cp_0_cp_1].vertex_BL.position = expr_429D_cp_0_cp_0[expr_429D_cp_0_cp_1].vertex_BL.position * 0f;
							TMP_CharacterInfo[] expr_42C0_cp_0_cp_0 = characterInfo;
							int expr_42C0_cp_0_cp_1 = j;
							expr_42C0_cp_0_cp_0[expr_42C0_cp_0_cp_1].vertex_TL.position = expr_42C0_cp_0_cp_0[expr_42C0_cp_0_cp_1].vertex_TL.position * 0f;
							TMP_CharacterInfo[] expr_42E3_cp_0_cp_0 = characterInfo;
							int expr_42E3_cp_0_cp_1 = j;
							expr_42E3_cp_0_cp_0[expr_42E3_cp_0_cp_1].vertex_TR.position = expr_42E3_cp_0_cp_0[expr_42E3_cp_0_cp_1].vertex_TR.position * 0f;
							TMP_CharacterInfo[] expr_4306_cp_0_cp_0 = characterInfo;
							int expr_4306_cp_0_cp_1 = j;
							expr_4306_cp_0_cp_0[expr_4306_cp_0_cp_1].vertex_BR.position = expr_4306_cp_0_cp_0[expr_4306_cp_0_cp_1].vertex_BR.position * 0f;
						}
						else
						{
							TMP_CharacterInfo[] expr_432E_cp_0_cp_0 = characterInfo;
							int expr_432E_cp_0_cp_1 = j;
							expr_432E_cp_0_cp_0[expr_432E_cp_0_cp_1].vertex_BL.position = expr_432E_cp_0_cp_0[expr_432E_cp_0_cp_1].vertex_BL.position + b3;
							TMP_CharacterInfo[] expr_434E_cp_0_cp_0 = characterInfo;
							int expr_434E_cp_0_cp_1 = j;
							expr_434E_cp_0_cp_0[expr_434E_cp_0_cp_1].vertex_TL.position = expr_434E_cp_0_cp_0[expr_434E_cp_0_cp_1].vertex_TL.position + b3;
							TMP_CharacterInfo[] expr_436E_cp_0_cp_0 = characterInfo;
							int expr_436E_cp_0_cp_1 = j;
							expr_436E_cp_0_cp_0[expr_436E_cp_0_cp_1].vertex_TR.position = expr_436E_cp_0_cp_0[expr_436E_cp_0_cp_1].vertex_TR.position + b3;
							TMP_CharacterInfo[] expr_438E_cp_0_cp_0 = characterInfo;
							int expr_438E_cp_0_cp_1 = j;
							expr_438E_cp_0_cp_0[expr_438E_cp_0_cp_1].vertex_BR.position = expr_438E_cp_0_cp_0[expr_438E_cp_0_cp_1].vertex_BR.position + b3;
						}
					...
					TMP_CharacterInfo[] expr_43E6_cp_0 = this.m_textInfo.characterInfo;
					int expr_43E6_cp_1 = j;
					expr_43E6_cp_0[expr_43E6_cp_1].bottomLeft = expr_43E6_cp_0[expr_43E6_cp_1].bottomLeft + b3;
					TMP_CharacterInfo[] expr_440A_cp_0 = this.m_textInfo.characterInfo;
					int expr_440A_cp_1 = j;
					expr_440A_cp_0[expr_440A_cp_1].topRight = expr_440A_cp_0[expr_440A_cp_1].topRight + b3;
					TMP_CharacterInfo[] expr_442E_cp_0 = this.m_textInfo.characterInfo;
					int expr_442E_cp_1 = j;
					expr_442E_cp_0[expr_442E_cp_1].topLine = expr_442E_cp_0[expr_442E_cp_1].topLine + b3.y;
					TMP_CharacterInfo[] expr_4453_cp_0 = this.m_textInfo.characterInfo;
					int expr_4453_cp_1 = j;
					expr_4453_cp_0[expr_4453_cp_1].bottomLine = expr_4453_cp_0[expr_4453_cp_1].bottomLine + b3.y;
					TMP_CharacterInfo[] expr_4478_cp_0 = this.m_textInfo.characterInfo;
					int expr_4478_cp_1 = j;
					expr_4478_cp_0[expr_4478_cp_1].baseLine = expr_4478_cp_0[expr_4478_cp_1].baseLine + b3.y;
					...
					if (lineNumber != num37 || j == this.m_characterCount - 1)
					{
						if (lineNumber != num37)
						{
					...
					{
						int num50 = (j != this.m_characterCount - 1 || !char.IsLetterOrDigit(character2)) ? (j - 1) : j;
						flag6 = false;
						num35++;
						TMP_LineInfo[] expr_47FF_cp_0 = this.m_textInfo.lineInfo;
						int expr_47FF_cp_1 = lineNumber;
						expr_47FF_cp_0[expr_47FF_cp_1].wordCount = expr_47FF_cp_0[expr_47FF_cp_1].wordCount + 1;
						TMP_WordInfo item = default(TMP_WordInfo);
						item.firstCharacterIndex = num38;
						item.lastCharacterIndex = num50;
						item.characterCount = num50 - num38 + 1;
				...
				this.m_textInfo.wordCount = (int)((num35 == 0 || this.m_characterCount <= 0) ? (short)1 : ((short)num35));
		...
		{
			int newSize = size * 4;
			int num = this.m_uiVertices.Length / 4;
		...
		private void AdjustLineOffset(int startIndex, int endIndex, float offset)
		{
			...
			for (int i = startIndex; i <= endIndex; i++)
			{
				...
				{
					TMP_CharacterInfo[] arg_6F_0_cp_0_cp_0 = this.m_textInfo.characterInfo;
					int arg_6F_0_cp_0_cp_1 = i;
					TMP_CharacterInfo[] expr_5B_cp_0 = this.m_textInfo.characterInfo;
					int expr_5B_cp_1 = i;
					arg_6F_0_cp_0_cp_0[arg_6F_0_cp_0_cp_1].vertex_BL.position = (expr_5B_cp_0[expr_5B_cp_1].bottomLeft = expr_5B_cp_0[expr_5B_cp_1].bottomLeft - b);
					TMP_CharacterInfo[] arg_AF_0_cp_0_cp_0 = this.m_textInfo.characterInfo;
					int arg_AF_0_cp_0_cp_1 = i;
					TMP_CharacterInfo[] expr_9B_cp_0 = this.m_textInfo.characterInfo;
					int expr_9B_cp_1 = i;
					arg_AF_0_cp_0_cp_0[arg_AF_0_cp_0_cp_1].vertex_TL.position = (expr_9B_cp_0[expr_9B_cp_1].topLeft = expr_9B_cp_0[expr_9B_cp_1].topLeft - b);
					TMP_CharacterInfo[] arg_EF_0_cp_0_cp_0 = this.m_textInfo.characterInfo;
					int arg_EF_0_cp_0_cp_1 = i;
					TMP_CharacterInfo[] expr_DB_cp_0 = this.m_textInfo.characterInfo;
					int expr_DB_cp_1 = i;
					arg_EF_0_cp_0_cp_0[arg_EF_0_cp_0_cp_1].vertex_TR.position = (expr_DB_cp_0[expr_DB_cp_1].topRight = expr_DB_cp_0[expr_DB_cp_1].topRight - b);
					TMP_CharacterInfo[] arg_12F_0_cp_0_cp_0 = this.m_textInfo.characterInfo;
					int arg_12F_0_cp_0_cp_1 = i;
					TMP_CharacterInfo[] expr_11B_cp_0 = this.m_textInfo.characterInfo;
					int expr_11B_cp_1 = i;
					arg_12F_0_cp_0_cp_0[arg_12F_0_cp_0_cp_1].vertex_BR.position = (expr_11B_cp_0[expr_11B_cp_1].bottomRight = expr_11B_cp_0[expr_11B_cp_1].bottomRight - b);
					TMP_CharacterInfo[] expr_145_cp_0 = this.m_textInfo.characterInfo;
					int expr_145_cp_1 = i;
					expr_145_cp_0[expr_145_cp_1].bottomLine = expr_145_cp_0[expr_145_cp_1].bottomLine - b.y;
					TMP_CharacterInfo[] expr_169_cp_0 = this.m_textInfo.characterInfo;
					int expr_169_cp_1 = i;
					expr_169_cp_0[expr_169_cp_1].topLine = expr_169_cp_0[expr_169_cp_1].topLine - b.y;
				}
			}
		}
