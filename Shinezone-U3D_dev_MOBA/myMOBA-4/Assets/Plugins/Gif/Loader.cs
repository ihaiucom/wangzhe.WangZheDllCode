		...
		private void ImageDataFlipY(ref Image image)
		{
			...
			if (image.desc.interlace_flag)
			{
				...
				while (i < image.desc.image_height)
				{
					...
					int destinationIndex = (image.desc.image_height - 1 - i) * image.desc.image_width;
					Array.Copy(image.data, sourceIndex, array, destinationIndex, image.desc.image_width);
					i += 8;
					num++;
				}
				int j = 4;
				...
				{
					int sourceIndex2 = num * image.desc.image_width;
					int destinationIndex2 = (image.desc.image_height - 1 - j) * image.desc.image_width;
					Array.Copy(image.data, sourceIndex2, array, destinationIndex2, image.desc.image_width);
					j += 8;
					num++;
				}
				int k = 2;
				...
				{
					int sourceIndex3 = num * image.desc.image_width;
					int destinationIndex3 = (image.desc.image_height - 1 - k) * image.desc.image_width;
					Array.Copy(image.data, sourceIndex3, array, destinationIndex3, image.desc.image_width);
					k += 4;
					num++;
				}
				int l = 1;
				...
				{
					int sourceIndex4 = num * image.desc.image_width;
					int destinationIndex4 = (image.desc.image_height - 1 - l) * image.desc.image_width;
					Array.Copy(image.data, sourceIndex4, array, destinationIndex4, image.desc.image_width);
					l += 2;
					num++;
				}
			}
			else
			{
				...
				{
					int sourceIndex5 = m * image.desc.image_width;
					int destinationIndex5 = (image.desc.image_height - 1 - m) * image.desc.image_width;
					Array.Copy(image.data, sourceIndex5, array, destinationIndex5, image.desc.image_width);
				}
			}
