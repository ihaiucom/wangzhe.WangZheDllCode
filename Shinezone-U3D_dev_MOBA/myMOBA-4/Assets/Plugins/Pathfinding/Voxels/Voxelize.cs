...
namespace Pathfinding.Voxels
{
	public class Voxelize
	{
							...
							for (int m = num6; m <= num8; m++)
							{
								...
								if (num11 >= 3)
								{
									...
									if (num11 >= 3)
									{
										...
										int num14 = AstarMath.Clamp(MMGame_Math.RoundToInt((double)num12), 0, this.voxelArea.depth - 1);
										int num15 = AstarMath.Clamp(MMGame_Math.RoundToInt((double)num13), 0, this.voxelArea.depth - 1);
											...
											if (num17 >= 3)
											{
												...
												if (num17 >= 3)
												{
													...
													if (num21 >= 0)
													{
														...
														this.voxelArea.AddLinkedSpan(num16 * this.voxelArea.width + m, (uint)((num22 < 0) ? 0 : num22), (uint)num21, area2, this.voxelWalkableClimb);
													}
												}
											}
										}
		...
		public void BuildRegions()
		{
			...
			ushort num5 = 2;
			this.MarkRectWithRegion(0, this.borderSize, 0, num2, (ushort)(num5 | 32768), array);
			num5 += 1;
			this.MarkRectWithRegion(num - this.borderSize, num, 0, num2, (ushort)(num5 | 32768), array);
			num5 += 1;
			this.MarkRectWithRegion(0, num, 0, this.borderSize, (ushort)(num5 | 32768), array);
			num5 += 1;
			this.MarkRectWithRegion(0, num, num2 - this.borderSize, num2, (ushort)(num5 | 32768), array);
			num5 += 1;
