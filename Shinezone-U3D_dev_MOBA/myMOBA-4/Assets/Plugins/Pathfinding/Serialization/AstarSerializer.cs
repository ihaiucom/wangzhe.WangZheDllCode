...
namespace Pathfinding.Serialization
{
	public class AstarSerializer
	{
		...
		private byte[] SerializeMeta()
		{
			...
			binaryWriter.Write(this.meta.version.Major);
			binaryWriter.Write(this.meta.version.Minor);
			binaryWriter.Write(this.meta.version.Build);
			binaryWriter.Write(this.meta.version.Revision);
