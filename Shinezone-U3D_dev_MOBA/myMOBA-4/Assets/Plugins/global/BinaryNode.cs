...
public class BinaryNode
{
	...
	public string GetValueString(Encoding encoding)
	{
		...
		return Encoding.UTF8.GetString(this.m_data, this.m_valueOffset + BinaryNode.INT_LEN, num - BinaryNode.INT_LEN);
	}

	public string GetName()
	{
		return Encoding.UTF8.GetString(this.m_data, this.m_nameOffset + BinaryNode.INT_LEN, this.m_nameLen);
	}
}
