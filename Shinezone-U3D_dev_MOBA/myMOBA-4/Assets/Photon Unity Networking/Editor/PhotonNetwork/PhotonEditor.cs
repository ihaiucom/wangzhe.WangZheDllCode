...
public class PhotonEditor : EditorWindow
{
	...
	[MenuItem("Window/Photon Unity Networking/Build Settings", false, 100)]
	protected static void MenuItemBuildSettings()
	{
		string bundlePath = Application.dataPath + "/../Tools/apktool_2.2.2/wangzhe/assets/PhotonServerSettings.assetbundle";
		BuildPipeline.BuildAssetBundle(PhotonNetwork.PhotonServerSettings, 
		                               null, 
		                               bundlePath, 
