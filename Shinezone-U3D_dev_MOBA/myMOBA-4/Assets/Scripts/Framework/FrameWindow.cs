...
namespace Assets.Scripts.Framework
{
	...
	public class FrameWindow : Singleton<FrameWindow>, IGameModule
	{
		...
		public void UpdateFrame()
		{
			...
			{
				if (this._maxFrqNo > this._begFrqNo && this._receiveWindow[(int)((UIntPtr)this._FrqNoToWinIdx_(this._begFrqNo))] == null)
				{
		...
		private void RequestRepairFraqBootInfo()
		{
			...
			{
				if (this._receiveWindow[(int)((UIntPtr)this._FrqNoToWinIdx_(num))] == null)
				{
					b += 1;
					...
					uint[] arg_8A_0 = stReqFrapBootSingle.KFrapsNo;
					CSPKG_REQUESTFRAPBOOTSINGLE expr_75 = stReqFrapBootSingle;
					byte bNum;
					expr_75.bNum = (byte)((bNum = expr_75.bNum) + (byte)1);
					arg_8A_0[(int)bNum] = num;
				}
				else
				{
					if (b > b2)
