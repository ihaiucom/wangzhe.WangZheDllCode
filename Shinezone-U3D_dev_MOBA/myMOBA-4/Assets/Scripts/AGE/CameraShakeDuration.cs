...
namespace AGE
{
	public class CameraShakeDuration : DurationEvent
	{
		...
		public override void Process(Action _action, Track _track, int _localTime)
		{
			...
			Vector3 a = new Vector3(UnityEngine.Random.Range(-this.shock.x, this.shock.x), UnityEngine.Random.Range(-this.shock.y, this.shock.y), UnityEngine.Random.Range(-this.shock.z, this.shock.z));
