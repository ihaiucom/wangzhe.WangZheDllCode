...
public class ImageWrap
{
	...
	private static int get_sprite(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.sprite);
		return 1;
	}
	...
	private static int get_overrideSprite(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.overrideSprite);
		return 1;
	}
	...
	private static int get_type(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.type);
		return 1;
	}
	...
	private static int get_preserveAspect(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.preserveAspect);
		return 1;
	}
	...
	private static int get_fillCenter(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.fillCenter);
		return 1;
	}
	...
	private static int get_fillMethod(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.fillMethod);
		return 1;
	}
	...
	private static int get_fillAmount(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.fillAmount);
		return 1;
	}
	...
	private static int get_fillClockwise(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.fillClockwise);
		return 1;
	}
	...
	private static int get_fillOrigin(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.fillOrigin);
		return 1;
	}
	...
	private static int get_eventAlphaThreshold(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.eventAlphaThreshold);
		return 1;
	}
	...
	private static int get_mainTexture(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.mainTexture);
		return 1;
	}
	...
	private static int get_hasBorder(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.hasBorder);
		return 1;
	}
	...
	private static int get_pixelsPerUnit(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.pixelsPerUnit);
		return 1;
	}
	...
	private static int get_minWidth(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.minWidth);
		return 1;
	}
	...
	private static int get_preferredWidth(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.preferredWidth);
		return 1;
	}
	...
	private static int get_flexibleWidth(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.flexibleWidth);
		return 1;
	}
	...
	private static int get_minHeight(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.minHeight);
		return 1;
	}
	...
	private static int get_preferredHeight(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.preferredHeight);
		return 1;
	}
	...
	private static int get_flexibleHeight(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.flexibleHeight);
		return 1;
	}
	...
	private static int get_layoutPriority(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, image.layoutPriority);
		return 1;
	}
	...
	private static int set_sprite(IntPtr L)
	{
		...
		image.sprite = (Sprite)LuaScriptMgr.GetUnityObject(L, 3, typeof(Sprite));
		return 0;
	}
	...
	private static int set_overrideSprite(IntPtr L)
	{
		...
		image.overrideSprite = (Sprite)LuaScriptMgr.GetUnityObject(L, 3, typeof(Sprite));
		return 0;
	}
	...
	private static int set_type(IntPtr L)
	{
		...
		image.type = (Image.Type)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(Image.Type)));
		return 0;
	}
	...
	private static int set_preserveAspect(IntPtr L)
	{
		...
		image.preserveAspect = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	private static int set_fillCenter(IntPtr L)
	{
		...
		image.fillCenter = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	private static int set_fillMethod(IntPtr L)
	{
		...
		image.fillMethod = (Image.FillMethod)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(Image.FillMethod)));
		return 0;
	}
	...
	private static int set_fillAmount(IntPtr L)
	{
		...
		image.fillAmount = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	private static int set_fillClockwise(IntPtr L)
	{
		...
		image.fillClockwise = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
	...
	private static int set_fillOrigin(IntPtr L)
	{
		...
		image.fillOrigin = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	private static int set_eventAlphaThreshold(IntPtr L)
	{
		...
		image.eventAlphaThreshold = (float)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	private static int IsRaycastLocationValid(IntPtr L)
	{
		...
		bool b = image.IsRaycastLocationValid(vector, eventCamera);
