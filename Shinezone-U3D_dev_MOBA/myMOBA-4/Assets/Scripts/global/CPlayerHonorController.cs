...
public class CPlayerHonorController : Singleton<CPlayerHonorController>
{
	...
	public void Draw(CUIFormScript form)
	{
		...
		while (enumerator.MoveNext())
		{
			...
			COMDT_HONORINFO value = current.Value;
			if (value != null)
			{
		...
		honorDic.TryGetValue(selectedHonorId, out honorInfo);
	...
	private void OnHonorItemEnable(CUIEvent uiEvent)
	{
		...
		COMDT_HONORINFO cOMDT_HONORINFO = this.m_honorInfoList[srcWidgetIndexInBelongedList];
