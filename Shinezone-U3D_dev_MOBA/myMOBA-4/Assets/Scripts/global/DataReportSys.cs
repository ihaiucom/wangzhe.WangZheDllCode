...
public class DataReportSys : Singleton<DataReportSys>
{
	...
	private class PingReport
	{
		...
		private void PingVariance()
		{
			...
			if (this.m_pingRecords != null && this.m_pingRecords.Count > 0)
			{
				...
				double num2 = num / (double)this.m_pingRecords.Count;
		...
		public List<KeyValuePair<string, string>> ReportPingToBeacon()
		{
			...
			{
				new KeyValuePair<string, string>("NewPing460", this.m_ping460Count.ToString()),
				new KeyValuePair<string, string>("NewPing300", this.m_ping300Count.ToString()),
				new KeyValuePair<string, string>("NewPing200To300", this.m_ping200to300Count.ToString()),
				new KeyValuePair<string, string>("NewAvePing", this.m_AvePing.ToString()),
				new KeyValuePair<string, string>("Min_Ping", this.m_NewMinPing.ToString()),
				new KeyValuePair<string, string>("Max_Ping", this.m_NewMaxPing.ToString()),
				new KeyValuePair<string, string>("Avg_Ping", this.m_NewAvePing.ToString()),
				new KeyValuePair<string, string>("Abnormal_Ping", this.m_NewAbnormal_PingCount.ToString()),
				new KeyValuePair<string, string>("Ping300", this.m_Newping300Count.ToString()),
				new KeyValuePair<string, string>("Ping150to300", this.m_Newping150to300.ToString()),
				new KeyValuePair<string, string>("Ping150", this.m_Newping150.ToString()),
				new KeyValuePair<string, string>("LostpingCount", this.CalcLostPingCount().ToString()),
				new KeyValuePair<string, string>("PingSeqCount", (this.m_NewSendHeartSeq - 1).ToString()),
				new KeyValuePair<string, string>("PingVariance", this.m_NewPingVariance.ToString()),
				new KeyValuePair<string, string>("BattleSvr_Reconnect", this.m_BattleReconnectCount.ToString()),
				new KeyValuePair<string, string>("GameSvr_Reconnect", this.m_LobbyReconnectCount.ToString())
			};
		}
	}
	...
	private class FPSReport
	{
		...
		public List<KeyValuePair<string, string>> ReportFPSToBeacon()
		{
			return new List<KeyValuePair<string, string>>
			{
				new KeyValuePair<string, string>("Max_FPS", this.m_MaxBattleFPS.ToString()),
				new KeyValuePair<string, string>("Min_FPS", this.m_MinBattleFPS.ToString()),
				new KeyValuePair<string, string>("Avg_FPS", this.m_fAveFPS.ToString()),
				new KeyValuePair<string, string>("Less5FPSCount", this.m_fpsCunt5.ToString()),
				new KeyValuePair<string, string>("Less10FPSCount", this.m_fpsCunt10.ToString()),
				new KeyValuePair<string, string>("Less18FPSCount", this.m_fpsCunt18.ToString()),
				new KeyValuePair<string, string>("Less25FPSCount", this.m_fpsCunt25.ToString()),
				new KeyValuePair<string, string>("Ab_FPS_time", this.m_Ab_FPS_time.ToString()),
				new KeyValuePair<string, string>("Abnormal_FPS", this.m_Abnormal_FPS_Count.ToString()),
				new KeyValuePair<string, string>("Ab_4FPS_time", this.m_Ab_4FPS_time.ToString()),
				new KeyValuePair<string, string>("Abnormal_4FPS", this.m_Abnormal_4FPS_Count.ToString())
			};
		}
	}
	...
	public int HeartPingCount
	{
		get
		{
			...
			{
				return DataReportSys.m_pPingReporter.m_pingRecords.Count;
			}
			return result;
		}
	}
	...
	public void Report(ref COMDT_CLIENT_RECORD_DATA stGeneralData, uint playerID)
	{
		...
		{
			stGeneralData.wClientPingNum = Math.Min((ushort)500, DataReportSys.m_pPingReporter.DataLen);
			...
			stGeneralData.wClientFPSNum = Math.Min((ushort)500, DataReportSys.m_pkFpsReport.DataLen);
