		...
		if (slotType != this.CurrentSlotType)
		{
			...
			if (num >= 0 && num < this.sNormalImg.Length)
			{
				if (!string.IsNullOrEmpty(this.sNormalImg[num]) && !string.IsNullOrEmpty(this.sRedImg[num]))
				{
					...
					this.SetWidthHeight(this.mini_normalImgNode, (this.fSmallImgWidth[num] <= 0f) ? 400f : this.fSmallImgWidth[num], this.fSmallImgHeight[num]);
					this.SetWidthHeight(this.mini_redImgNode, (this.fSmallImgWidth[num] <= 0f) ? 400f : this.fSmallImgWidth[num], this.fSmallImgHeight[num]);
					this.SetWidthHeight(this.big_normalImgNode, (this.fBigImgWidth[num] <= 0f) ? 800f : this.fBigImgWidth[num], this.fBigImgHeight[num]);
					this.SetWidthHeight(this.big_redImgNode, (this.fBigImgWidth[num] <= 0f) ? 800f : this.fBigImgWidth[num], this.fBigImgHeight[num]);
