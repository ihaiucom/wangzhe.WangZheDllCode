...
public class CameraSystem : MonoSingleton<CameraSystem>
{
	...
	public void MoveCamera(float offX, float offY)
	{
		if (this.MobaCamera != null)
		{
			...
			Moba_Camera_Settings expr_45_cp_0 = this.MobaCamera.settings;
			expr_45_cp_0.absoluteLockLocation.x = expr_45_cp_0.absoluteLockLocation.x + offX * CameraSystem.s_CameraMoveScale;
			Moba_Camera_Settings expr_68_cp_0 = this.MobaCamera.settings;
			expr_68_cp_0.absoluteLockLocation.z = expr_68_cp_0.absoluteLockLocation.z + offY * CameraSystem.s_CameraMoveScale;
		}
	}
