...
internal class SetIntimacy : CheatCommandNetworking
{
	protected override string Execute(string[] InArguments, ref CSDT_CHEATCMD_DETAIL CheatCmdRef)
	{
		...
		CheatCmdRef.stChgIntimacy.stUin.ullUid = ((num != 0uL) ? num : masterRoleInfo.playerUllUID);
		CheatCmdRef.stChgIntimacy.stUin.dwLogicWorldId = ((num2 != 0u) ? num2 : ((uint)masterRoleInfo.logicWorldID));
