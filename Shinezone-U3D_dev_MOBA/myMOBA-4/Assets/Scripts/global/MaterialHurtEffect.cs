...
public class MaterialHurtEffect : ActorComponent
{
	...
	public int PlayHighLitEffect(Vector3 color)
	{
		...
		MaterialHurtEffect.HighLitColor item = default(MaterialHurtEffect.HighLitColor);
	...
	public void StopHighLitEffect(int id)
	{
		...
		{
			sMaterialEffect_HighLit.color = this.hlcList[this.hlcList.Count - 1].color;
		}
