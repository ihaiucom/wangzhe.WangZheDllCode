...
public class NewbieGuide5v5GuideConfirm : NewbieGuideBaseScript
{
	...
	protected override void Initialize()
	{
		...
		if (this.ConfirmBtnScript != null)
		{
			...
			CUIEventScript expr_87 = this.ConfirmBtnScript;
			expr_87.onClick = (CUIEventScript.OnUIEventHandler)Delegate.Combine(expr_87.onClick, new CUIEventScript.OnUIEventHandler(this.ClickHandler));
		}
		base.Initialize();
	}
	...
	protected override void ClickHandler(CUIEvent uiEvt)
	{
		if (this.ConfirmBtnScript != null)
		{
			CUIEventScript expr_17 = this.ConfirmBtnScript;
