...
public class TypeWrap
{
	...
	private static int GetTypeFromCLSID(IntPtr L)
	{
		...
		{
			Guid clsid2 = (Guid)LuaScriptMgr.GetLuaObject(L, 1);
			string @string = LuaScriptMgr.GetString(L, 2);
			Type typeFromCLSID2 = Type.GetTypeFromCLSID(clsid2, @string);
	...
	private static int GetTypeFromProgID(IntPtr L)
	{
		...
		if (num == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(bool)))
		{
			...
			bool throwOnError = LuaDLL.lua_toboolean(L, 2);
			Type typeFromProgID3 = Type.GetTypeFromProgID(string3, throwOnError);
	...
	private static int FindInterfaces(IntPtr L)
	{
		...
		else
		{
			...
			filter = delegate(Type param0, object param1)
			{
		...
		Type[] o = typeObject.FindInterfaces(filter, varObject);
	...
	private static int GetEvent(IntPtr L)
	{
		...
		if (num == 3)
		{
			...
			EventInfo event2 = typeObject2.GetEvent(luaString2, bindingAttr);
	...
	private static int GetEvents(IntPtr L)
	{
		...
		if (num == 2)
		{
			...
			EventInfo[] events2 = typeObject2.GetEvents(bindingAttr);
	...
	private static int GetField(IntPtr L)
	{
		...
		if (num == 3)
		{
			...
			string luaString2 = LuaScriptMgr.GetLuaString(L, 2);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(BindingFlags)));
			FieldInfo field2 = typeObject2.GetField(luaString2, bindingAttr);
	...
	private static int GetFields(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			FieldInfo[] fields2 = typeObject2.GetFields(bindingAttr);
	...
	private static int GetMember(IntPtr L)
	{
		...
		if (num == 3)
		{
			...
			string luaString2 = LuaScriptMgr.GetLuaString(L, 2);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(BindingFlags)));
			MemberInfo[] member2 = typeObject2.GetMember(luaString2, bindingAttr);
		...
		if (num == 4)
		{
			...
			BindingFlags bindingAttr2 = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 4, typeof(BindingFlags)));
			MemberInfo[] member3 = typeObject3.GetMember(luaString3, type, bindingAttr2);
	...
	private static int GetMembers(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			MemberInfo[] members2 = typeObject2.GetMembers(bindingAttr);
	...
	private static int GetMethod(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Type), typeof(string), typeof(BindingFlags)))
		{
			...
			MethodInfo method3 = typeObject3.GetMethod(string2, bindingAttr);
		...
		if (num == 6)
		{
			...
			MethodInfo method5 = typeObject5.GetMethod(luaString3, bindingAttr2, binder, arrayObject4, arrayObject5);
		...
		if (num == 7)
		{
			...
			MethodInfo method6 = typeObject6.GetMethod(luaString4, bindingAttr3, binder2, callConvention, arrayObject6, arrayObject7);
	...
	private static int GetMethods(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			MethodInfo[] methods2 = typeObject2.GetMethods(bindingAttr);
	...
	private static int GetNestedType(IntPtr L)
	{
		...
		if (num == 3)
		{
			...
			string luaString2 = LuaScriptMgr.GetLuaString(L, 2);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 3, typeof(BindingFlags)));
			Type nestedType2 = typeObject2.GetNestedType(luaString2, bindingAttr);
	...
	private static int GetNestedTypes(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			Type[] nestedTypes2 = typeObject2.GetNestedTypes(bindingAttr);
	...
	private static int GetProperties(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			PropertyInfo[] properties2 = typeObject2.GetProperties(bindingAttr);
	...
	private static int GetProperty(IntPtr L)
	{
		...
		if (num == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Type), typeof(string), typeof(BindingFlags)))
		{
			...
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetLuaObject(L, 3));
			PropertyInfo property4 = typeObject5.GetProperty(string3, bindingAttr);
		...
		if (num == 7)
		{
			...
			PropertyInfo property7 = typeObject10.GetProperty(luaString4, bindingAttr2, binder, typeObject11, arrayObject5, arrayObject6);
	...
	private static int GetConstructor(IntPtr L)
	{
		...
		if (num == 5)
		{
			...
			ConstructorInfo constructor2 = typeObject2.GetConstructor(bindingAttr, binder, arrayObject2, arrayObject3);
		...
		if (num == 6)
		{
			...
			Type[] arrayObject4 = LuaScriptMgr.GetArrayObject<Type>(L, 5);
			ParameterModifier[] arrayObject5 = LuaScriptMgr.GetArrayObject<ParameterModifier>(L, 6);
			ConstructorInfo constructor3 = typeObject3.GetConstructor(bindingAttr2, binder2, callConvention, arrayObject4, arrayObject5);
	...
	private static int GetConstructors(IntPtr L)
	{
		...
		if (num == 2)
		{
			Type typeObject2 = LuaScriptMgr.GetTypeObject(L, 1);
			BindingFlags bindingAttr = (BindingFlags)((int)LuaScriptMgr.GetNetObject(L, 2, typeof(BindingFlags)));
			ConstructorInfo[] constructors2 = typeObject2.GetConstructors(bindingAttr);
	...
	private static int FindMembers(IntPtr L)
	{
		...
		else
		{
			...
			filter = delegate(MemberInfo param0, object param1)
			{
				int oldTop = func.BeginPCall();
	...
	private static int InvokeMember(IntPtr L)
	{
		...
		if (num == 7)
		{
			...
			object o2 = typeObject2.InvokeMember(luaString2, invokeAttr2, binder2, varObject2, arrayObject2, culture);
		...
		if (num == 9)
		{
			...
			CultureInfo culture2 = (CultureInfo)LuaScriptMgr.GetNetObject(L, 8, typeof(CultureInfo));
			string[] arrayString = LuaScriptMgr.GetArrayString(L, 9);
			object o3 = typeObject3.InvokeMember(luaString3, invokeAttr3, binder3, varObject3, arrayObject3, arrayObject4, culture2, arrayString);
	...
	private static int MakeArrayType(IntPtr L)
	{
		...
		if (num == 2)
		{
			...
			Type o2 = typeObject2.MakeArrayType(rank);
