...
namespace IIPSMobile
{
	internal class IIPSMobileErrorCodeCheck
	{
		...
		public IIPSMobileErrorCodeCheck.ErrorCodeInfo CheckIIPSErrorCode(int nErrorCode)
		{
			...
			return new IIPSMobileErrorCodeCheck.ErrorCodeInfo(false)
			{
				m_bCheckOk = true,
				m_nErrorType = nErrorType,
				m_nFirstModule = firstModuleType,
				m_nSecondModule = secondModuleType,
				m_nInsideErrorType = errorCodeType,
				m_nErrorCode = num,
				m_nLastCheckError = this.m_nLastCheckErrorCode
			};
		}
