...
namespace com.tencent.pandora
{
	public class LuaState : IDisposable
	{
		...
		{
			int newTop = LuaDLL.lua_gettop(this.L);
			LuaMethodWrapper @object = new LuaMethodWrapper(this.translator, target, function.DeclaringType, function);
		...
		public LuaFunction CreateFunction(object target, MethodBase function)
		{
			...
			LuaFunction result = (!(object2 is LuaCSFunction)) ? ((LuaFunction)object2) : new LuaFunction((LuaCSFunction)object2, this);
			LuaDLL.lua_settop(this.L, newTop);
			return result;
		}
