...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterInitiative_node118 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterInitiative_node118()
		{
			this.opr_p1 = 3000;
		}
