...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterBossInitiative_node101 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterBossInitiative_node101()
		{
			this.opr_p1 = 3000;
		}
