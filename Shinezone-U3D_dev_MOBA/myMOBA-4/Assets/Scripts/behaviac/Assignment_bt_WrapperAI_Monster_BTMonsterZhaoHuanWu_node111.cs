...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterZhaoHuanWu_node111 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterZhaoHuanWu_node111()
		{
			this.opr_p1 = 3000;
		}
