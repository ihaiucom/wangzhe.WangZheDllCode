...
namespace behaviac
{
	internal class Assignment_bt_WrapperAI_Monster_BTMonsterZhaoHuanWu_node115 : Assignment
	{
		private int opr_p1;

		public Assignment_bt_WrapperAI_Monster_BTMonsterZhaoHuanWu_node115()
		{
			this.opr_p1 = 3000;
		}
