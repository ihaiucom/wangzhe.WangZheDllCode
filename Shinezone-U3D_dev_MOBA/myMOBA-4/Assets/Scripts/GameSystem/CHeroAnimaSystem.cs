...
namespace Assets.Scripts.GameSystem
{
	public class CHeroAnimaSystem : Singleton<CHeroAnimaSystem>
	{
		...
		public void OnHeroInfo_ClickModel(CUIEvent uiEvent)
		{
			...
			if (component && this.m_clikAnimaList != null && this.m_clikAnimaList.Count > 0)
			{
				int index = UnityEngine.Random.Range(0, this.m_clikAnimaList.Count);
				component.CrossFade(this.m_clikAnimaList[index]);
				component.CrossFadeQueued(component.clip.name, 0.3f);
				this.PlayAnimaSound(this.m_clikAnimaList[index]);
