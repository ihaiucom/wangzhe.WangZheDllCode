...
namespace Assets.Scripts.GameSystem
{
	public class CUIRedDotSystem : Singleton<CUIRedDotSystem>
	{
		...
		public static void AddRedDot(GameObject target, enRedDotPos dotPos = enRedDotPos.enTopRight, int alertNum = 0, int offsetX = 0, int offsetY = 0)
		{
			...
			if (alertNum == 0)
			{
				gameObject = (UnityEngine.Object.Instantiate(CUIUtility.GetSpritePrefeb("UGUI/Form/Common/redDot", false, false)) as GameObject);
			}
			else
			{
				gameObject = (UnityEngine.Object.Instantiate(CUIUtility.GetSpritePrefeb("UGUI/Form/Common/redDotBig", false, false)) as GameObject);
			}
