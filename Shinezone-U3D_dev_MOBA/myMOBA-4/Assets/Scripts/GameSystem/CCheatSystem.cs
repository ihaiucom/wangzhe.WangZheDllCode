	...
	public class CCheatSystem : Singleton<CCheatSystem>
	{
		...
		private void OnCheatJoystickConfigChanged(CUIEvent uiEvent)
		{
			...
			for (int i = 0; i < multiSelected.Length; i++)
			{
				...
				if (i == 0)
				{
					PlayerPrefs.SetInt(CCheatSystem.s_rmsJoystickForceMoveable, (!CCheatSystem.s_joystickConfigs[i]) ? 0 : 1);
				}
			}
			PlayerPrefs.Save();
		}
				...
				if (component != null)
				{
					...
					for (int i = 0; i < CCheatSystem.s_tversionServerTypeName.Length; i++)
					{
						...
						if (transform != null)
						{
							...
							if (component2 != null)
							{
								component2.text = CCheatSystem.s_tversionServerTypeName[i];
								if (i == 8)
								{
				...
				if (component3 != null)
				{
					...
					for (int j = 0; j < CCheatSystem.s_TDirServerTypeName.Length; j++)
					{
						...
						if (transform2 != null)
						{
							...
							if (component4 != null)
							{
								component4.text = CCheatSystem.s_TDirServerTypeName[j];
								if (j == 0)
								{
									component4.color = new Color(1f, 0f, 0f, 1f);
								}
							}
						}
					}
				...
				if (component5 != null)
				{
					...
					for (int k = 0; k < CCheatSystem.s_errorLogFlagName.Length; k++)
					{
						...
						if (transform3 != null)
						{
							...
							if (component6 != null)
							{
								component6.text = CCheatSystem.s_errorLogFlagName[k];
							}
						}
					}
				...
				if (component7 != null)
				{
					...
					for (int m = 0; m < CCheatSystem.s_ignoreMaintainName.Length; m++)
					{
						...
						if (transform4 != null)
						{
							...
							if (component8 != null)
							{
								component8.text = CCheatSystem.s_ignoreMaintainName[m];
							}
						}
					}
				...
				if (component9 != null)
				{
					...
					for (int n = 0; n < CCheatSystem.s_joystickConfigNames.Length; n++)
					{
						...
						if (transform5 != null)
						{
							...
							if (component10 != null)
							{
								component10.text = CCheatSystem.s_joystickConfigNames[n];
							}
						}
