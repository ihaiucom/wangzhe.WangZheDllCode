...
namespace Assets.Scripts.GameSystem
{
	public class MiniMapSignalPanel
	{
		...
		public void Show(CUIEvent uievent)
		{
			...
			Vector2 pressPosition = uievent.m_pointerEventData.pressPosition;
		...
		public void OnHoldUp(CUIEvent uievent)
		{
			...
			for (int i = 0; i < this.signalEntities.Count; i++)
			{
				...
				if (signalEntity != null)
				{
					signalEntity.ProcessUp(this.cacheClickX, this.cacheClickY, this.form, uievent.m_pointerEventData.position);
				}
			}
		}
