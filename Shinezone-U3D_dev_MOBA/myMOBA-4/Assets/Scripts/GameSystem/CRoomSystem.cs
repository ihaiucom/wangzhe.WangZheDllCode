...
namespace Assets.Scripts.GameSystem
{
	...
	internal class CRoomSystem : Singleton<CRoomSystem>
	{
		...
		private void InitMaps(CUIFormScript rootFormScript)
		{
			...
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_1"), out array[0]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_2"), out array[1]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_3"), out array[2]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_4"), out array[3]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_5"), out array[4]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_6"), out array[5]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_7"), out array[6]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_8"), out array[7]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_9"), out array[8]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_Room_10"), out array[9]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_PVP_MELEE"), out this.MeleeMapId);
			uint[] array2 = new uint[10];
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_1"), out array2[0]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_2"), out array2[1]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_3"), out array2[2]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_4"), out array2[3]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_5"), out array2[4]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_6"), out array2[5]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_7"), out array2[6]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_8"), out array2[7]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_9"), out array2[8]);
			uint.TryParse(Singleton<CTextManager>.instance.GetText("MapType_Room_10"), out array2[9]);
			...
			for (int j = 0; j < component.m_elementAmount; j++)
			{
				...
				uint num = 0u;
				uint.TryParse(Singleton<CTextManager>.instance.GetText("MapID_PVP_5V5Miwu"), out num);
