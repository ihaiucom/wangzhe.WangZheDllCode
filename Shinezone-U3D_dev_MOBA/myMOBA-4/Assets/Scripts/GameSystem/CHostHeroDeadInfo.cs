					...
					if (transform4)
					{
						...
						if (component2)
						{
							...
							if (!string.IsNullOrEmpty(text3))
							{
								...
								string text4 = text3.Substring(num2 + 1, text3.Length - num2 - 2);
					...
					else
					{
						...
						if (hurtType >= HurtTypeDef.PhysHurt && hurtType < HurtTypeDef.Max)
						{
							...
							if (transform4)
							{
								...
								if (component3)
								{
									component3.text = this.m_Skill_HurtType_Name[(int)hurtType];
									component3.color = CUIUtility.s_Text_Skill_HurtType_Color[(int)hurtType];
								}
							}
							...
							if (transform5)
							{
								...
								if (component4)
								{
									...
									{
										component4.text = array[i].strName;
									}
									else
									{
										ActorTypeDef actorTypeDef = ActorTypeDef.Invalid;
									...
									component4.color = CUIUtility.s_Text_SkillName_And_HurtValue_Color[(int)hurtType];
								}
							}
							...
							if (transform8)
							{
								...
								if (component6)
								{
									...
									component6.color = CUIUtility.s_Text_SkillName_And_HurtValue_Color[(int)hurtType];
								}
							}
						}
					}
			...
			if (this.m_hostActor)
			{
				...
				while (enumerator.MoveNext())
				{
					if (enumerator.Current != null && this.m_hostActor.handle.ObjID == enumerator.Current.GetHostHeroObjId())
					{
						...
						int num2 = (array3[0] <= array3[1]) ? array3[1] : array3[0];
						num2 = ((num2 <= array3[2]) ? array3[2] : num2);
