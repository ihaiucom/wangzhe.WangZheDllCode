...
namespace Assets.Scripts.GameSystem
{
	...
	public class CPlayerPvpInfoController : Singleton<CPlayerPvpInfoController>
	{
		...
		public void UpdateUI()
		{
			...
			if (selectedIndex < 0 || selectedIndex2 < 0 || selectedIndex >= Enum.GetValues(typeof(MainTab)).Length || selectedIndex2 >= Enum.GetValues(typeof(SubTab)).Length)
			{
				return;
			}
			...
			Utility.GetComponetInChild<Text>(widget, "panelTop/DropList/Button_Down/Text").text = CPlayerPvpInfoController.sSubTitles[(int)subTab];
			float num = 0f;
			float num2 = 0f;
			int num3 = 0;
			int num4 = 0;
			...
			{
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt1").text = num.ToString("F1");
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt2").text = num2.ToString("P0");
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt3").text = num3.ToString();
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt4").text = num4.ToString();
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt5").text = num5.ToString();
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt6").text = num6.ToString();
				Utility.GetComponetInChild<Text>(p, "DateBar3/txt9").text = (this.m_ability[6] * 100f).ToString("F1");
			}
			else
			{
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt1").text = "-";
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt2").text = "-";
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt3").text = "-";
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt4").text = "-";
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt5").text = "-";
				Utility.GetComponetInChild<Text>(gameObject2, "Content/txt6").text = "-";
				Utility.GetComponetInChild<Text>(p, "DateBar3/txt9").text = "-";
			}
			if (subTab != SubTab.Match1V1)
			{
				Utility.GetComponetInChild<Text>(p, "txt1").text = num8.ToString();
				Utility.GetComponetInChild<Text>(p, "txt2").text = num9.ToString();
				Utility.GetComponetInChild<Text>(p, "txt3").text = num10.ToString();
				Utility.GetComponetInChild<Text>(p, "txt4").text = num11.ToString();
				Utility.GetComponetInChild<Text>(p, "txt5").text = num12.ToString();
				Utility.GetComponetInChild<Text>(p, "txt6").text = num13.ToString();
			}
			else
			{
				Utility.GetComponetInChild<Text>(p, "txt1").text = "-";
				Utility.GetComponetInChild<Text>(p, "txt2").text = "-";
				Utility.GetComponetInChild<Text>(p, "txt3").text = "-";
				Utility.GetComponetInChild<Text>(p, "txt4").text = "-";
				Utility.GetComponetInChild<Text>(p, "txt5").text = "-";
				Utility.GetComponetInChild<Text>(p, "txt6").text = "-";
			}
			Utility.GetComponetInChild<Text>(p, "DateBar1/txt7").text = num14.ToString();
			Utility.GetComponetInChild<Text>(p, "DateBar2/txt8").text = ((num15 != 1f) ? num15.ToString("P1") : num15.ToString("P0"));
			Utility.GetComponetInChild<Image>(p, "DateBar2/Bar").fillAmount = num15;
			Utility.GetComponetInChild<Image>(p, "DateBar3/Bar").fillAmount = CPlayerProfile.Divide(this.m_ability[6], 1f);
			this.InitTemVector();
		...
		private static void ConvertAverageData(CPlayerProfile profile, MainTab mainTab, SubTab subTab, out float kda, out float joinFight, out int totalCoinGet, out int totalHurtToEnemy, out int totalBeHurt, out int totalHurtToOrgan, out float totalDead)
		{
			...
			else if (mainTab == MainTab.Match100)
			{
				...
				{
					if (b2 == 0 || (profile.pvpExtraDetail.astRecentDetail[num14].bGameType == b2 && b3 == profile.pvpExtraDetail.astRecentDetail[num14].bMapAcntNum))
					{
						if ((profile.pvpExtraDetail.astRecentDetail[num14].bGameType != 5 || profile.pvpExtraDetail.astRecentDetail[num14].bMapAcntNum >= 10) && profile.pvpExtraDetail.astRecentDetail[num14].bGameType != 9)
						{
