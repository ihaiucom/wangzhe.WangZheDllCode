...
namespace Assets.Scripts.GameSystem
{
	public class CChatUT
	{
		...
		public static CChatEntity Build_4_OfflineOrOnline(bool bOffline)
		{
			...
			{
				text = ((!bOffline) ? Singleton<CTextManager>.instance.GetText("FriendChat_online_Info") : Singleton<CTextManager>.instance.GetText("FriendChat_Offline_Info")),
		...
		{
			string text = (!bFriend) ? Singleton<CTextManager>.instance.GetText("chat_title_total") : Singleton<CTextManager>.instance.GetText("chat_title_friend");
			if (bFriend)
			{
