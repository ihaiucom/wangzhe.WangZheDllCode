	...
	public class ActivitySys : Singleton<ActivitySys>
	{
		...
		public void StartTimer()
		{
			...
			if (this._refreshTimer == 0)
			{
				...
				DateTime d2 = new DateTime(dateTime.Year, dateTime.Month, dateTime.Day, 0, UnityEngine.Random.Range(5, 60), UnityEngine.Random.Range(0, 60));
				TimeSpan timeSpan = d2 - d;
				this._refreshTimer = Singleton<CTimerManager>.GetInstance().AddTimer((int)(timeSpan.TotalSeconds * 1000.0), 1, new CTimer.OnTimeUpHandler(this.RequestRefresh));
			}
		}
		...
		private void CreateStatic()
		{
			...
			while (enumerator2.MoveNext())
			{
				...
				this.TryAdd(new FixTimeActivity(this, current2.Value));
			}
			...
			while (enumerator3.MoveNext())
			{
				...
				this.TryAdd(new MultiGainActivity(this, current3.Value));
			}
			...
			while (enumerator4.MoveNext())
			{
				...
				this.TryAdd(new ExchangeActivity(this, current4.Value));
			}
			...
			while (enumerator5.MoveNext())
			{
				...
				this.TryAdd(new PointsExchangeActivity(this, current5.Value));
			}
			...
			while (enumerator6.MoveNext())
			{
				...
				this.TryAdd(new ExeTaskActivity(this, current6.Value));
			}
			...
			while (enumerator7.MoveNext())
			{
				...
				this.TryAdd(new NoticeActivity(this, current7.Value));
			}
		}
