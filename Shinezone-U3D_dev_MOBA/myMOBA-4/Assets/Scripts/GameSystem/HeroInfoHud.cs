...
namespace Assets.Scripts.GameSystem
{
	public class HeroInfoHud
	{
		...
		public uint PickedHeroID
		{
			get
			{
				return (this._pickedHero == null) ? 0u : this._pickedHero.actorHero.handle.ObjID;
			}
		}
		...
		public void ValidateLevel()
		{
			...
			this._levelTxt.text = this._pickedHero.actorHero.handle.ValueComponent.actorSoulLevel.ToString();
		}
		...
		public void ValidateHp()
		{
			...
			this._hpTxt.text = string.Format("{0}/{1}", actorHp, totalValue);
		}
		...
		public void ValidateAd()
		{
			...
			this._adTxt.text = totalValue.ToString();
		}
		...
		public void ValidateAp()
		{
			...
			this._apTxt.text = totalValue.ToString();
		}
		...
		public void ValidatePhyDef()
		{
			...
			this._phyDefTxt.text = totalValue.ToString();
		}
		...
		public void ValidateMgcDef()
		{
			...
			this._mgcDefTxt.text = totalValue.ToString();
		}
		...
		public void ValidateMoney()
		{
			...
			this._moneyTxt.text = this._pickedHero.TotalCoin.ToString();
		}
		...
		public void ValidateKDA()
		{
			...
			this._killTxt.text = this._pickedHero.numKill.ToString();
			this._deadTxt.text = this._pickedHero.numDead.ToString();
			this._assistTxt.text = this._pickedHero.numAssist.ToString();
		}
		...
		public void ValidateReviceCD()
		{
			...
			{
				this._reviveTxt.text = string.Format("{0}", Mathf.FloorToInt((float)this._pickedHero.actorHero.handle.ActorControl.ReviveCooldown * 0.001f));
