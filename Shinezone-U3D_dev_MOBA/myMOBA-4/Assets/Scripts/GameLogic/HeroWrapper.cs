...
namespace Assets.Scripts.GameLogic
{
	public class HeroWrapper : ObjWrapper
	{
		...
		public PoolObjHandle<ActorRoot> CallMonster
		{
			get
			{
				return (!this.hasCalledMonster) ? base.GetOrignalActor() : this.callMonster;
			}
			set
			{
		...
		protected override void OnDead()
		{
			...
			{
				PoolObjHandle<ActorRoot> ptr = (!this.myLastAtker) ? this.myLastAtker : this.myLastAtker.handle.ActorControl.GetOrignalActor();
