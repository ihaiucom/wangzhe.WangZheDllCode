...
namespace Assets.Scripts.GameLogic
{
	public class MultiGameContext : GameContextBase
	{
		...
		public MultiGameContext(SCPKG_MULTGAME_BEGINLOAD InMessage)
		{
			...
			Singleton<Assets.Scripts.Framework.GameLogic>.GetInstance().HashCheckFreq = InMessage.dwHaskChkFreq;
			Singleton<Assets.Scripts.Framework.GameLogic>.GetInstance().SnakeTraceMasks = InMessage.dwCltLogMask;
			Singleton<Assets.Scripts.Framework.GameLogic>.GetInstance().SnakeTraceSize = InMessage.dwCltLogSize;
		}
