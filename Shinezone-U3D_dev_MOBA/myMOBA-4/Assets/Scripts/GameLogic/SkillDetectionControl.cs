...
namespace Assets.Scripts.GameLogic
{
	public class SkillDetectionControl : Singleton<SkillDetectionControl>
	{
		...
		{
			ClassEnumerator classEnumerator = new ClassEnumerator(typeof(SkillBaseDetectionAttribute), typeof(SkillBaseDetection), typeof(SkillBaseDetectionAttribute).Assembly, true, false, false);
