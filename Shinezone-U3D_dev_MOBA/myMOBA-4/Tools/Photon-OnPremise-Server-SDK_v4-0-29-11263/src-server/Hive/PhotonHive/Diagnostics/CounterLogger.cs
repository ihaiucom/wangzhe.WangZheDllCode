...
namespace Photon.Hive.Diagnostics
{
    ...
    public class CounterLogger : IDisposable
    {
        ...
        private static void LogCounter(object state)
        {
            ...
            //    "# Sessions = {0:N2}", SocketServer.Diagnostics.PhotonCounter.SessionCount.GetNextValue());
            //counterLog.InfoFormat(
            //    "OperationReceive/s = {0:N2}",
            //    SocketServer.Diagnostics.PhotonCounter.OperationReceivePerSec.GetNextValue());
            //counterLog.InfoFormat(
            //    "OperationsResponse/s = {0:N2}",
            //    SocketServer.Diagnostics.PhotonCounter.OperationResponsePerSec.GetNextValue());
            //counterLog.InfoFormat(
            //    "EventsSent/s = {0:N2}",
            //    SocketServer.Diagnostics.PhotonCounter.EventSentPerSec.GetNextValue());
            //counterLog.InfoFormat(
            //    "Average Execution Time = {0:N2}\n",
            //    SocketServer.Diagnostics.PhotonCounter.AverageOperationExecutionTime.GetNextValue());
        }
